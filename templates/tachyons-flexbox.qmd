...
<!-- LAYOUT FOR 2 EVEN-ISH COLUMNS USING TACHYONS FLEXBOX: https://tachyons.io/docs/layout/flexbox/

NOTE: The following template is mobile responsive, but Quarto will push the contents into two rows even on desktop if it is a 50/50 split.  -->
