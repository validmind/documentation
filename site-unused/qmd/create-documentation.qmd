...
The code snippet can be copied and pasted directly into your developer source code to integrate the {{< var validmind.developer >}} and to be able to upload to the {{< var validmind.platform >}}.
...
- [Get started with the {{< var validmind.developer >}}](get-started-developer-framework.qmd)
- [Install and initialize the {{< var vm.developer >}}](install-and-initialize-developer-framework.qmd)
