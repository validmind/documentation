...
The code snippet can be copied and pasted directly into your developer source code to integrate the {{< var validmind_developer >}} and to be able to upload to the {{< var validmind.platform >}}.
