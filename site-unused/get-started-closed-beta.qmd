...
| Yes | **[nlp_and_llm/hugging_face_integration_demo.ipynb](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/nlp_and_llm/hugging_face_integration_demo.ipynb)**<br>Introduces you to the process of documenting an NLP model specialized in sentiment analysis of financial news. | [Demo] Hugging Face - Text Sentiment Analysis
| Yes | **[nlp_and_llm/hugging_face_summarization_demo.ipynb](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/nlp_and_llm/hugging_face_summarization_demo.ipynb)**<br>Introduces you to the process of documenting an NLP model specialized in summarization of financial news. | [Demo] Hugging Face - Text Summarization
| Yes | **[nlp_and_llm/tutorial_time_series_forecasting.ipynb](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/time_series/tutorial_time_series_forecasting.ipynb)**<br>Guides you through the process of documenting and testing time series forecasting models | [Demo] Interest Rate Time Series Forecasting Model
