...
|`vm_private_service_connect_validmind` | https://private.us3-prod.validmind.ai | `psc.validmind` | {{< var psc.validmind >}} |
|`vm_private_service_connect_auth` | https://auth.private.validmind.ai | `psc.authentication` | {{< var psc.authentication >}} |
