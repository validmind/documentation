...
Follow the steps in [Install and initialize the {{< var vm_dev >}}](/developer/model-documentation/install-and-initialize-developer-framework.qmd) for detailed instructions on how to integrate the {{< var vm_dev >}} and upload to the {{< var vm_ui >}}.
