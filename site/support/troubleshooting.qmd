...
#### Issue
You cannot run `pip install validmind` or `import validmind as vm` in the {{< var vm_framework >}} notebooks.

#### Fix
Make sure you are installing the latest version of the {{< var vm_dev >}} by running this command:
...
Follow the steps in [Install and initialize the {{< var vm_dev >}}](/developer-framework/model-documentation/install-and-initialize-developer-framework.qmd) for detailed instructions on how to integrate the {{< var vm_dev >}} and upload to the {{< var vm_ui >}}.
