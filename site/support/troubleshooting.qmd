...
Learn how to resolve commonly encountered issues with the {{< var developer >}}.

## Cannot install the {{< var validmind_developer >}}

#### Issue
You cannot run `pip install validmind` or `import validmind as vm` in the {{< var validmind_developer >}} notebooks.

#### Fix
Make sure you are installing the latest version of the {{< var developer >}} by running this command:
...
Follow the steps in [Install and initialize the {{< var developer >}}](/developer/model-documentation/install-and-initialize-developer-framework.qmd) for detailed instructions on how to integrate the {{< var developer >}} and upload to the {{< var platform >}}.
