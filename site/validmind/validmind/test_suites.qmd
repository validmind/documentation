...
<span class="kw">def</span><span class="name">register_test_suite</span>(<span class="params"><span class="n">suite_id</span><span class="p">:</span><span class="nb">str</span><span class="muted">,</span></span><span class="params"><span class="n">suite</span><span class="p">:</span><a href="/validmind/validmind/vm_models.html#testsuite">validmind.vm_models.TestSuite</a></span>):
