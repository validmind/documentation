---
title: "[validmind](/validmind/validmind.html).ChiSquaredFeaturesTable"
...
## ChiSquaredFeaturesTable[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="decorators"><span class="decorator">@<span class="n">tags(<span class="s">'tabular_data'</span>, <span class="s">'categorical_data'</span>, <span class="s">'statistical_test'</span>)</span></span><span class="decorator">@<span class="n">tasks(<span class="s">'classification'</span>)</span></span></span>
