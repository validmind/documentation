...
<span class="kw">def</span><span class="name">RunsTest</span>(<span class="param"><span class="n">dataset</span></span>)<span class="p"> → </span><span class="return-annotation"><span class="n">pd</span>.<span class="n">DataFrame</span></span>:
