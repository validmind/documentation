...
<span class="decorators"><span class="decorator">@<span class="n">tags(<span class="s">'time_series_data'</span>, <span class="s">'stationarity'</span>, <span class="s">'unit_root_test'</span>, <span class="s">'statsmodels'</span>)</span></span><span class="decorator">@<span class="n">tasks(<span class="s">'data_validation'</span>)</span></span></span>

<span class="kw">def</span><span class="name">KPSS</span>(<span class="param"><span class="n">dataset</span><span class="p">:</span><a href="/validmind/validmind/vm_models.html#vmdataset">validmind.vm_models.VMDataset</a></span>):
