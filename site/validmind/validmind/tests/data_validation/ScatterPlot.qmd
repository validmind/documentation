...
<span class="kw">def</span><span class="name">ScatterPlot</span>(<span class="param"><span class="n">dataset</span></span>)<span class="p"> → </span><span class="return-annotation"><span class="n">matplotlib</span>.<a href="/validmind/validmind/vm_models.qmd#figure">validmind.vm_models.figure</a>.<span class="n">Figure</span></span>:
