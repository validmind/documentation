---
title: "[validmind](/validmind/validmind.html).ModelPredictionResiduals"
...
## ModelPredictionResiduals[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="decorators"><span class="decorator">@<span class="n">tags(<span class="s">'regression'</span>)</span></span><span class="decorator">@<span class="n">tasks(<span class="s">'residual_analysis'</span>, <span class="s">'visualization'</span>)</span></span></span>
