---
title: "[validmind](/validmind/validmind.html).ModelParameters"
...
## ModelParameters[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="decorators"><span class="decorator">@<span class="n">tags(<span class="s">'model_training'</span>, <span class="s">'metadata'</span>)</span></span><span class="decorator">@<span class="n">tasks(<span class="s">'classification'</span>, <span class="s">'regression'</span>)</span></span></span>
