...
RELATED_DOC_KEYWORDS: dict[str, list[str]] = {
    ...
    "segment": ["inventory/manage-inventory-segments"],
    "finding": ["model-validation", "findings"],
    "artifact": [
        "validation/working-with-artifacts",
        "validation/view-filter-artifacts",
        "validation/customize-artifact-layouts",
        "validation/manage-artifact-types",
        "validation/log-artifacts",
        "validation/update-artifacts",
    ],
    "validation issues": [
        "validation/view-filter-artifacts",
        "validation/customize-artifact-layouts",
