...
# Adds PRs labeled 'highlight' to the release highlights template file. PRs from documentation are written under '## Release Highlights', validmind-python under 'ValidMind Developer Framework', and frontend under 'ValidMind Platform UI'
