...
date: last-modified
aliases:
  - ../guide/get-started-validmind-library.html
  - ../guide/validmind-library.html
  - ../guide/restapi.html
...
{{< var vm.product >}}'s {{< var vm.developer >}} provides a rich collection of documentation tools and test suites, from documenting descriptions of your dataset to validation testing your models for weak spots and overfit areas. 
 
<!-- Using the variable in alt text messes up the image display  --> 

![](validmind-ai-risk-platform.png){width=70% fig-align="center" fig-alt="An image showing the two main components of ValidMind. The ValidMind Library that integrates with your existing developer environment, and the ValidMind Platform."}
...
The {{< var vm.developer >}} is designed to be model agnostic. If your model is built in Python, {{< var vm.product >}}’s Python client library already provides all the standard functionality you might need without requiring your developers to rewrite any functions.
...
{{< var vm.product >}} provides many built-in tests and test suites which make it easy for developers to automate their model documentation. Start by running a pre-made test, then modify it, and finally create your own test: 
