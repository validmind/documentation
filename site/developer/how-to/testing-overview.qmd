...
digraph {
    rankdir=LR
    bgcolor="transparent"
    node [shape=box, style="rounded,filled", fillcolor="#FAFBFB", color="#083E44", fontcolor="#36454F", fontname="Arial,Helvetica,sans-serif", fontsize=11, penwidth=1]
    edge [color="#083E44", penwidth=1]
    graph [fontcolor="#36454F", fontname="Arial,Helvetica,sans-serif", fontsize=11]
    
    subgraph cluster_identify { label="Identify"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; TestID [label="Test ID"]; ResultID [label="Result ID"] }
    subgraph cluster_configure { label="Configure"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; Inputs; Params [label="Parameters"] }
    subgraph cluster_run { label="Run"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; RunTest [label="run_test()"] }
    subgraph cluster_output { label="Outputs & log results"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; Output [label="Tables, plots, etc."]; Log [label=".log()"] }
    Platform
...
digraph {
    ...
    subgraph cluster_identify { label="Identify"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; SuiteID [label="Test suite ID"] }
    subgraph cluster_configure { label="Configure"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; SuiteInputs [label="Inputs"]; SuiteConfig [label="Config"] }
    subgraph cluster_run { label="Run"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; RunSuite [label="run_test_suite()"] }
    subgraph cluster_output { label="Outputs & log results"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; SuiteOutput [label="Tables, plots, etc."]; SuiteLog [label=".log()"] }
    Platform
