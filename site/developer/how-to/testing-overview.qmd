...
digraph {
    ...
    ranksep=0.5
    nodesep=0.8
    node [shape=box, style="rounded,filled", fillcolor="#FAFBFB", color="#083E44", fontcolor="#36454F", fontname="Arial,Helvetica,sans-serif", fontsize=10, penwidth=0.7, margin="0.24,0.3"]
