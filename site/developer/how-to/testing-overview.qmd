...
digraph {
    ...
    ranksep=0.5
    nodesep=0.8
    node [shape=box, style="rounded,filled", fillcolor="#FAFBFB", color="#083E44", fontcolor="#36454F", fontname="Arial,Helvetica,sans-serif", fontsize=10, penwidth=1, margin="0.12,0.08"]
    edge [color="#083E44", penwidth=1]
    graph [fontcolor="#36454F", fontname="Arial,Helvetica,sans-serif", fontsize=10]
    
    subgraph cluster_identify { label="Identify"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; TestID [label="Test ID"]; ResultID [label="Result ID"] }
    subgraph cluster_configure { label="Configure"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; Inputs; Params [label="Parameters"] }
    subgraph cluster_run { label="Run"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; RunTest [label="run_test()"] }
    subgraph cluster_output { label="Outputs & log results"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; Output [label="Tables, plots, etc."]; Log [label=".log()"] }
    Platform
...
digraph {
    ...
    subgraph cluster_identify { label="Identify"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; SuiteID [label="Test suite ID"] }
    subgraph cluster_configure { label="Configure"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; SuiteInputs [label="Inputs"]; SuiteConfig [label="Config"] }
    subgraph cluster_run { label="Run"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; RunSuite [label="run_test_suite()"] }
    subgraph cluster_output { label="Outputs & log results"; style="rounded"; color="#083E44"; fillcolor="#FAFBFB"; margin=6; SuiteOutput [label="Tables, plots, etc."]; SuiteLog [label=".log()"] }
    Platform
