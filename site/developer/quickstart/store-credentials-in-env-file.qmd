...
[^7]: [Install and initialize the {{< var validmind.developer >}}](/developer/quickstart/install-and-initialize-validmind-library.qmd#install-validmind)

[^8]: [Enable monitoring](/guide/monitoring/enable-monitoring.qmd)

[^9]: [Install and initialize the {{< var validmind.developer >}}](/developer/quickstart/install-and-initialize-validmind-library.qmd#upgrade-validmind)
