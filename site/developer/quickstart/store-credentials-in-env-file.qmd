...
iii. Select a model by clicking on it or find your model by applying a filter or searching for it.[^4]

iv. In the left sidebar that appears for your model, click **{{< fa rocket >}} Getting Started**.
...
a. After installing the {{< var validmind.developer >}} within your Jupyter Notebook,[^8] insert this code snippet in a code cell above your model identifier credentials:
