...
- [x] You are a [{{< fa code >}} Developer]{.role} or [{{< fa circle-check >}} Validator]{.role}, or assigned another role with sufficient permissions to perform the tasks in this guide.[^2]
...
5. Click {{< fa square-plus >}} and then select **Test-Driven**.[^3]
    ...
    - By default, the [{{< fa code >}} Developer]{.role} role can add test-driven blocks within model documentation or ongoing-monitoring plans.
    - By default, the [{{< fa circle-check >}} Validator]{.role} role can add test-driven blocks within validation reports. 
