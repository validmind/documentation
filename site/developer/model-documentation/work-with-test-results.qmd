...
- [x] You are a [Developer]{.role} or [Validator]{.role}, or assigned another role with sufficient permissions to perform the tasks in this guide.[^2]
...
5. Click {{< fa square-plus >}} and then select **Test-Driven**.[^3]
    ...
    - By default, the [Developer]{.role} role can add test-driven blocks within model documentation or ongoing-monitoring plans.
    - By default, the [Validator]{.role} role can add test-driven blocks within validation reports. 
