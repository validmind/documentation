...
## End-to-end workflow  {.unnumbered}
...
2. [Install and initialize the {{< var validmind.developer >}}.](install-and-initialize-developer-framework.qmd)
...
[^4]: [Install and initialize the developer framework](install-and-initialize-developer-framework.qmd)
