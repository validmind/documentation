...
3. {{< fa arrow-right >}} Use the instructions from **In the {{< var platform >}}, Step 3**, [initialize the {{< var validmind.developer >}}](install-and-initialize-developer-framework.qmd).
