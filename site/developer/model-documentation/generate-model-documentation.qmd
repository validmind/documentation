...
**The ValidMind workflow** — Generate model documentation starting with your model or model predictions, load your model or predictions into the {{< var vm.developer >}}, then finally view the results and refine your documentation in the {{< var vm.platform >}}. 
...
5. {{< fa arrow-right >}} After **With the {{< var validmind.developer >}}, Step 6**, add content blocks[^3] to your model documentation: 
   
   Select the block type:
   
      - **For test-driven blocks** — Select from available test provider results[^4]
      - **For text blocks** — 
...
[^4]: [Work with test results](work-with-test-results.qmd)
