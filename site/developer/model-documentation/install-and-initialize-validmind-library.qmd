...
Use the _code snippet_ unique to each registered model per model document to connect your environment to the {{< var validmind.platform >}}. Initialize the {{< var validmind.developer >}} with this code snippet, ensuring your test results are uploaded to the correct model's document.
...
4. Select the **[document]{.smallcaps}** you want to automatically upload test results to.
