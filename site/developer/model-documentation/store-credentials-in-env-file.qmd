...
a. After installing the {{< var validmind.developer >}} within your Jupyter Notebook,^ insert this code snippet in a code cell above your model identifier credentials:
...
b. Remove the inline credentials from `vm.init()` after importing the {{< var vm.developer >}}:
   ...
   Example updated code cell including ongoing monitoring:^[[Enable monitoring](/guide/monitoring/enable-monitoring.qmd)]
