...
1. Within your Jupyter Notebook or developer environment terminal, retrieve the information for the currently installed version of ValidMind:
...
2. If the version returned is less recent than the version indicated in our production open-source code,[^6] run the following in a code cell or within your terminal:
