...
listing:
  - id: generate-documentation
    ...
    - install-and-initialize-developer-framework.qmd
    - store-credentials-in-env-file.qmd
    - work-with-test-results.qmd
---

Use the {{< var validmind.developer >}} to generate model documentation, then view the results and refine your documentation in the  {{< var validmind.platform >}}.
