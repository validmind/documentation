---
title: "Install and initialize the {{< var vm.developer >}}"
date: last-modified
---
...
:::{.callout}
To also enable monitoring, add `monitoring=True` to the `vm.init` method in your code snippet. [^3]
:::
...
[^3]: [Ongoing monitoring](/guide/monitoring/ongoing-monitoring.qmd)