...
In order to integrate the {{< var developer >}} and to be able to upload to the {{< var vm.platform >}}, you must provide the following information through a code snippet that you copy from the {{< var validmind.platform >}}:
...
After you have pasted the code snippet into your development source code and run your code, the Python client library will connect and register with ValidMind. You can now use the {{< var developer >}} to document and test your models, and to upload model documentation and test results to the {{< var vm.platform >}}.
