...
: Any Python object with a `predict()` method is compatible. Framework-specific wrappers provide extra features and convenience, but they are not required and you can use generic Python models without them.
:::

::: {.column width="50%" .pl3}
Vendor model compatibility
: {{< var vm.product >}} works with both first-party models and [third-party vendor models](/about/glossary/glossary.qmd#vendor-model), enabling flexible integration with proprietary and external model sources.
:::
