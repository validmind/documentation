...
- Tests: DeepEval integration
- Refer to [Agentic AI evaluation](#agentic-ai-evaluation) for available tests
:::
...
| Test | Requires model | Input columns |
|------|----------------|---------------|
| TaskCompletion | Yes (`predict_fn`) | `input` |
| PlanQuality | Yes (`predict_fn`) | `input` |
| PlanAdherence | Yes (`predict_fn`) | `input` |
| ToolCorrectness | No | `input`, `expected_tools`, `tools_called` |
| ArgumentCorrectness | No | `input`, `tools_called` |
