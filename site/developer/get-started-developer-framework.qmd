...
After you have tried out the {{< var developer >}}, continue [working with your model documentation](/guide/model-documentation/working-with-model-documentation.qmd) in the AI Risk Platform ({{< var vm.platform >}}) online. There, you can:
