...
listing:
  ...
  - id: library-documentation
    ...
    fields: [title, description]
    contents:
    - ../guide/documentation/work-with-test-results.qmd
...
Learn how to use the {{< var validmind.developer >}} with our high-level Jupyter Notebook courses covering usage of ValidMind for specific roles or concepts.
...
## Learn how to use the {{< var validmind.developer >}}
...
::: {.w-70-ns}
Try our Jupyter Notebook code samples that showcase the capabilities of the {{< var validmind.developer >}} and cover a variety of sample use cases.
:::

::: {.w-30-ns .tr}
[Code samples by use case](samples-jupyter-notebooks.qmd){.button .button-green}
...
[^3]: [Working with model documentation](/guide/documentation/working-with-model-documentation.qmd)