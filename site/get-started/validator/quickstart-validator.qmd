...
::: {.column-margin}
![Inventory record stakeholders with only the Validators assigned](model-stakeholders.png){width=90% fig-alt="A screenshot showing the inventory record stakeholders with only Validators assigned" .screenshot}
:::

#### 3. Select a report template

{{< include /get-started/common-steps/_select-template.qmd >}}

#### 4. Get your code snippet
