...
1. Open [Quickstart for model validation]({{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/quickstart/quickstart_validation.ipynb) and [run the quickstart notebook](#run-the-quickstart-notebook).
...
[^1]: [Quickstart for model validation](/notebooks/quickstart/quickstart_validation.ipynb)
