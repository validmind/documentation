...
Continue with [Explore sample model documentation](../platform-ui/quickstart-explore-sample-model-documentation.qmd) to learn more about using the {{< var vm_risk >}} hands-on.
