...
Continue with [Explore sample model documentation](/get-started/platform-ui/explore-sample-model-documentation.qmd) to learn more about using the {{< var vm_risk >}} hands-on.
