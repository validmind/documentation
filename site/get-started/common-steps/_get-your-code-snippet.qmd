...
![{{< fa rocket >}} Getting Started page with a sample code snippet](/get-started/developer/developer-code-snippet.png){width=90% fig-alt="A screenshot showing the Getting Started page with a sample code snippet" .screenshot}
...
![{{< fa rocket >}} Getting Started page with a sample code snippet](/get-started/validator/validator-code-snippet.png){width=90% fig-alt="A screenshot showing the Getting Started page with a sample code snippet" .screenshot}
