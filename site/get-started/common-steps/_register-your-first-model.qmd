...
a. To register a model for use with this quickstart, select:
   ...
   - **[what type of model is it]{.smallcaps}[?]{.smallercaps}**  — `New Model`
...
a. Select your own name under the **[model owner]{.smallcaps}** drop-down — don't worry, we'll adjust these permissions later for validation.
