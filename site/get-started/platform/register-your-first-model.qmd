...
2. Click **{{< fa plus >}} Register New Model**.[^1]
   ...
   ![The Register New Model panel](model-registration.png){width=60% fig-alt="A screenshot showing the Register New Model panel" class="screenshot"}
