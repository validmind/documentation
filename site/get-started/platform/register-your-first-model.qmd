...
3. After the model is registered, explore the initial model documentation and validation report outlines provided based on the documentation template you selected. 

   In the left sidebar that appears for your model, click on:

   a. **Documentation**[^2]
   b. **Validation Report**[^3] 
...
[^3]: [Preparing validation reports](/guide/model-validation/preparing-validation-reports.qmd)