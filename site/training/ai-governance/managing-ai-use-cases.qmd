...
::: {.column width="50%" .pl3}
![Custom fields configuration](custom-fields.png){fig-alt="A screenshot showing custom field configuration in ValidMind settings" .screenshot}
:::
...
::: {.column width="60%" .pl3}
![Model inventory overview](inventory-overview.png){fig-alt="A screenshot showing the ValidMind inventory with AI use cases displaying tier, model owner, and model stage fields" .screenshot}
:::
...
::: {.column width="50%" .pl3}
![Risk tier configuration](risk-tiers.png){fig-alt="A screenshot showing risk tier field configuration in ValidMind" .screenshot}
:::
