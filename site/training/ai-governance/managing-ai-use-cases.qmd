...
![A short video showing custom field configuration in ValidMind settings](custom-fields.gif)
:::
...
![A short video showing the ValidMind inventory with AI use cases displaying tier, model owner, and model stage fields](intentory-in-action.gif)
:::
