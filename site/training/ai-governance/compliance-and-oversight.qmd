...
subtitle: "AI Governance Fundamentals — Module 4 of 4<br><br>_Click [{{< fa chevron-right >}}](#learning-objectives) to start_"
lightbox: true
format:
  revealjs:
    controls: true
...
# Regulatory mapping {background-color="#083E44" background-image="/training/assets/home-hero.svg"}
...
# Dashboards and reporting {background-color="#083E44" background-image="/training/assets/home-hero.svg"}
...
# Audit evidence {background-color="#083E44" background-image="/training/assets/home-hero.svg"}
...
# Ongoing compliance {background-color="#083E44" background-image="/training/assets/home-hero.svg"}
...
Congratulations on completing **AI Governance Fundamentals**!
...
::: {.tc}
[Return to AI Governance Fundamentals](ai-governance-register.qmd){.button target="_blank"}
:::
