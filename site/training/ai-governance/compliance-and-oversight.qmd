...
# Regulatory mapping {background-image="../assets/digitalspace-colours.svg"}
...
# Dashboards and reporting {background-image="../assets/digitalspace-colours.svg"}
...
# Audit evidence {background-image="../assets/digitalspace-colours.svg"}
...
![Audit evidence pipeline: Registration, Approval history, Documentation, Change history, Export for auditors](evidence-pipeline.svg){fig-alt="Horizontal flow diagram: Registration records, Approval history, Documentation, Change history, and Export for auditors, with ValidMind brand colors." width="90%"}
...
# Continuous compliance {background-image="../assets/digitalspace-colours.svg"}
