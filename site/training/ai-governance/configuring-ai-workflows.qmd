...
## Example: Risk classification workflow {.center}

![Risk Classification Workflow](risk-classification-workflow.png){fig-alt="A screenshot showing a Risk Classification Workflow with model stage changes, user actions, approvals, and condition branches for different risk levels" .screenshot}

## Risk classification workflow steps {.center}

This intake workflow demonstrates key AI governance patterns:
...
::: {.column width="50%" .pl3}
![Approval step configuration](approval-config.png){fig-alt="A screenshot showing approval step configuration with role selection in the workflow builder" .screenshot}
:::
