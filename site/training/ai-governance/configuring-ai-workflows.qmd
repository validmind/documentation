...
::: {.f3}
- **{{< fa cube >}} Model Stage Change** — Sets model stage to [In Risk Classification]{.bubble}
- **{{< fa arrow-pointer >}} User Action** — Collects risk classification materials with deadline
- **{{< fa bullhorn >}} Broadcast** — Notifies stakeholders of pending risk rating
- **{{< fa users >}} Approval** — Routes to Model Validation Governance for review
- **{{< fa maximize >}} Condition Branch** — Different paths for High Risk, Medium Risk, or Default
:::
