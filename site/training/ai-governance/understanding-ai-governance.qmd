...
![AI governance and MRM as parallel use cases with overlapping shared artifacts](../assets/ai-governance-mrm-overlap.svg){fig-alt="Diagram: AI Governance and MRM as overlapping circles with shared artifacts in the overlap." width="75%"}
