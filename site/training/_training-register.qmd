...
4. **Start one of our [available courses](/training/training.qmd#available-courses)!**

::: {.callout-important title="For testing and evaluation purposes only"}
Do not upload proprietary information — the training environment environment is not to be used for production. If you have questions about testing in the training environment, please [provide feedback or ask for help](/training/training.qmd#feedback-help).
:::
