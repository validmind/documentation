...
- Beyond just guiding users into the platform, the new home page will also explain our value proposition to a broader audience.
:::
::::
...
The new onboarding delivers clarity and direction for every user role.

Instead of a generic starting point, each persona — developers, validators, and admins — gets a tailored experience that aligns with their specific needs.
