...
To try out this course, you need to have been [onboarded](course-registration.qmd#register) onto {{< var vm.product >}} Academy with the [**{{< fa check >}} Role Name**]{.bubble} role.
...
#### This is what an `h4` looks like
   ...
   ![Here's what a `.screenshot` looks like](/guide/model-documentation/add-content-block.gif){class="screenshot"}
