...
If you update the extension, **make sure to reapply our custom CSS changes!**
...
:::: {.slideover--l .auto-collapse .quarters}
**This is a collapsible left-aligned modal (`slideover--l`) at half-size on top of the live {{< var vm.product >}} Platform.**
...
The box will also automatically scroll once past a certain length (a percentage of your screen)...
