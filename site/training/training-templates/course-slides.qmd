...
#### This is what an `h4` looks like
   ...
   ![Here's what a `.screenshot` looks like](/guide/documentation/add-content-block.gif){.screenshot}
...
For example, the following links to our [_commenting.qmd](/guide/documentation/_commenting.qmd){target="_blank"} single-source include file. 
