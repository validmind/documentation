...
First, let's make sure you can log in and show you around {{< var vm.product >}}.

{{< include _revealjs-navigation.qmd >}}

## Can you log in?

To try out this course, you need to have been [onboarded](training.qmd#onboarding) onto {{< var vm.product >}} Academy with the **Customer Admin** role.
