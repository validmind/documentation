...
::: {.w-40-ns .nb3 .pl2}
[{{< fa graduation-cap >}} training](https://docs.validmind.ai/training/administrator-fundamentals/administrator-fundamentals.html#/section-12){.button-small} [{{< fa book-open >}} docs](/guide/model-workflows/setting-up-model-workflows.qmd){.button-small}
:::
