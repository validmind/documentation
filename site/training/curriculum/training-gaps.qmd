---
title: "Training gaps"
# Comparison: Customer Questions vs. Updated Fundamentals Courses
---

This document compares the customer questions against the updated ValidMind fundamentals courses to identify content gaps.

## Administrator Fundamentals

### Part 1 (Covered Topics)  
...
### Gaps:  
- ❌ How to configure model inventory, e.g. add model inventory fields? (Partially related to configuring model inventory, but not explicitly covered.)
