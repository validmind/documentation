...
1. Get your access credentials for the {{< var platform >}} by signing up with ValidMind: [{{< var vm_url_us1 >}}]({{< var vm_url_us1 >}})
...
2. When you receive your access credentials, make sure you can log in:
   ...
   - **{{< var validmind_platform >}}** — [{{< var vm_url_us1 >}}]({{< var vm_url_us1 >}})
