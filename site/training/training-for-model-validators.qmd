...
_"As a validator who is new to {{< var vm.product >}}, I want to learn how to review model documentation, prepare my validation report, and submit it for approval."_
...
To try out this training module, you need to have been [onboarded](training.qmd#onboarding) onto {{< var vm.product >}} Academy with the **Validator** role.
