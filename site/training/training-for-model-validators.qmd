...
To try out this training module, you need to have been [onboarded](training-overview.html#onboarding) onto ValidMind Academy with the **Validator** role.
...
For you to be able to transition through the approval workflow, the model documentation and validation report must have completed all required steps. For example, you cannot submit a validation report for review until the model documentation itself has been submitted. 
