...
To try out this course, you need to have been [onboarded](administrator-fundamentals-register.qmd#register) onto ValidMind Academy with the [**Customer Admin**]{.bubble} role.
...
::: footer
:::: {.absolute bottom=0 left=50 right=50 .w-95 .f3 .tc .pl4 .overlay}
For the user you added earlier, grant the [**Validator**]{.bubble} role. Also grant all validators the **Duplicate Template** permission.
