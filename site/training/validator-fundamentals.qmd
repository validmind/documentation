...
:::: {.columns}
::: {.column width="30%" .pr4 .f2}
Before submitting your report, resolve identified issues by closing the finding or including a mitigation plan.
...
:::: {.absolute bottom=15 .w-100 .f4 .tc .pl4 .pr4 .bg-near-white .ba .b--dark-pink .bw1 .br3 .near-black .shadow-5}
To rack open issues, close any outstanding ones or add a mitigation plan. issues related to findings or comments. 
