...
To try out this course, you need to have been [onboarded](training.qmd#onboarding) onto ValidMind Academy with the **Validator** role.
...
# Track issue resolution {background-color="#083E44" background-image="home-hero.svg"}

## {.scrollable}

:::: {.columns}
::: {.column width="30%" .pr4 .f2}
Based on your review of the documentation, there will be issues that you need to track and resolve. 

- Use the Reports page and Activity Feed to track open findings
- Getting from the validation report to the model documentation (the original ask)
- Checking model documentation for open findings
- Showing how to resolve findings

::: {.tc}
[Learn more ...](/guide/model-validation/_track_issue_resolution.qmd){.button target="_blank"}
:::
...
As part of the validation process, you may have indicated issues with the model documentation that must be resolved by adding findings. Track the resolution, you add a new finding. 
