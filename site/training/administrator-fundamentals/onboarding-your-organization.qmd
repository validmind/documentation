...
- Keep track of all your organization's records (models) and their progress throughout their lifecycles in the customizable inventory ...
...
- Set up workflows and attestations to streamline the governance of your records ...
...
2. Enter your **Business Unit Name**.
...
1. Click on the **Use Case** field under Default Fields.
2. Type in your use case name under **Options And Groups**.
3. Click **{{< fa plus >}} Add Option** to add the use case to the list. (Optional) Click and hold to drag and drop the use case to a group.
4. Click **Save Configuration** to save the inserted use case.
...
::: {.tc}
[Learn more ...](/guide/validation/manage-validation-guidelines.html#set-up-validation-guidelines){.button target="_blank"}
:::
...
{{< include /guide/validation/_add-risk-areas.qmd >}}

### b. Add validation guidelines

{{< include /guide/validation/_add-validation-guidelines.qmd >}}
