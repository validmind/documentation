...
1. Under Invite By Email:
    ...
    - Click **{{< fa plus >}}** under [role (optional)]{.smallcaps} to assign roles to that user:
        ...
        2. Click **Assign Additional Roles (Optional)**.^[Users invited without additional roles applied will be automatically assigned to a [Basic User]{.bubble} role with minimal permissions.]
