...
_"As an **administrator** who has set up user access to {{< var validmind.platform >}} and customized our model inventory, I want to further customize the {{< var vm.platform >}} by configuring workflows and attestations in accordance with our organization's requirements."_
...
To continue, you need to have been [onboarded](administrator-fundamentals-register.qmd#register){target="_blank"} onto {{< var validmind.training >}} with the [**{{< fa circle-check >}} Validator**]{.bubble} role and completed the first two modules of this course:
...
Our series of four introductory notebooks for model administrators include sample code and how-to information to get you started with {{< var vm.product >}}:
