...
2. Click **{{< fa plus >}} Add Model Stage**.
...
2. Click **{{< fa plus >}} Add Workflow**.
3. On the Add New Workflow modal, enter in a **[title]{.smallcaps}** and a **[description]{.smallcaps}** the workflow.
4. Under **[workflow start]{.smallcaps}**, select when the workflow should be initiated.
5. Under **[workflow expected duration]{.smallcaps}**, define the SLA for the workflow.
6. Click **Add Workflow** to save your blank workflow.
...
1. Under Workspace, select **Workflows**.
2. Click on the workflow you'd added earlier, then:
  - To add a step, drag and drop a new step onto the canvas.
  - Double-click the new step to open up the configuration modal.
3. After you're finished with step configuration, click **Update Step** to apply your changes.
4. After you've configured a step, link your workflow together:
...
5. Designate the end of your workflow by dragging an **{{< fa circle-stop >}} End** step onto the canvas.
6. Link your previous step to the **{{< fa circle-stop >}} End** step by clicking on the bottom **{{< fa circle >}}** of that step, and dragging to the top **{{< fa circle >}}** of the **{{< fa circle-stop >}} End** step.
7. Click **Save Workflow** to apply your changes.
