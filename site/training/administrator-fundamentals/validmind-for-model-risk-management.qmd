...
Without leaving the {{< var validmind.platform >}}, your entire organization
...
Click [{{< fa chevron-right >}}]() to learn how to **set up workflows** for your use case.
...
3. Click on the name of the attestation you added to configure it:
  - Click **{{< fa plus >}} Add Attestation Period** and add a period.
  - Under Relevant Attestation Fields, drag **Relevant Attestation Fields** to display in model snapshots.
  - Under Questionnaire Template, click the template area to edit.
