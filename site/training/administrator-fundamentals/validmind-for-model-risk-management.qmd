...
2. [Set up model stages](#set-up-model-stages)
3. [Set up custom workflows](#set-up-workflows)
...
# Set up model stages {background-color="#083E44" background-image="/training/assets/home-hero.svg"}
...
1. Under Workplace Settings, select **{{< fa align-left >}} Block Library**.
