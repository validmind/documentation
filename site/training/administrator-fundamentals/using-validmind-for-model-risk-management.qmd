...
::: {.tc}
[Learn more ...](/guide/templates/customize-virtual-document-validator.qmd){.button target="_blank"}
:::

:::

::: {.column width="55%" .bl .pl4 .f3}
...
3. Add regulations or policies, associated assessments, and assessment questions.
...
Select the regulation or policy you want to add an assessment for by clicking on it:

{{< include /guide/templates/_add-assessments.qmd >}}

### iii. Add questions

Select the assessment you want to modify by clicking on it.
