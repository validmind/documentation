...
To try out this course, you need to have been [onboarded](administrator-fundamentals-register.qmd#register) onto {{< var vm.product >}} Academy with the [**{{< fa hand >}} Customer Admin**]{.bubble} role.
...
# You're in — let's show you around. {background-color="#083E44" background-image="../assets/home-hero.svg"}
...
# Set up your organization {background-color="#083E44" background-image="../assets/home-hero.svg"}
...
# Onboard users {background-color="#083E44" background-image="../assets/home-hero.svg"}
...
# Manage roles and permissions {background-color="#083E44" background-image="../assets/home-hero.svg"}
...
# Manage groups {background-color="#083E44" background-image="../assets/home-hero.svg"}
...
# Customize templates {background-color="#083E44" background-image="../assets/home-hero.svg"}
...
::: {.tc}
[Learn more ...](/guide/model-documentation/customize-documentation-templates.qmd){.button target="_blank"}
:::
...
# Configure workflows {background-color="#083E44" background-image="../assets/home-hero.svg"}
