...
2. Enter a **[title]{.smallcaps}** (name), select the field **[type]{.smallcaps}**, and indicate what **[inventory record types]{.smallcaps}** the field is available on.
...
2. On the details page of your record, confirm that the new field that you added is present.
