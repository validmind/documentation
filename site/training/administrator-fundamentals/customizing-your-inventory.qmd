...
title: "Customizing Your <br>Inventory"
...
format:
  ...
  # Change this to the file name prepended by a _ to get around the global HTML output settings required by _metadata.yml
    output-file: _customizing-your-inventory.html
    search: false
...
skip_preview: true
aliases:
  - /training/administrator-fundamentals/customizing-your-model-inventory.html
---

# Learning objectives {.center}

_"As an **administrator** who has set up our organization's foundational units and granted users granulated access to the {{< var validmind.platform >}}, I want to configure our inventory and customize our reusable resources."_
...
::: {.f2}
1. [The {{< var validmind.platform >}} inventory](#the-validmind-inventory)
2. [Configure your inventory](#configure-your-inventory)
...
::: {.embed}
Typically, your development team will independently register records in your inventory.

For this training course, you'll register a dummy model-type record to familiarize you with the {{< var validmind.platform >}} interface and the record details page.
:::
...
1. **Select the name of your model you registered** to open up the record details page.
2. Scroll through the page to explore the default layout, and the fields available out-of-the-box.

When you're done, click [{{< fa chevron-right >}}]() to learn how to **customize your inventory.**

::::

# Configure your inventory {background-color="#083E44" background-image="/training/assets/home-hero.svg"}
...
::: {.tc}
[Learn more ...](/guide/inventory/manage-inventory-record-types.qmd){.button target="_blank"}
:::
...
## {background-iframe="https://app.prod.validmind.ai/settings/primary-record-types" background-interactive="true" data-preload="yes"}
...
1. Click **{{< fa plus >}} Add Inventory Record Type**.
2. Enter a a **[name]{.smallcaps}** for your record type.
...
::: {.tc}
[Learn more ...](/guide/inventory/manage-inventory-fields.qmd){.button target="_blank"}
:::
...
{{< include /guide/inventory/_inventory-fields.qmd >}}
...
Aggregation
: Automatically compute a read-only value from [downstream artifacts](/guide/validation/working-with-artifacts.qmd){target="_blank"} linked to this record.

    1. Select the [**[type of artifacts]{.smallcaps}**](/guide/validation/manage-artifact-types.qmd){target="_blank"} to aggregate from.
    2. Select an **[aggregation function]{.smallcaps}**:
        - **COUNT - Count matching entities** — Count the number of matching artifacts for that type.
        - **MIN - Earliest/minimum value** — Return the least recent value from a selected Date type artifact field for that type, then select the Date type **[artifact field]{.smallcaps}** to aggregate on.
        - **MAX - Latest/maximum value** — Return the most recent value from a selected Date type artifact field for that type, then select the Date type **[artifact field]{.smallcaps}** to aggregate on.
    4. (Optional) Click **{{< fa plus >}} Add Rule** under [filters]{.smallcaps} to narrow which artifacts are included in the aggregation.

{{< include /guide/inventory/_field-types.qmd >}}
...
2. Enter a **[title]{.smallcaps}** (name), select the field **[type]{.smallcaps}**.
3. Indicate what **[inventory record types]{.smallcaps}** the field is available on — choose `Model` so that we can review this field on our sample model.
...
1. Select the name of your model you registered earlier to open up the record details page.
...
::: {.tc}
[Learn more ...](/guide/configuration/manage-record-stakeholder-types.qmd){.button target="_blank"}
:::
...
3. Select the **[inventory record types]{.smallcaps}** this stakeholder type is available on.
4. Under **[default on inventory record types]{.smallcaps}**, select which inventory record types should display this stakeholder type by default.
...
::: {.tc}
[Learn more ...](/guide/validation/manage-artifact-types.qmd){.button target="_blank"}
:::
...
{{< include /guide/validation/_artifact-types.qmd >}}
...
### Add or edit artifact types

::: {.f4}

{{< include /guide/validation/_add-edit-artifact-types.qmd >}}
...
{{< include /guide/validation/_add-edit-artifact-statuses.qmd >}}
...
## {background-iframe="https://app.prod.validmind.ai/settings/finding-types" background-interactive="true" data-preload="yes"}
...
1. Click **{{< fa plus >}} Add Artifact Type**.
2. Enter a **[name]{.smallcaps}** (name) and an optional **[description]{.smallcaps}**.
...
::: {.tc}
[Learn more ...](/guide/validation/manage-artifact-fields.qmd){.button target="_blank"}
:::
...
{{< include /guide/validation/_artifact-fields.qmd >}}

::: {.panel-tabset}

### Add or edit artifact fields

{{< include /guide/validation/_add-edit-artifact-fields.qmd >}}
...
## {background-iframe="https://app.prod.validmind.ai/settings/finding-custom-fields" background-interactive="true" data-preload="yes"}
...
1. Click **{{< fa plus >}} Add Field**.
2. Enter a **[title]{.smallcaps}** (name) and select the field **[type]{.smallcaps}**.
3. Select the **[artifact types]{.smallcaps}** this field is available on.
4. Click **Save** to add your field.
...
::: {.tc}
[Learn more ...](/guide/validation/manage-artifact-severities.qmd){.button target="_blank"}
:::
...
{{< include /guide/validation/_artifact-severities.qmd >}}

::: {.panel-tabset}

### Add artifact severities

{{< include /guide/validation/_add-artifact-severities.qmd >}}

### Reorder artifact severities

{{< include /guide/validation/_reorder-artifact-severities.qmd >}}
...
## {background-iframe="https://app.prod.validmind.ai/settings/finding-severities" background-interactive="true" data-preload="yes"}
...
2. Enter a **[name]{.smallcaps}** and select a **[color]{.smallcaps}** for the severity.
...
::: {.tc}
[Learn more ...](/guide/templates/working-with-document-templates.qmd){.button target="_blank"}
:::
...
::: {.tc}
[Learn more ...](/guide/templates/customize-document-templates.qmd){.button target="_blank"}
:::
...
{{< include /guide/templates/_customize-document-templates.qmd >}}
...
### Add shared blocks to templates
...
3. Click **{{< fa pencil >}} Edit Outline**.
4. Click **{{< fa plus >}}** on any section of your template that does not have child sections.
5. Select **{{< fa align-left >}} Text Block**.
...
9. Add a description in **[version notes]{.smallcaps}** to track your changes.
...
- [x] Configure your inventory record fields
- [x] Define granular access to inventory fields
...
<br><br>
<!-- IMPORTANT: USE THE .HTML PATH AND NOT THE .QMD PATH FOR THE REVEALJS OUTPUT -->
[{{< var vm.product >}} for Risk Management](using-validmind-for-risk-management.html){.button target="_blank"}
:::
