...
3. [Configure document templates](#configure-document-templates)
...
2. Enter a **Name** for your record type.
...
: Automatically compute a read-only value from [downstream artifacts](/guide/validation/working-with-artifacts.qmd){target="_blank"} linked to this record.
    ...
    1. Select the [**Artifacts**](/guide/validation/manage-artifact-types.qmd){target="_blank"} to aggregate from.
...
3. Indicate what **Inventory Record Types** the field is available on — choose `Model` so that we can review this field on our sample model.
...
# Configure document templates {background-color="#083E44" background-image="/training/assets/home-hero.svg"}
...
::: {.tc}
[Learn more ...](/guide/templates/manage-document-types.qmd){.button target="_blank"}
:::
...
## {background-iframe="https://app.prod.validmind.ai/settings/document-types" background-interactive="true" data-preload="yes"}
...
2. Enter the document type details, including the inventory record relationships and permissions.
3. Click **Create Document Type** to add your document type.
...
1. Select one of the tabs for the [type of template you want to create](/guide/templates/manage-document-types.qmd){target="_blank"}.
