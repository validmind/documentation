...
Aggregation
: Automatically compute a read-only value from [downstream artifacts](/guide/model-validation/working-with-artifacts.qmd){target="_blank"} linked to this record.

    1. Select the [**[type of artifacts]{.smallcaps}**](/guide/model-validation/manage-artifact-types.qmd){target="_blank"} to aggregate from.
...
::: {.tc}
[Learn more ...](/guide/model-validation/manage-artifact-types.qmd){.button target="_blank"}
:::
...
::: {.tc}
[Learn more ...](/guide/model-validation/manage-artifact-fields.qmd){.button target="_blank"}
:::
...
::: {.tc}
[Learn more ...](/guide/model-validation/manage-artifact-severities.qmd){.button target="_blank"}
:::
