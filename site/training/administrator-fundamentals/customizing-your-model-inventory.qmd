...
1. Under Workspace Settings, select **Model Inventory Fields**.
...
Under User Permissions, select **Model Stakeholder Type**:
...
3. Click on the stakeholder type you added above.
