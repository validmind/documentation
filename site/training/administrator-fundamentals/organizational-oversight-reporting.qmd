...
::: {.embed}
Default report widgets are provided in the **Models** and **Findings** pages.

You can supplement these with your own custom reports in additional pages to suit your organizational needs.
...
Reports will not include data or findings from [archived models](/guide/model-inventory/archive-delete-models.qmd).
:::
:::
...
- [x] Create custom report pages and visualizations
