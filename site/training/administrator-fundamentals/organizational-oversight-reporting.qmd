...
::: {.f2}
1. [Audit record activity](#audit-model-activity)
...
::: {.tc}
**View record workflow**
:::

1. Select the name of your record you registered for this course to open up the record details page.
2. On the landing page of your record, locate the [active workflows]{.smallcaps} section.
...
::: {.embed}
Default report widgets are provided in the **Models** and **Validation Issues** dashboards.
...
Reports will not include data or artifacts from [archived models](/guide/inventory/archive-delete-records.qmd){target="_blank"}.
:::
:::
