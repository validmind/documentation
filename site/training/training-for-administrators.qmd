...
:::: {.columns}
::: {.column width="30%" .pr4 .f2}
Assign roles to users to define their responsibilities based on your organization's structure, granting them acccess to features within the {{< var validmind.platform >}}.
:::
