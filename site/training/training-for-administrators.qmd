...
To try out this training module, you need to have been [onboarded](training-overview.html#onboarding) onto ValidMind Academy with the **Customer Admin** role.
...
From  **Settings** in the {{< var vm_platform >}}, <br>you can: 
...
{{< include ../guide/_manage-users-monitor.qmd >}}
:::
...
1. <a href="../guide/set-up-model-workflows.html#configure-workflow-steps" target="_blank">Configure the workflow steps</a>
2. <a href="../guide/set-up-model-workflows.qmd#link-workflow-together" target="_blank">Link the workflow together</a>

<form method="get" action="../guide/working-with-model-workflows.html" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 24px; padding: 6.25px 12.5px; margin-top: 10px; margin-bottom: 20px;">Learn more ...</button>
</form>
:::
...
::: footer
:::: {.absolute bottom=0 left=50 right=50 .w-95 .f3 .tc .pl4 .bg-near-white .ba .b--dark-pink .bw1 .br3 .near-black .shadow-5}
Modify the user action for the default **Model Inventory** workflow, so that the **Submit for Initial Validation** action button is displayed for model owners.
