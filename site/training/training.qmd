...
listing:
  ...
  - id: sample-notebooks
    ...
    - title: "Quickstart for model documentation"
      path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/quickstart_customer_churn_full_suite.ipynb"
    ...
    - title: "{{< var vm.product >}} introduction for model developers"
      path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/tutorials/intro_for_model_developers.ipynb"
      subtitle: "Open notebook in JupyterHub {{< fa chevron-right >}}"
    ...
    - title: "Document an application scorecard model"
      path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_demo.ipynb"
      subtitle: "Open notebook in JupyterHub {{< fa chevron-right >}}"
    ...
    - title: "Prompt validation for large language models (LLMs)"
      path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/code_samples/nlp_and_llm/foundation_models_integration_demo.ipynb"
      subtitle: "Open notebook in JupyterHub {{< fa chevron-right >}}"
