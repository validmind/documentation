...
:::: {.flex .flex-wrap .justify-around .hero-training}
...
:::: {.f2}
Ready to dive into the world of model risk, for free?
::::

:::: {.f4}
Gain **hands-on experience** and discover the platform that simplifies **model risk management**. Our **free** courses make navigating **AI and governance** straightforward, practical, and even fun — build your confidence in managing **model risk**, one **engaging course** at a time!
::::
...
::: {.column-page .pt5}
## Available courses — Getting started
...
:::: {.flex .flex-wrap .justify-around .pt5}
