---
title: "Welcome to {{< var vm.product >}} Training"
date: last-modified
filters:
  - tachyons
aliases:
...
Gain hands-on experience and explore what {{< var vm.product >}} has to offer with our training environment. 
...
![](/assets/img/validmind-demo-compact.png){width=85% fig-alt="An image showing the main ValidMind Platform main dashboard"}
...
1. Get your access credentials from {{< var vm.product >}}. 
...
1. Get your access credentials for the {{< var vm.platform >}} by signing up with {{< var vm.product >}}: [{{< var url.us1 >}}]({{< var url.us1 >}})
...
2. When you receive your access credentials, make sure you can log in:
   ...
   - **{{< var vm.product >}} Jupyter Hub** — <https://jupyterhub.validmind.ai/>
   - **{{< var validmind.platform >}}** — [{{< var url.us1 >}}]({{< var url.us1 >}})

3. Join a kick-off session with {{< var vm.product >}} to get a free instructor-led hands-on demo.
...
----------|-----------------|
| **[Quickstart for model documentation](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/quickstart_customer_churn_full_suite.ipynb)**<br>Gets you started with the basic process of documenting models with {{< var vm.product >}}, from the {{< var vm.developer >}} to the {{< var vm.platform >}}. | [Demo] Customer Churn Model
| **[{{< var vm.product >}} introduction for model developers](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/intro_for_model_developers.ipynb)**<br>Learn how the end-to-end documentation process works based on common scenarios you encounter in model development settings. | [Demo] Customer Churn Model
