...
listing:
  - id: training-courses
    ...
    sort: false
    contents:
    - path: training-for-administrators-fundamentals-register.qmd
      image: /assets/img/icon-automate.svg
    - path: training-for-model-developers-fundamentals-register.qmd
      image: /assets/img/icon-automate.svg
    - path: training-for-model-validators-fundamentals-register.qmd
      image: /assets/img/icon-automate.svg
---
...
## Our interactive training environment 
