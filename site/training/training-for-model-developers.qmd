...
See the _code snippet_? It connects <br> notebook to ValidMind.
:::
...
:::: {.absolute bottom=15 .w-100 .f3 .tc .pl4 .bg-near-white .ba .b--dark-pink .bw1 .br3 .near-black .shadow-5}
**TRY IT:** Go to the {{< var vm_platform >}}. 
...
**TRY IT:** In the documentation, post a comment, reply to it, and then resolve the thread. Review your comments in the **Activity Feed** on the front page. 
