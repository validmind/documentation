...
format:
  revealjs:
    ...
    view-distance: 2
    logo: /validmind.png
    footer: "{{< var vm.product >}} Academy | [Home {{< fa person-walking-dashed-line-arrow-right >}}](training.qmd)"
...
To try out this training module, you need to have been [onboarded](training.qmd#onboarding) onto {{< var vm.product >}} Academy with the **Developer** role.
...
<form method="get" action="https://app.prod.validmind.ai" target="_blank" style="display: flex; justify-content: center;">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 32px; padding: 6.25px 12.5px; margin-top: 40px; margin-bottom: 40px;">Log into {{< var vm.product >}}</button>
</form>
:::
::::
...
::: {.f4}
When run on JupyterHub, this notebook will generate model documentation and upload it to {{< var vm.product >}}. After you finish this training module, your own training notebook will look similar, complete with output. 
...
Or, find your next learning resource on [{{< var vm.product >}} Academy](training.qmd).
