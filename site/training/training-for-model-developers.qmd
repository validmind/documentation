...
The notebook includes sample code and explanations, all in one place. You will run this notebook on JupyterHub shortly — for now, explore the contents and then click [{{< fa chevron-right >}}]() to continue.
:::
...
- Review and edit the documentation <br>generated with the introductory notebook.
...
See the _code snippet_? It lets <br>you connect the model with <br>a notebook.
:::
...
## Initialize the {{< var vm_dev >}} {.scrollable}
...
## {background-iframe="../notebooks/tutorials/intro_for_model_developers.html#initializing-the-validmind-developer-framework" background-interactive="yes" data-preload="yes"} 
...
:::: {.columns}
::: {.column width="30%" .pr4 .f2}
Have a question about the model? Collaborate with other developers or with your model validator right in the model documentation.
