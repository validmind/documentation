...
1. Select a model by clicking on it or [find your model by applying a filter or searching for it](/guide/working-with-model-inventory.qmd#search-filter-and-sort-models).
