...
**This is the {{< var validmind_platform >}}.**
...
# Initialize the {{< var validmind_developer >}}
...
4. Click {{< fa square-plus >}} and then select **Test-driven block**:
   ...
   ![Screenshot showing the selected test result in the dialog](/notebooks/images/selecting-high-pearson-correlation-test.png){fig-alt="Screenshot showing the selected test result in the dialog"}
...
<form method="get" action="/guide/model-documentation/view-documentation-activity.html" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 24px; padding: 6.25px 12.5px; margin-top: 10px; margin-bottom: 20px;">Learn more ...</button>
</form>
:::
