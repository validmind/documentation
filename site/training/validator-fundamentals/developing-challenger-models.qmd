...
## {background-iframe="/notebooks/tutorials/model_validation/3-developing_challenger_model.html#run-model-performance-tests" data-preload="yes"}

:::: {.absolute bottom=15 .w-100 .f4 .tc .pl4 .overlay}
**Run model performance tests**

::: {.f5}
Use [`vm.tests.list_tests()`](/validmind/validmind/tests.qmd#list_tests) to identify all the model performance tests for classification:
...
[Learn more ...](/notebooks/tutorials/model_validation/3-developing_challenger_model.html#log-a-model-finding){.button target="_blank"}
...
::: {.f6}
2.2.2. Model Performance — **Link Finding to Report** {{< fa chevron-right >}} **{{< fa plus >}} Create New Finding** > Enter your finding details {{< fa chevron-right >}} Select your finding: **Update Linked Findings**
...
## {background-iframe="/notebooks/tutorials/model_validation/3-developing_challenger_model.html#run-diagnostic-tests" data-preload="yes"}
...
## {background-iframe="/notebooks/tutorials/model_validation/3-developing_challenger_model.html#run-feature-importance-tests" data-preload="yes"}
...
## {background-iframe="/notebooks/tutorials/model_validation/4-finalize_validation_reporting.html" background-interactive="yes" data-preload="yes"}
...
## {background-iframe="/notebooks/tutorials/model_validation/4-finalize_validation_reporting.html#initialize-the-validmind-library" data-preload="yes"}
...
1. Open **4 — Finalize testing and validation**: [{{< fa square-arrow-up-right >}} JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/model_validation/4-finalize_validation_reporting.ipynb){target="_blank"}
2. Run all the cells under the **Setting up** section.
...
## {background-iframe="/notebooks/tutorials/model_validation/4-finalize_validation_reporting.html#implement-a-custom-inline-test" data-preload="yes"}
...
1. Continue with **4 — Finalize testing and validation**: [{{< fa square-arrow-up-right >}} JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/model_validation/4-finalize_validation_reporting.ipynb){target="_blank"}
2. Run all the cells in the sections under Implementing a custom tests: **Implement a custom inline test**
...
## {background-iframe="/notebooks/tutorials/model_validation/4-finalize_validation_reporting.html#use-external-test-providers" data-preload="yes"}
...
1. Continue with **4 — Finalize testing and validation**: [{{< fa square-arrow-up-right >}} JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/model_validation/4-finalize_validation_reporting.ipynb){target="_blank"}
2. Run all the cells in the sections under Implementing a custom tests: **Use external test providers**
...
## {background-iframe="/notebooks/tutorials/model_validation/4-finalize_validation_reporting.html#verify-test-runs" data-preload="yes"}
