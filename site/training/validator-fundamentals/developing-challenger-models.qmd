...
4. Under the Model Performance Metrics section, locate Findings then click **Link Finding to Report** and select **Validation Issue**.
5. Click **{{< fa plus >}} Add Validation Issue Finding** to add a finding.
