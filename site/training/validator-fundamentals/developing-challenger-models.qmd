...
3 — [Developing a potential challenger model](/notebooks/tutorials/validation/3-developing_challenger_model.ipynb){target="_blank"}<br>
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html" background-interactive="yes" data-preload="yes"}
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html#initialize-the-validmind-library" data-preload="yes"}
...
1. Open **3 — Developing a potential challenger model**: [{{< fa square-arrow-up-right >}} JupyterHub]({{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/tutorials/validation/3-developing_challenger_model.ipynb){target="_blank"}
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html#import-the-champion-model" data-preload="yes"}
...
1. Continue with **3 — Developing a potential challenger model**: [{{< fa square-arrow-up-right >}} JupyterHub]({{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/tutorials/validation/3-developing_challenger_model.ipynb){target="_blank"}
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html#training-a-potential-challenger-model" data-preload="yes"}
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html#initialize-the-validmind-models" data-preload="yes"}
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html#run-model-performance-tests" data-preload="yes"}
...
::: {.tc}
[Learn more ...](/notebooks/EXECUTED/validation/3-developing_challenger_model.html#log-an-artifact){.button target="_blank"}
...
As we can observe from the output in our notebook, our champion model doesn't pass the `MinimumAccuracy` test based on the default thresholds of the out-of-the-box test, so let's log an artifact in the {{< var validmind.platform >}}:

#### Create an artifact via a validation report

{{< include /guide/validation/_link-artifacts-to-reports.qmd >}}
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html#run-diagnostic-tests" data-preload="yes"}
...
## {background-iframe="/notebooks/EXECUTED/validation/3-developing_challenger_model.html#run-feature-importance-tests" data-preload="yes"}
