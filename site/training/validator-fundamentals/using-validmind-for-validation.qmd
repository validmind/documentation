...
2. Remove yourself as an owner by clicking on the **Owners** tile, then clicking on the **x** next to your name. Click **Save** to apply your changes to that role.
...
3. Under **Create Document**, select `Generic Validation Report` from the **Template** drop-down menu.
4. Click **Use Template** to apply the template.
