...
2. Remove yourself as a developer by clicking on the **[developers]{.smallcaps}** tile, then clicking on the **x** next to your name. Click **Save** to apply your changes to that role.
3. Add yourself as a validator by clicking on the [validators]{.smallcaps} tile, and selecting your name from the drop-down menu. Click **Save** to apply your changes to that role.
