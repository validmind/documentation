...
2. Filter this list to include only validation issues you want to see, or toggle visibilty for column headers.
...
**Review {{< fa square-poll-vertical >}} Analytics**
...
2. Select **Validation Issues** to review reports on validation issues.
