...
2. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** > **Validation Report**.
...
2. On the left sidebar that appears for your model, click **{{< fa file >}} Documents** > **Validation Report**.
...
1. Select the name of your model you registered for this course to open up the model details page.
2. On the left sidebar that appears for your model, click **{{< fa file >}} Documents** > **Documentation**.
