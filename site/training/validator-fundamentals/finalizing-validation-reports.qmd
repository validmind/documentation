...
::: {.f2}
1. [Refine validation report](#refine-validation-report)
3. [Submit validation report for approval](#submit-report-for-approval)
...
To continue, you need to have been [onboarded](developer-fundamentals-register.qmd#register){target="_blank"} onto {{< var validmind.training >}} with the [**{{< fa circle-check >}} Validator**]{.bubble} role and completed the first three modules of this course:
