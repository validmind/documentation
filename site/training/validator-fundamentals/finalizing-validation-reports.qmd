...
::: {.tc}
[Learn more ...](/guide/validation/log-artifacts.qmd){.button target="_blank"}
...
::: {.tc}
[Learn more ...](/guide/validation/update-artifacts.qmd#track-artifact-resolution){.button target="_blank"}
:::
...
4. When you are finished editing, set the validation issue **Status** to `Closed`.
...
4. Select a **Regulation** and an associated **Assessment** from the drop-down menus to to check your report against.
