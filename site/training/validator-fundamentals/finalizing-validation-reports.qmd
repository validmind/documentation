...
{{< include /guide/documentation/_check-model-documents.qmd >}}
...
::: {.tc}
[Learn more ...](/guide/model-validation/add-manage-artifacts.qmd){.button target="_blank"}
...
::: {.tc}
[Learn more ...](/guide/model-validation/add-manage-artifacts.qmd#track-issue-resolution){.button target="_blank"}
:::
...
{{< include /guide/model-validation/_track-artifact-resolution.qmd >}}
...
{{< include /guide/model-validation/_view-all-artifacts.qmd >}}
