...
To try out this course, you need to have been [onboarded](validator-fundamentals-register.qmd#register) onto {{< var vm.product >}} Academy with the [**{{< fa circle-check >}} Validator**]{.bubble} role.
