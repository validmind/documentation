...
From the **{{< fa cubes >}} Model Inventory**:
...
:::: {.absolute bottom=15 .w-100 .f3 .tc .pl4 .overlay}
On JupyterHub: <a href="https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/intro_for_model_developers.ipynb" target="_blank">Run the cells under **Model Testing** to train your model and then run **3. Implementing custom tests**</a>.
