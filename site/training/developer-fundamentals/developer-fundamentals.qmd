...
format:
  revealjs:
    ...
    view-distance: 2
    logo: /validmind.png
    footer: "{{< var vm.product >}} Academy | [Home {{< fa person-walking-dashed-line-arrow-right >}}](/training/training.qmd)"
...
To try out this course, you need to have been [onboarded](developer-fundamentals-register.qmd#register) onto {{< var vm.product >}} Academy with the [**{{< fa code >}} Developer**]{.bubble} role.
...
Or, find your next learning resource on [{{< var vm.product >}} Academy](/training/training.qmd).
