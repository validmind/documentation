...
# Train a model {background-color="#083E44" background-image="../assets/home-hero.svg"}
...
:::: {.absolute bottom=15 .w-100 .f3 .tc .pl4 .overlay}
On JupyterHub: <a href="https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/intro_for_model_developers.ipynb" target="_blank">Run the cells under **Model Testing**</a>.
