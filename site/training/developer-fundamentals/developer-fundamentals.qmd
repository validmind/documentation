...
4. Hover the cursor after the Pearson Correlation Matrix content block until a horizontal dashed line with a {{< fa square-plus >}} button appears that indicates you can insert a new block:
   ...
   ![Screenshot showing the insert button for test-driven blocks](/guide/model-documentation/add-content-block.gif){width=90% fig-alt="Screenshot showing the insert button for test-driven blocks" .screenshot}
...
![](/releases/2024-may-22/generate-with-ai.png){fig-alt="A screenshot showing a text editor with a toolbar and the Generate with AI button on the right" .screenshot}
:::

::: {.column width="50%"}
Accept the text or try again:

![](/releases/2024-may-22/ai-content-builder.png){fig-alt="A screenshot showing a modal with AI-generated text" .screenshot}
:::
:::: -->