...
::: {.f2}
1. Edit model documentation
3. Submit documentation for approval
4. Track model activity
...
[Learn more ...](https://docs.validmind.ai/validmind/validmind/vm_models.html#TestSuite.get_default_config){.button target="_blank"}
:::
...
::: {.f5}
The default configuration does not assign any inputs to a test, but you can assign inputs to individual tests as needed depending on the datasets and models you want to pass to individual tests:
