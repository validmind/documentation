...
::: {.f5}
Then, we'll use the [`init_dataset()` function](/validmind/validmind.html#init_dataset){target="_blank"} to connect the sample data with a {{< var vm.product >}} `Dataset` object in preparation for running tests:
...
::: {.f5}
You run individual tests by calling the [`run_test` function](https://docs.validmind.ai/validmind/validmind/tests.html#run_test){target="_blank"} provided by the `validmind.tests` module:
...
::: {.f5}
The [`run_documentation_tests()` function](/validmind/validmind.html#run_documentation_tests){target="_blank"} allows you to run multiple tests at once and automatically log the results to your documentation:
...
::: {.f5}
Use the `init_dataset` and [`init_model` functions](/validmind/validmind.html#init_model){target="_blank"} to initialize these objects:
...
::: {.f5}
Use the [`assign_predictions()` method](/validmind/validmind/vm_models.html#VMDataset.assign_predictions){target="_blank"} from the `Dataset` object to link existing predictions to any number of models:
