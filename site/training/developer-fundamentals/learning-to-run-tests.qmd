...
For now, **scroll through these test descriptions** to explore. When you are done, click [{{< fa chevron-right >}}]() to continue.
...
1. Open **102 Start the model development process**: [{{< fa square-arrow-up-right >}} JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/model_development/102-start_development_process.ipynb){target="_blank"}
2. Run the following cell in the Setting up section: **Identify qualitative tests**
...
::: {.f5}
Then, we'll use the [`init_dataset()` function](https://docs.validmind.ai/validmind/validmind.html#init_dataset){target="_blank"} to connect the sample data with a {{< var vm.product >}} `Dataset` object in preparation for running tests:
...
1. Open **102 Start the model development process**: [{{< fa square-arrow-up-right >}} JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/model_development/102-start_development_process.ipynb){target="_blank"}
2. Run the following cell in the Running tests section: **Run tabular data tests**.
...
::: {.f5}
Let's retrieve the list of features with the highest correlation coefficients and use them to reduce the final list of features for modeling:

1. Open **102 Start the model development process**: [{{< fa square-arrow-up-right >}} JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/model_development/102-start_development_process.ipynb){target="_blank"}
2. Run the following cell in the Running tests section: **Utilize test output**.
...
[Learn more ...](https://docs.validmind.ai/developer/model-documentation/work-with-test-results.html){.button target="_blank"}
:::
...
4. Hover under the Pearson Correlation Matrix content block until a horizontal dashed line with a **+** button appears, indicating that you can insert a new block.
   ...
   ![Insert block button in model documentation](/notebooks/tutorials/model_development/add-content-block.gif){fig-alt="Screenshot showing insert block button in model documentation" .screenshot}
...
5. Click **+** and then select **Test-Driven Block**:
    ...
    ![The HighPearsonCorrelation test selected](/notebooks/tutorials/model_development/selecting-high-pearson-correlation-test.png){fig-alt="Screenshot showing the HighPearsonCorrelation test selected" .screenshot}
...
7. Finalize the documentation by editing the test result's description block to explain the changes you made to the raw data and the reasons behind them as shown in the screenshot below:
    ...
    ![The inserted High Pearson Correlation block](/notebooks/tutorials/model_development/high-pearson-correlation-block.png){fig-alt="Screenshot showing the inserted High Pearson Correlation block" .screenshot}
...
4. Insert a test-driven block: `HighPearsonCorrelation:balanced_raw_dataset`
