...
2 — [Start the model development process](/notebooks/tutorials/development/2-start_development_process.ipynb){target="_blank"}<br>
...
## {background-iframe="/notebooks/EXECUTED/development/2-start_development_process.html#initialize-the-validmind-datasets" data-preload="yes"}
...
::: {.tc}
[Learn more ...](/notebooks/EXECUTED/development/2-start_development_process.ipynb#add-individual-test-results-to-model-documentation){.button target="_blank"}
...
{{< include /guide/documentation/_add-test-results.qmd >}}
...
## {background-iframe="/notebooks/EXECUTED/development/2-start_development_process.html#initialize-model-evaluation-objects" data-preload="yes"}
