...
<span class="kw">def</span><span class="name">get_test_suite</span>(<span class="params"><span class="n">test_suite_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">section</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">\*args</span><span class="muted">,</span></span><span class="params"><span class="n">\*\*kwargs</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">TestSuite</span></span>:
...
<span class="kw">def</span><span class="name">init</span>(<span class="params"><span class="n">project</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">api_key</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">api_secret</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">api_host</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">monitoring</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">bool</span><span class="o">=</span><span class="kc">False</span><span class="muted">,</span></span><span class="params"><span class="n">generate_descriptions</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span></span>):
...
<span class="kw">def</span><span class="name">init_dataset</span>(<span class="params"><span class="n">dataset</span><span class="muted">,</span></span><span class="params"><span class="n">model</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">index</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">index_name</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">date_time_index</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">bool</span><span class="o">=</span><span class="kc">False</span><span class="muted">,</span></span><span class="params"><span class="n">columns</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">text_column</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">target_column</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">feature_columns</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">extra_columns</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">dict</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">class_labels</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">dict</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">type</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">input_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">\_\_log</span><span class="o">=</span><span class="kc">True</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">VMDataset</span></span>:
...
<span class="kw">def</span><span class="name">init_model</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">object</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">input_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="s1">'model'</span><span class="muted">,</span></span><span class="params"><span class="n">attributes</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">dict</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">predict_fn</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">callable</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">\_\_log</span><span class="o">=</span><span class="kc">True</span><span class="muted">,</span></span><span class="params"><span class="n">\*\*kwargs</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">VMModel</span></span>:
...
<span class="kw">def</span><span class="name">init_r_model</span>(<span class="params"><span class="n">model_path</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="muted">,</span></span><span class="params"><span class="n">input_id</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="s1">'model'</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">VMModel</span></span>:
...
<span class="kw">def</span><span class="name">log_metric</span>(<span class="params"><span class="n">key</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="muted">,</span></span><span class="params"><span class="n">value</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">float</span><span class="muted">,</span></span><span class="params"><span class="n">inputs</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">params</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">recorded_at</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">thresholds</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="o">=</span><span class="kc">None</span></span>):
...
<span class="name">RawData</span>(<span class="param"><span class="n">log</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">bool</span><span class="o">=</span><span class="kc">False</span><span class="muted">,</span></span><span class="param"><span class="n">\*\*kwargs</span></span>)
...
<span class="kw">def</span><span class="name">inspect</span>(<span class="param"><span class="bp">self</span><span class="muted">,</span></span><span class="param"><span class="n">show</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">bool</span><span class="o">=</span><span class="kc">True</span></span>):
