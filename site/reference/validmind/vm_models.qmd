...
<span class="kw">def</span><span class="name">get_default_config</span>()<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">dict</span></span>:
...
<span class="kw">def</span><span class="name">get_tests</span>()<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --></span>:
...
<span class="kw">def</span><span class="name">num_tests</span>()<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">int</span></span>:
...
<span class="kw">def</span><span class="name">run</span>(<span class="params"><span class="n">send</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">bool</span><span class="o">=</span><span class="kc">True</span><span class="muted">,</span></span><span class="params"><span class="n">fail_fast</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">bool</span><span class="o">=</span><span class="kc">False</span></span>):
...
<span class="kw">def</span><span class="name">summarize</span>(<span class="params"><span class="n">show_link</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">bool</span><span class="o">=</span><span class="kc">True</span></span>):
...
<span class="kw">def</span><span class="name">assign_predictions</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">VMModel</span><span class="muted">,</span></span><span class="params"><span class="n">prediction_column</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">prediction_values</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">probability_column</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">probability_values</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">prediction_probabilities</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">list</span><span class="o">=</span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">\*\*kwargs</span></span>):
...
<span class="kw">def</span><span class="name">prediction_column</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">VMModel</span><span class="muted">,</span></span><span class="params"><span class="n">column_name</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">str</span></span>:
...
<span class="kw">def</span><span class="name">probability_column</span>(<span class="params"><span class="n">model</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">VMModel</span><span class="muted">,</span></span><span class="params"><span class="n">column_name</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="kc">None</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">str</span></span>:
...
<span class="kw">def</span><span class="name">with_options</span>(<span class="params"><span class="n">\*\*kwargs</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">VMDataset</span></span>:
...
<span class="kw">def</span><span class="name">y_df</span>()<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --></span>:
...
<span class="kw">def</span><span class="name">y_pred</span>(<span class="params"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --></span>:
...
<span class="kw">def</span><span class="name">y_pred_df</span>(<span class="params"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --></span>:
...
<span class="kw">def</span><span class="name">y_prob</span>(<span class="params"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --></span>:
...
<span class="kw">def</span><span class="name">y_prob_df</span>(<span class="params"><span class="n">model</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --></span>:
...
<span class="kw">def</span><span class="name">with_options</span>(<span class="params"><span class="n">\*\*kwargs</span></span>)<span class="p"> → </span><span class="return-annotation"><!-- types.jinja2 - format_type --><span class="n">VMInput</span></span>:
