...
<span class="kw">def</span><span class="name">load_data</span>(<span class="params"><span class="n">source</span><span class="o">=</span><span class="s1">'online'</span><span class="muted">,</span></span><span class="params"><span class="n">dataset_size</span><span class="o">=</span><span class="kc">None</span></span>):
