...
<span class="kw">def</span><span class="name">get_model_info</span>(<span class="params"><span class="n">model</span></span>)
...
<span class="kw">def</span><span class="name">ModelMetadata</span>(<span class="params"><span class="n">model</span></span>)
