...
<span class="kw">def</span> <span class="name">adj_r2_score</span>(<span class="params"><span class="n">actual</span><span class="p">:</span><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'np'}, {'cls': 'ExprName', 'name': 'ndarray'}]}</span><span class="muted">,</span></span><span class="params"><span class="n">predicted</span><span class="p">:</span><span class="n">{'cls': 'ExprAttribute', 'values': [{'cls': 'ExprName', 'name': 'np'}, {'cls': 'ExprName', 'name': 'ndarray'}]}</span><span class="muted">,</span></span><span class="params"><span class="n">rowcount</span><span class="p">:</span><span class="n">int</span><span class="muted">,</span></span><span class="params"><span class="n">featurecount</span><span class="p">:</span><span class="n">int</span></span>)
