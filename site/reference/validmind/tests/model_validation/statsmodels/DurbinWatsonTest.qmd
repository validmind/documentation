---
title: "[validmind](/reference/validmind.html).DurbinWatsonTest"
...
## DurbinWatsonTest[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="kw">def</span><span class="name">DurbinWatsonTest</span>(<span class="params"><span class="n">dataset</span><span class="muted">,</span></span><span class="params"><span class="n">model</span><span class="muted">,</span></span><span class="params"><span class="n">threshold</span><span class="o">=</span><!-- types.jinja2 - format_type --><span class="p">\[</span><!-- types.jinja2 - format_type --><span class="n">1.5</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">2.5</span><span class="p">\]</span></span>):
