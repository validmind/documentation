...
def KMeansClustersOptimization(
    model: VMModel,
    dataset: VMDataset,
    n_clusters: {'cls': 'ExprSubscript', 'left': {'cls': 'ExprName', 'name': 'Union'}, 'slice': {'cls': 'ExprTuple', 'elements': [{'cls': 'ExprSubscript', 'left': {'cls': 'ExprName', 'name': 'List'}, 'slice': {'cls': 'ExprName', 'name': 'int'}}, 'None'], 'implicit': True}} = None):
```
