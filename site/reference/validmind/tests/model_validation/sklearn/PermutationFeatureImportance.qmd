...
def PermutationFeatureImportance(
    model: VMModel,
    dataset: VMDataset,
    fontsize: {'cls': 'ExprSubscript', 'left': {'cls': 'ExprName', 'name': 'Union'}, 'slice': {'cls': 'ExprTuple', 'elements': [{'cls': 'ExprName', 'name': 'int'}, 'None'], 'implicit': True}} = None,
    figure_height: {'cls': 'ExprSubscript', 'left': {'cls': 'ExprName', 'name': 'Union'}, 'slice': {'cls': 'ExprTuple', 'elements': [{'cls': 'ExprName', 'name': 'int'}, 'None'], 'implicit': True}} = None):
```
