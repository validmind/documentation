---
title: "[validmind](/reference/validmind.html).ModelsPerformanceComparison"
...
## multiclass_roc_auc_score<span class='muted'>()</span>
...
## ModelsPerformanceComparison[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="kw">def</span><span class="name">ModelsPerformanceComparison</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span><span class="muted">,</span></span><span class="params"><span class="n">models</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->list\[<!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a>\]</span></span>)
