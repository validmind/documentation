---
title: "[validmind](/reference/validmind.html).OverfitDiagnosis"
...
## OverfitDiagnosis[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="kw">def</span><span class="name">OverfitDiagnosis</span>(<span class="params"><span class="n">model</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a></span><span class="muted">,</span></span><span class="params"><span class="n">datasets</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->List\[<!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a>\]</span><span class="muted">,</span></span><span class="params"><span class="n">metric</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type -->str</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">cut_off_threshold</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type -->float</span><span class="o"> = </span><span class="kc">{'cls': 'ExprName', 'name': 'DEFAULT_THRESHOLD'}</span></span>)
