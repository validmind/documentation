...
<span class="kw">def</span><span class="name">WeakspotsDiagnosis</span>(<span class="params"><span class="n">datasets</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->List\[<!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a>\]</span><span class="muted">,</span></span><span class="params"><span class="n">model</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a></span><span class="muted">,</span></span><span class="params"><span class="n">features_columns</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->Union\[<!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->List\[<!-- types.jinja2 - format_type -->str\], <!-- types.jinja2 - format_type --> None \]</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">metrics</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->Union\[<!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->Dict\[<!-- types.jinja2 - format_type -->str, <!-- types.jinja2 - format_type -->Callable\], <!-- types.jinja2 - format_type --> None \]</span><span class="o"> = </span><span class="kc">None</span><span class="muted">,</span></span><span class="params"><span class="n">thresholds</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->Union\[<!-- types.jinja2 - format_type --><!-- types.jinja2 - format_type -->Dict\[<!-- types.jinja2 - format_type -->str, <!-- types.jinja2 - format_type -->float\], <!-- types.jinja2 - format_type --> None \]</span><span class="o"> = </span><span class="kc">None</span></span>)
