---
title: "[validmind](/reference/validmind.html).NegativeInstruction"
...
<span class="kw">def</span><span class="name">get_explanation</span>(<span class="params"><span class="n">response</span><span class="p">: </span><!-- types.jinja2 - format_type --><span class="nb">str</span></span>)
...
<span class="kw">def</span><span class="name">get_score</span>(<span class="params"><span class="n">response</span><span class="p">: </span><!-- types.jinja2 - format_type --><span class="nb">str</span></span>)
