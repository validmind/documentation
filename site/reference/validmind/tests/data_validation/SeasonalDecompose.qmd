...
<span class="kw">def</span> <span class="name">SeasonalDecompose</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span><span class="muted">,</span></span><span class="params"><span class="n">seasonal_model</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type -->str</span><span class="o"> = </span><span class="kc">'additive'</span></span>)
