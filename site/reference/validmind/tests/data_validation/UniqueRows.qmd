...
<span class="kw">def</span><span class="name">UniqueRows</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span><span class="muted">,</span></span><span class="params"><span class="n">min_percent_threshold</span><span class="p">:</span><span class="nb"><!-- types.jinja2 - format_type -->float</span><span class="o"> = </span><span class="kc">1</span></span>)
