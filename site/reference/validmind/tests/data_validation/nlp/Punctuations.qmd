...
<span class="kw">def</span><span class="name">Punctuations</span>(<span class="params"><span class="n">dataset</span><span class="muted">,</span></span><span class="params"><span class="n">count_mode</span><span class="o"> = </span><span class="kc">'token'</span></span>)
