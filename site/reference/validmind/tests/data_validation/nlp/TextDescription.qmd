...
<span class="kw">def</span><span class="name">TextDescription</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">VMDataset</span><span class="muted">,</span></span><span class="params"><span class="n">unwanted_tokens</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">set</span><span class="o">=</span><!-- types.jinja2 - format_type --><span class="p">{</span><!-- types.jinja2 - format_type --><span class="n">'s'</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">"s'"</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">'mr'</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">'ms'</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">'mrs'</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">'dr'</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">"'s"</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">' '</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">"''"</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">'dollar'</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">'us'</span><span class="p">, </span><!-- types.jinja2 - format_type --><span class="n">'\`\`'</span><span class="p">}</span><span class="muted">,</span></span><span class="params"><span class="n">lang</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">str</span><span class="o">=</span><span class="s1">'english'</span></span>):
