...
<span class="kw">def</span> <span class="name">AutoAR</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span><span class="muted">,</span></span><span class="params"><span class="n">max_ar_order</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type -->int</span><span class="o"> = </span><span class="kc">3</span></span>)
