...
<span class="kw">def</span> <span class="name">HighPearsonCorrelation</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span><span class="muted">,</span></span><span class="params"><span class="n">max_threshold</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type -->float</span><span class="o"> = </span><span class="kc">0.3</span><span class="muted">,</span></span><span class="params"><span class="n">top_n_correlations</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type -->int</span><span class="o"> = </span><span class="kc">10</span><span class="muted">,</span></span><span class="params"><span class="n">feature_columns</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type -->list</span><span class="o"> = </span><span class="kc">None</span></span>)
