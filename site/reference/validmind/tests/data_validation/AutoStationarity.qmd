...
<span class="kw">def</span><span class="name">AutoStationarity</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">VMDataset</span><span class="muted">,</span></span><span class="params"><span class="n">max_order</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">int</span><span class="o">=</span><span class="kc">5</span><span class="muted">,</span></span><span class="params"><span class="n">threshold</span><span class="p">:</span><!-- types.jinja2 - format_type --><span class="n">float</span><span class="o">=</span><span class="kc">0.05</span></span>):
