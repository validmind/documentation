---
title: "[validmind](/reference/validmind.html).TabularDescriptionTables"
...
## get_categorical_columns[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="kw">def</span><span class="name">get_categorical_columns</span>(<span class="params"><span class="n">dataset</span></span>)

:::

<!-- function.qmd.jinja2 -->

## get_datetime_columns[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="kw">def</span><span class="name">get_datetime_columns</span>(<span class="params"><span class="n">dataset</span></span>)

:::

<!-- function.qmd.jinja2 -->

## get_numerical_columns[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="kw">def</span><span class="name">get_numerical_columns</span>(<span class="params"><span class="n">dataset</span></span>)
...
## get_summary_statistics_datetime[()]{.muted}
...
## TabularDescriptionTables[()]{.muted}

<!-- signatures.jinja2 -->

::: {.signature}

<span class="kw">def</span><span class="name">TabularDescriptionTables</span>(<span class="params"><span class="n">dataset</span></span>)
