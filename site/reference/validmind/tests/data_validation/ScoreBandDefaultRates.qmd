...
<span class="kw">def</span> <span class="name">ScoreBandDefaultRates</span>(<span class="params"><span class="n">dataset</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmdataset">validmind.vm_models.VMDataset</a></span><span class="muted">,</span></span><span class="params"><span class="n">model</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type --><a href="/reference/validmind/vm_models.html#class-vmmodel">validmind.vm_models.VMModel</a></span><span class="muted">,</span></span><span class="params"><span class="n">score_column</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type -->str</span><span class="o"> = </span><span class="kc">'score'</span><span class="muted">,</span></span><span class="params"><span class="n">score_bands</span><span class="p">:</span><span class="n"><!-- types.jinja2 - format_type -->list</span><span class="o"> = </span><span class="kc">None</span></span>)
