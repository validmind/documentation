...
def generate_qmd_files(qmd_files, release_folder, formatted_date, merged_pull_requests, tag_time, release_date):
  ...
  # Copy and rename release_highlights_template.qmd to the releases folder
...
if __name__ == '__main__':
  ...
  generate_qmd_files(qmd_files, release_folder, formatted_release_date, merged_pull_requests, tag_time, release_date)
