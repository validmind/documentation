...
<div style="position: relative; display: inline-block; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); border-radius: 5px; border: 1px solid #222425;background: #DE257E;margin-left: 40px;margin-right: 40px">
  <iframe src="/training/administrator-fundamentals.html" width="270" height="125" style="border:none; border-radius: 5px;"></iframe>
  <a href="/training/administrator-fundamentals.html" target="_blank" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 10;"></a>
</div>
<div style="position: relative; display: inline-block; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); border-radius: 5px; border: 1px solid #222425;background: #DE257E;margin-left: 40p;xmargin-right: 40px">
  <iframe src="/training/developer-fundamentals.html" width="270" height="125" style="border:none; border-radius: 5px;"></iframe>
  <a href="/training/developer-fundamentals.html" target="_blank" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 10;"></a>
</div>
<div style="position: relative; display: inline-block; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); border-radius: 5px; border: 1px solid #222425;background: #DE257E;margin-left: 40px;margin-right: 40px">
  <iframe src="/training/validator-fundamentals.html" width="270" height="125" style="border:none; border-radius: 5px;"></iframe>
  <a href="/training/validator-fundamentals.html" target="_blank" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 10;"></a>
</div>
</div>
