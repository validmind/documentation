...
listing:
  - id: developer
    ...
    contents:
    - /get-started/quickstart-developer.qmd
  - id: validator
    type: grid
    grid-columns: 1
    max-description-length: 250
    ...
    fields: [title, description, image]
    contents:
    - /get-started/quickstart-validator.qmd
  - id: admin
    type: grid
    grid-columns: 1
    max-description-length: 250
    ...
    fields: [title, description, image]
    contents:
    - /get-started/quickstart-administrator.qmd
  - id: releases
    type: grid
    grid-columns: 3
...
:::: {.navy .f4 .tl}
[setup + administration]{.smallcaps}
::::
