...
![](intro-for-developers-notebook.png){width=90% fig-alt="A screenshot showing the new introductory notebook for developers opened on JupyterHub" class="screenshot"}
...
![](documentation-overview-page.png){fig-alt="A screenshot showing the new Document Overview page in the platform UI"class="screenshot"}
...
We created a new documentation outline page which replaces the existing model overview page. This page shows a section-by-section outline of your model's documentation:

![](overview-conversations.png){width=80% fig-alt="A screenshot showing the new documentation outline page, with numbered model documentation sections from 1. to 3.4" class="screenshot"}
...
![](unresolved-conversations.png){fig-alt="A screenshot showing four unresolved conversation between model developers or validator" class="screenshot"}
...
![](business-unit-risk-areas.gif){fig-alt="A gif showing new business unit and risk area settings for your organization" class="screenshot"}
...
![](overview-completion.png){fig-alt="A screenshot of the Documentation overview page displaying a total count of how many sections have been completed" class="screenshot"}

:::

::: {.w-40-ns}

![](section-status.png){width="60%" fig-alt="A screenshot of the status picker of a section of the model documentation page" class="screenshot"}
...
![](validation-report-overview-page.png){width="60%" fig-alt="A screenshot showing the section-by-section outline of the validation report, along with a total compliance summary" class="screenshot"}
...
![](is-vendor-model.png){width="70%" fig-alt="A screenshot showing how you can flag vendor models when registering a model in the inventory" class="screenshot"}

Also available is an improved look and functionality for model inventory filtering:

![](model-inventory-filters.png){width="80%" fig-alt="A screenshot showing model inventory filtering options" class="screenshot"}
...
![](model-group.png){width="80%" fig-alt="A screenshot showing how you can modify the group an inventory model belongs to" class="screenshot"}
...
![](missing-vendor-name.png){width="80%" fig-alt="A screenshot showing a tooltip with the words 'Missing required fields: Vendor Name'" class="screenshot"}
...
![](template-yaml.png){width="80%" fig-alt="A screenshot showing template YAML" class="screenshot"}

:::

::: {.w-60-ns}

![](duplicate-template-id.png){width="80%" fig-alt="A screenshot showing the error message 'Duplicate section ID test found in template'" class="screenshot"}
...
![](about-section.png){fig-alt="A screenshot of the ValidMind docs site showing the new About section" class="screenshot"}
