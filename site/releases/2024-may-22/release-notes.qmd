...
![](318640225-1e59865c-3c0e-4600-b490-4a0c22cc4b42.png){fig-alt="A screenshot showing a tooltip with the words 'Missing required fields: Vendor Name'"}
...
![](319061059-a70f36de-cb09-42b0-b46f-0a142e4423e1.png){width="70%" fig-alt="A screenshot showing template YAML"}<br><br>
![](319060925-3658a36b-ba08-4ebd-bbda-d9b19893272a.png){width="70%" fig-alt="A screenshot showing the error message 'Duplicate section ID test found in template'"}"
...
<img width="800" alt=`about_vm` src="https://github.com/validmind/documentation/assets/164545837/8bf74eef-f05e-4c50-b18c-2790c43577ca">
