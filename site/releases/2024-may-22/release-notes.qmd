...
[Try notebook on JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/intro_for_model_developers.ipynb){.button .button-green}
...
::: {.column-margin}
[Developer reference](/validmind/validmind.html){.button target="_blank" .button-green}
...
[Try notebook on JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/custom_tests/implement_custom_tests.ipynb){.button .button-green}
...
We have introduced several updates to the **{{< fa building-columns >}} Organization** settings page, enabling you to manage business units and risk areas for your organization. 
...
[Customize documentation templates](/guide/model-documentation/customize-documentation-templates.qmd){.button .button-green}
...
::: {.w-50-ns}
Also available is an improved look and functionality for filtering the **{{< fa cubes >}} Model Inventory**.
...
::: {.w-70-ns}
We added a tooltip for required missing fields on the **{{< fa cubes >}} Model Inventory** card view.
...
![Tooltip on the {{< fa cubes >}} Model Inventory card view](missing-vendor-name.png){width="80%" fig-alt="A screenshot showing a tooltip on the Model Inventory card view" .screenshot}
