...
Our new end-to-end notebook gives you a full introduction to the {{< var vm_framework >}}. You can use this notebook to learn how the end-to-end documentation process works, based on common scenarios you encounter in model development settings.
...
1. **Initializing the {{< var vm_framework >}}** — The {{< var vm_dev >}} provides tools for documentation and testing, from dataset descriptions to model validation using various open-source frameworks.
...
2. **Starting the model development process** — Access the test repository to use individual tests as building blocks for model development. Learn to run tests, analyze results, and add evidence to model documentation. 
    ...
    See the full list of tests at [Test descriptions](https://docs.validmind.com/guide/test-descriptions.html) or try the [Test sandbox](https://docs.validmind.com/guide/test-sandbox.html).
...
::: {.callout-tip appearance="minimal" title="Try it on JupyterHub"}
[ValidMind Introduction for Model Developers¶](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/intro_for_model_developers.ipynb)
:::
...
Since there's no model object available, the {{< var vm_dev >}} won't be able to call `model.predict()` or `model.predict_proba()`. You need to load predictions and probabilities manually. For example:
...
::: {.callout-tip appearance="minimal" title="Try it on JupyterHub"}
[Implement custom tests](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/custom_tests/implement_custom_tests.ipynb)
::: 
...
::: {.callout-tip appearance="minimal" title="Try it on JupyterHub"}
[Integrate external test providers](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/custom_tests/integrate_external_test_providers.ipynb).
:::
...
::: {.callout-tip appearance="minimal" title="Try it"}
[Assign Prediction Values and Probabilities to ValidMind Datasets](https://github.com/validmind/developer-framework/blob/main/notebooks/code_sharing/credit_risk/assign_prediction_probabilities.ipynb)
:::
...
This picker allows you to set whether the section is **In Progress** or **Done**. The Documentation overview page display a total count of how many sections have been completed, as well as a checkmark indicating that the section is done.
