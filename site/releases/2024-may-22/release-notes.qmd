...
![New Document Overview page in the ValidMind Platform](documentation-overview-page.png){width=90% fig-alt="A screenshot showing the new Document Overview page in the ValidMind Platform"class="screenshot"}
