...
![](intro-for-developers-notebook.png){fig-alt="A screenshot showing the new introductory notebook for developers opened on JupyterHub" class="screenshot" class="screenshot"}
...
![](documentation-overview-page.png){fig-alt="A screenshot showing the new Document Overview page in the platform UI" class="screenshot" class="screenshot"}
...
![](generate-with-ai.png){width="80%" fig-alt="A screenshot showing a text editor with a toolbar. The New Generate with AI button is available on the right" class="screenshot" class="screenshot"}

Here, you can choose to **Accept Text** or **Try Again**:

![](ai-content-builder.png){width="80%" fig-alt="A screenshot showing a modal with AI-generated text" class="screenshot" class="screenshot"}
--->
...
![](overview-conversations.png){fig-alt="A screenshot showing the new documentation outline page, with numbered model documentation sections from 1. to 3.4" class="screenshot"}
