...
**Try notebook on JupyterHub:**

[ValidMind Introduction for Model Developers](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/tutorials/intro_for_model_developers.ipynb){.button}
...
<br><br>
[{{< var validmind.developer >}}](https://docs.validmind.ai/validmind/validmind.html){.button}
...
[Implement custom tests](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/custom_tests/implement_custom_tests.ipynb){.button}
...
<center>
[add_extra_column()](https://docs.validmind.ai/validmind/validmind/vm_models.html#VMDataset.add_extra_column){.button}
</center> 
...
[LanguageDetection](/tests/data_validation/nlp/LanguageDetection.md){.button}

[Toxicity](/tests/data_validation/nlp/Toxicity.md){.button}

[PolarityAndSubjectivity](/tests/data_validation/nlp/PolarityAndSubjectivity.md){.button}

[Sentiment](/tests/data_validation/nlp/Sentiment.md){.button}
...
[Integrate external test providers](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/custom_tests/integrate_external_test_providers.ipynb){.button}
...
[Assign Prediction Values and Probabilities to ValidMind Datasets](https://github.com/validmind/developer-framework/blob/main/notebooks/code_sharing/credit_risk/assign_prediction_probabilities.ipynb){.button}
