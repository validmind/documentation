...
{{< video 319067297-cfc828b7-c4a8-46a4-89ff-1b7286681189.mp4 width="600" >}}
...
![](327548926-6b3fe585-35ba-465b-a3ac-3af2ead8ebe3.png){width="70%" fig-alt="A screenshot showing how you can flag vendor models when registering a model in the inventory."}

Also available is an improved look and functionality for model inventory filtering:

![](327548917-d6f0bc14-4a99-440d-bba3-cd578a47fc5d.png){width="80%" fig-alt="A screenshot showing model inventory filtering options"}
...
![](329086860-6906834d-83e0-415b-9836-9dabc224bec8.png){width="80%" fig-alt="A screenshot showing how you can modify the group an inventory model belongs to."}
...
These features provide a rich context for testing and evaluation. You can use realistic models and datasets without any risk to your production environment. [Learn more...](../../guide/get-started-sandbox.qmd)
