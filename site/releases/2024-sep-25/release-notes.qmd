...
![](generate-with-ai.png){width="80%" fig-alt="A screenshot showing the content editing toolbar with the Generate with AI button on the right" class="screenshot"}
...
![](generate-ai-prompt.png){width=90% fig-alt="A screenshot showing the ValidMind AI Content Builder modal with the optional prompt box" class="screenshot"}
