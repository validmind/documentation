...
![{{< var vm.product >}} AI Content Builder modal with the optional prompt box](generate-ai-prompt.png){width=90% fig-alt="A screenshot showing the ValidMind AI Content Builder modal with the optional prompt box" .screenshot}
