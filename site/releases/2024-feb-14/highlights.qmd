...
![](getting-started-instructions.png){fig-alt="New indicator that specifies the user who made updates through the developer framework" fig-align="center" class="screenshot"}
