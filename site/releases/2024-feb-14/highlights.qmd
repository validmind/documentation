...
We simplified the instructions for getting started with the {{< var validmind_developer >}} in the {{< var validmind.platform >}}. These instructions tell you how to use the code snippet for your model documentation with your own model or with one of our code samples.
