...
We've improved the ValidMind user experience, from more supportive documentation templates, easier specification of inputs, and better filtering within the {{< var vm_dev >}}, to the ability to view which user ran actions within the {{< var vm_ui >}}.

### {{< var vm_framework >}} (v1.26.6)
...
To enable model developers to know what task types and tags are available to filter on, we have made some updates to our {{< var vm_dev >}}:
...
Try it: [Exploring Tests in the {{< var vm_dev >}}](/notebooks/how_to/explore_tests.ipynb)
...
#### Updated events to show who ran the {{< var vm_dev >}} actions
...
We simplified the instructions for getting started with the {{< var vm_framework >}} in the {{< var vm_platform >}}. These instructions tell you how to use the code snippet for your model documentation with your own model or with one of our code samples.
...
Performance improvements for the {{< var vm_platform >}}
: We made improvements to page load times on our {{< var vm_ui >}} for a smoother user experience.
...
: The model inventory has been updated to allow organizations to add custom fields. This enhancement enables administrators to customize the model inventory data schema according to your specific organizational needs. This can be done by accessing **Custom Fields** in the **{{< fa gear >}} Settings** page.
...
: Our user guide now includes end-to-end instructions for managing users on the ValidMind platform. This new content covers common tasks such as inviting new users, adding them to user groups, and managing roles and permissions. [Learn more ...](/guide/configuration/onboarding-users.qmd)
