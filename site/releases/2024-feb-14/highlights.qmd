...
We've improved the ValidMind user experience, from more supportive documentation templates, easier specification of inputs, and better filtering within the {{< var developer >}}, to the ability to view which user ran actions within the {{< var platform >}}.

### {{< var validmind_developer >}} (v1.26.6)
...
To enable model developers to know what task types and tags are available to filter on, we have made some updates to our {{< var developer >}}:
...
Try it: [Exploring Tests in the {{< var developer >}}](/notebooks/how_to/explore_tests.ipynb)
...
### {{< var validmind_platform >}} (v1.13.13)
...
#### Updated events to show who ran the {{< var developer >}} actions
...
We simplified the instructions for getting started with the {{< var validmind_developer >}} in the {{< var validmind_platform >}}. These instructions tell you how to use the code snippet for your model documentation with your own model or with one of our code samples.
...
Performance improvements for the {{< var validmind_platform >}}
: We made improvements to page load times on our {{< var platform >}} for a smoother user experience.
