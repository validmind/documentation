...
![New indicator specifying the user who made updates via the ValidMind Library)](actions-after.png){width=90% fig-alt="Screenshot of the new indicator specifying the user who made updates via the ValidMind Library" fig-align="center" class="screenshot"}
