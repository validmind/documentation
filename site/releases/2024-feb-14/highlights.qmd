...
::: {.w-70-ns}
We implemented a toggle feature in the **{{< fa tower-broadcast >}} Model Activity** and Recent Activity sections under **Comments** to filter and display only specific user mentions. 
:::
