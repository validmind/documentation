...
We simplified the instructions for getting started with the {{< var vm_framework >}} in the Platform UI. These instructions tell you how to use the code snippet for your model documentation with your own model or with one of our code samples.
