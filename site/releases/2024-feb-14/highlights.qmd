...
![](list-tasks-and-tags.png){fig-alt="New indicator that specifies the user who made updates through the developer framework" fig-align="center" width=90% class="screenshot"}
...
![](actions-before.png){fig-alt="Old indicator that says that the developer framework logged an event" fig-align="center" class="screenshot"}
...
![](actions-after.png){fig-alt="New indicator that specifies the user who made updates through the developer framework" fig-align="center" class="screenshot"}
...
![](getting-started-instructions.png){width=80% fig-alt="New indicator that specifies the user who made updates through the developer framework" fig-align="center" class="screenshot"}
