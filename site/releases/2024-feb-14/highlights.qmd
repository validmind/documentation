...
We've improved the ValidMind user experience, from more supportive documentation templates, easier specification of inputs, and better filtering within the {{< var developer >}}, to the ability to view which user ran actions within the {{< var vm.platform >}}.
