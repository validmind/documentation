...
```
::: {.tc}
[run_documentation_tests()](/validmind/validmind.html#run_documentation_tests){.button target="_blank" .button-green}
:::
...
[init_dataset()](/validmind/validmind.html#init_dataset){.button target="_blank" .button-green}

[init_model()](/validmind/validmind.html#init_model){.button target="_blank".button-green} 
...
::: {.w-60-ns}
You can now narrow down models in your **{{< fa cubes >}} Model Inventory** with our advanced filter, search, and sort options. 
:::
