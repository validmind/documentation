...
![Risk Areas & Validation Guidelines in Workspace Settings](settings-validation-guidelines.png){fig-alt="A screenshot showing the Risk Areas & Validation Guidelines in Workspace Settings" class="screenshot" .lightbox}
