...
[Manage validation guidelines](/guide/model-validation/manage-validation-guidelines.qmd){.button target="_blank"}

:::

::: {.w-50-ns}

![Risk Areas & Validation Guidelines in Workspace Settings](settings-validation-guidelines.png){fig-alt="A screenshot showing the Risk Areas & Validation Guidelines in Workspace Settings" class="screenshot"}
...
[Working with model workflows](/guide/model-workflows/working-with-model-workflows.qmd#reset-your-model-workflow"){.button target="_blank"}

:::

::: {.w-30-ns}

![Option to reset your model workflow](reset-model-workflow.png){fig-alt="A screenshot showing the option to reset your model workflow" class="screenshot"}
...
[Manage model inventory fields](/guide/model-inventory/manage-model-inventory-fields.qmd){.button target="_blank"}
...
[Customize model lifecycle statuses](/guide/model-workflows/customize-model-lifecycle-statuses.qmd){.button target="_blank"}
