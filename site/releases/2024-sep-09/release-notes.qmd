...
::: {.w-50-ns}
We've expanded on our risk area functionality and added a new page to your Workplace Settings: **{{< fa align-left >}} Risk Areas & Validation Guidelines**.

This replaces the old Risk Areas set up under **{{< fa building-columns >}} Organization**, and allows you to customize guidelines associated with your model validation templates.

[Manage validation guidelines](/guide/model-validation/manage-validation-guidelines.qmd){.button}

:::

::: {.w-50-ns}

![{{< fa align-left >}} Risk Areas & Validation Guidelines in Workspace Settings](settings-validation-guidelines.png){fig-alt="A screenshot showing the Risk Areas & Validation Guidelines in Workspace Settings" .screenshot .lightbox}
...
[Working with model workflows](/guide/model-workflows/working-with-model-workflows.qmd#reset-your-model-workflow"){.button}
