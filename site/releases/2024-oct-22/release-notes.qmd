...
![Ongoing monitoring of a model](/releases/2024-oct-22/358433496-02a6d5b9-0521-4110-b45c-b91e06798a97.png)
...
::: {.w-80-ns}
To help you get started, we've added a new notebook that demonstrates how to log ongoing monitoring results for a model. This notebook provides a hands-on example of setting up and conducting monitoring tests, helping you ensure your models are performing consistently over time.
:::

::: {.w-20-ns .tr}
[Try it ...](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/ongoing_monitoring/quickstart_customer_churn_ongoing_monitoring.ipynb){.button}
