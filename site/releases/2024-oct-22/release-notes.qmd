...
::: {.w-30-ns .tr}
[Learn about monitoring {{< fa book-open >}}](../../guide/monitoring/ongoing-monitoring.qmd){.button}
:::
...
::: {.w-30-ns .tr}
[Try it on JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/ongoing_monitoring/quickstart_customer_churn_ongoing_monitoring.ipynb){.button}
...
::: {.w-70-ns}
Archived models are read-only and do not contribute to statistics or reports. Models must be inactive and archived before they can be deleted. Model archiving and deletion are recorded in the activity feed. An administrator can restore archived models if needed.
:::

::: {.w-30-ns .tr}
[Learn about archiving models {{< fa book-open >}}](/guide/model-inventory/archive-delete-models.qmd){.button}
:::
...
::: {.w-30-ns .tr}
[Try it on JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_with_bias.ipynb){.button}
:::
...
::: {.w-40-ns .tr}
[Learn about content blocks](../../guide/model-documentation/work-with-content-blocks.qmd#add-content-blocks){.button}
:::
...
::: {.w-33-ns}
![Adding a new block](/releases/2024-oct-22/366145578-ce832e92-b8f2-47f1-b2f8-5d4b299fbe4a.png){class="screenshot"}
:::

::: {.w-33-ns .tr}
![Selecting the block](/releases/2024-oct-22/366145581-b2afc5aa-5a37-4639-8f11-63fea34191c7.png){class="screenshot"}
:::

::: {.w-33-ns .tr}
![Metric over time graph](/releases/2024-oct-22/366145585-937d5018-ee21-47df-b9d2-b2da5125046d.png){class="screenshot"}
:::
...
::: {.w-30-ns .tr}
[Try it on JupyterHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/how_to/filter_input_columns.ipynb){.button}
:::
...
::: {.w-70-ns}
This update enhances the user experience by introducing a new email verification error page. If you need to verify your email address but have been unable to do so, this page allows you to resend the verification email and navigate to the dashboard to access ValidMind once verification is complete. 
:::

::: {.w-30-ns .tr}
[Learn about registering {{< fa book-open >}}](/guide/configuration/register-with-validmind.qmd){.button}
:::
...
::: {.w-40-ns .tr}
[Learn about model inventory fields {{< fa book-open >}}](/guide/model-inventory/manage-model-inventory-fields.qmd){.button}
:::
...
::: {.w-40-ns .tr}
[Learn about model inventory fields {{< fa book-open >}}](/guide/model-inventory/manage-model-inventory-fields.qmd#inventory-field-types){.button}
:::
::::

The inventory model page displays attachments when the attachment field is defined:

![Sample attachments](/releases/2024-oct-22/368770367-a7f6b364-7e7a-483e-8bc8-01a0ac9c7158.png){class="screenshot"}
...
::: {.w-30-ns .tc}
[Learn about attachments {{< fa book-open >}}](/guide/model-validation/add-manage-model-findings.qmd#manage-supporting-documentation){.button}
:::
...
::: {.w-50-ns .tc}
![Adding the currency number type](/releases/2024-oct-22/368772301-4fb7e8e1-5a43-490d-b17d-a80b7d30cfba.png){class="screenshot"}
:::

::: {.w-50-ns .tc}
![Currency type in model documentation](/releases/2024-oct-22/367452366-50f19b63-1bc4-438b-8fd7-702e6b2f5ca9.png){width="80%" class="screenshot"}

<br>

[Learn more about custom field types {{< fa book-open >}}](/guide/model-inventory/manage-model-inventory-fields.qmd){.button}
:::
...
::: {.w-30-ns .tr}
[Learn about deleting findings {{< fa book-open >}}](/guide/model-validation/add-manage-model-findings.qmd#delete-model-findings){.button}
:::
...
::: {.w-30-ns .tr}
[Learn about renaming roles {{< fa book-open >}}](/guide/configuration/manage-roles.qmd#rename-existing-roles){.button}
:::
...
::: {.w-30-ns .tr}
[Learn about filtering {{< fa book-open >}}](/guide/model-inventory/view-model-activity.qmd#filter-activity){.button}
:::
...
::: {.w-50-ns}
This enhancement allows for better formatting and presentation of your guidelines, improving how content is managed and displayed. The rich text editor provides a more flexible way to create and edit guideline descriptions, making the process smoother and more user-friendly.

[Learn about validation guidelines {{< fa book-open >}}](/guide/model-validation/manage-validation-guidelines.qmd#edit-guidelines){.button}
:::

::: {.w-50-ns}
![Rich text guidelines editor](edit-validation-guidelines.png){class="screenshot"}
:::
...
[docs.validmind.ai/training](docs.validmind.ai/training){.button}
:::
...
<div style="position: relative; display: inline-block; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); border-radius: 5px; border: 1px solid #222425;">
  <iframe src="/training/training.html" width="540" height="325" style="border:none; border-radius: 5px;"></iframe>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?si=JfBNClmsZYLS7m9F&amp;list=PL7I7ZrCoVCCObEiuLLAL0Wm9GQ6x5U0q5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="box-shadow: 5px 5px 5px #ccc, -5px 5px 5px #ccc; border-radius: 5px;"></iframe>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/5J7wysDIXgI?si=KPkFhx3O6NknijRf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="box-shadow: 5px 5px 5px #ccc, -5px 5px 5px #ccc; border-radius: 5px;"></iframe>
...
::: {.w-30-ns .tc}
[Learn about deployment options {{< fa book-open >}}](/about/deployment/deployment-options.qmd){.button}
:::
::::
...
::: {.w-30-ns .tc}
[{{< fa brands github >}} Try it on GitHub](https://github.com/validmind/developer-framework){.button}
:::
