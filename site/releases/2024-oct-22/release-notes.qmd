...
::: {.w-60-ns}
You can now define attachments as model inventory fields for supporting documentation. Each attachment field can be unique. This enhancement allows you to attach different sets of files for a model.
:::
