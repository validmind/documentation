...
::: {.w-30-ns .tc}
[Try it on JupyerHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_with_bias.ipynb){.button}
:::
...
::: {.w-30-ns .tc}
[Try it on JupyerHub](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/how_to/filter_input_columns.ipynb){.button}
:::
