...
::: {.w-30-ns .tr}
[Learn about adding content blocks](../../guide/model-documentation/work-with-content-blocks.qmd#add-content-blocks){.button}
:::
...
::: {.w-30-ns .tc}
[Learn about filtering model activity {{< fa book-open >}}](/guide/model-inventory/view-model-activity.qmd#filter-activity){.button}
:::
...
Additionally, we’ve introduced a new, easy-to-remember URL for accessing training content: 
...
[Watch the video series...](../../guide/guides.html#model-validation){.button}
