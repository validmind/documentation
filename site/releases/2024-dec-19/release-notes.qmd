...
The {{< var validmind.training >}} **Developer Fundamentals** course has been updated with an improved version of the ValidMind introduction for model developers Jupyter Notebook: 
...
::: {.column-margin}
[{{< fa cube >}} Developers](/developer/get-started-validmind-library.qmd){.button}
