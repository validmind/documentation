...
Labels: enhancement
--->
#### Custom model inventory and all findings views
<span id="saved-views"></span>
Along with customizing what you see, you can now save preconfigured views on the **{{< fa cubes >}} Inventory** and **{{< fa triangle-exclamation >}} Findings** pages within {{< var validmind.platform >}}, allowing you to retrieve these settings easily for future use.
...
[^1]: [Custom model inventory and all findings views](#saved-views)
