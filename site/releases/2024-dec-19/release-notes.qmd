...
::: {.w-30-ns .tc}
[Collaborate with others](/guide/model-documentation/collaborate-with-others.qmd#revision-history){.button .button-green}
...
::: {.tc}
[Add and manage model findings](/guide/model-validation/add-manage-model-findings.qmd#delete-model-findings){.button .button-green}
