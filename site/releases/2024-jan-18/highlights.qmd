...
![Managing users under Settings &gt; User Directory](user-management.gif){fig-alt="An animated gif showcasing how to manage users under Settings &gt; User Directory" class="screenshot"}
...
![Managing groups under Settings &gt; Groups](group-management.gif){fig-alt="An animated gif showcasing how to manage groups under Settings &gt; Groups" class="screenshot"}
:::
...
::: {.w-50-ns}
![Templates available under Settings &gt; Templates](template-pages.gif){fig-alt="Animated gif showcasing templates available under Settings &gt; Templates" class="screenshot"}
...
::: {.w-50-ns}
![Model detail page with the stakeholders grouped by the type of role they hold highlighted](group-users-by-type.png){fig-alt="A screenshot of the model detail page with the stakeholders grouped by the type of role they hold highlighted" class="screenshot"}
:::
