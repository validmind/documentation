...
<form method="get" action="/guide/configuration/manage-your-profile.html" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Manage your profile
</button>
</form>
...
::: grid
::: g-col-5
![Light mode](light-mode.png){fig-alt="The ValidMind Platform UI in light mode" class="screenshot" class="screenshot"}
:::

::: g-col-5
![Dark mode](dark-mode.png){fig-alt="The ValidMind Platform UI in dark mode" class="screenshot" class="screenshot"}
:::
:::
...
![Managing users under Settings &gt; User Directory](user-management.gif){fig-alt="An animated gif showcasing how to manage users under Settings &gt; User Directory" fig-align="center" class="screenshot"}
...
<form method="get" action="/guide/configuration/manage-users.html" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Manage users
</button>
</form>
...
![Managing groups under Settings &gt; Groups](group-management.gif){fig-alt="An animated gif showcasing how to manage groups under Settings &gt; Groups" fig-align="center" class="screenshot"}
:::
...
<form method="get" action="/guide/configuration/manage-groups.html" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Manage groups
</button>
</form>
...
![Templates available under Settings &gt; Templates](template-pages.gif){fig-alt="Animated gif showcasing templates available under Settings &gt; Templates" fig-align="center"  class="screenshot"}
:::
...
::: {.w-50-ns}
![Model detail page with the stakeholders grouped by the type of role they hold highlighted](group-users-by-type.png){fig-alt="A screenshot of the model detail page with the stakeholders grouped by the type of role they hold highlighted" fig-align="center" class="screenshot"}
:::
...
<form method="get" action="/guide/model-documentation/collaborate-with-others.html#commenting" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Commenting
</button>
</form>
...
<form method="get" action="/guide/model-documentation/working-with-model-documentation.html#document-overview" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Document Overview
</button>
</form>
