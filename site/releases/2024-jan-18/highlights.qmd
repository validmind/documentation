...
::: grid
::: g-col-5
![Light mode](light-mode.png){fig-alt="The ValidMind Platform UI in light mode" class="screenshot" class="screenshot" class="screenshot"}
:::

::: g-col-5
![Dark mode](dark-mode.png){fig-alt="The ValidMind Platform UI in dark mode" class="screenshot" class="screenshot" class="screenshot"}
:::
:::
...
![](user-management.gif){fig-alt="Managing users under Settings &gt; User Directory" fig-align="center" width="90%" class="screenshot" class="screenshot"}
...
![](group-management.gif){fig-alt="Managing groups under Settings &gt; Groups" fig-align="center" width="90%" class="screenshot" class="screenshot"}
...
![](template-pages.gif){fig-alt="Template pages available under Settings &gt; Templates" fig-align="center" width="90%" class="screenshot" class="screenshot"}
...
![](group-users-by-type.png){fig-alt="Model documentation with the stakeholders shown as grouped by the type of role they hold" fig-align="center" width="60%" class="screenshot" class="screenshot"}
