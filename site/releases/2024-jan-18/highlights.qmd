...
This release introduces a new dark mode to the {{< var validmind_platform >}}, along with new user and template management features, other enhancements, and bug fixes.

<!--- ### {{< var validmind_developer >}} () --->

### {{< var validmind_platform >}} (v1.11.0)

#### Dark mode

<!---Dark mode by @gtagle in [#494](https://github.com/validmind/frontend/pull/494)--->

You now have the option to set your color theme preference for the {{< var validmind_platform >}}. The theme can be set by toggling **Enable Dark Mode** in your profile settings.
...
We continue to make easier to set up and administer ValidMind for members in your organization. In this release, we are introducing new user and group management features that are available right in the {{< var platform >}}.
...
Try it in the {{< var platform >}}: [User directory]({{< var vm_url_us1 >}}/settings/user-directory)
...
Try it in the {{< var platform >}}: [Groups]({{< var vm_url_us1 >}}/settings/groups)
...
Try it in the {{< var validmind_platform >}}: [Templates]({{< var vm_url_us1 >}}/settings/templates)
...
-   **Search experience fixes**. We implemented multiple fixes to the search functionality in the {{< var platform >}}:
