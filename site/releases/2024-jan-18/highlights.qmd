...
::: grid
::: g-col-5
![Light mode](light-mode.png){fig-alt="The ValidMind Platform UI in light mode" .screenshot .screenshot}
:::

::: g-col-5
![Dark mode](dark-mode.png){fig-alt="The ValidMind Platform UI in dark mode" .screenshot .screenshot}
:::
:::
...
![Managing users under Settings &gt; User Directory](user-management.gif){fig-alt="An animated gif showcasing how to manage users under Settings &gt; User Directory" .screenshot}
...
![Managing groups under Settings &gt; Groups](group-management.gif){fig-alt="An animated gif showcasing how to manage groups under Settings &gt; Groups" .screenshot}
:::
...
::: {.w-50-ns}
![Templates available under Settings &gt; Templates](template-pages.gif){fig-alt="Animated gif showcasing templates available under Settings &gt; Templates" .screenshot}
