...
![User management](user-management.gif){fig-alt="Managing users under Settings > User Directory" width=90%}
...
![Group management](group-management.gif){fig-alt="Managing groups under Settings > Groups" width=90%}
...
![Template pages](template-pages.gif){fig-alt="Template pages available under Settings > Templates" width=90%}
