...
Try it in the {{< var vm.platform >}}: [User directory]({{< var vm_url_us1 >}}/settings/user-directory)
...
Try it in the {{< var vm.platform >}}: [Groups]({{< var vm_url_us1 >}}/settings/groups)
