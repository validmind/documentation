...
<img src="user-management.gif" alt="Managing users under Settings > User Directory" style="width: 90%; border: 5px solid #555; box-shadow: 5px 5px 5px #888; border-radius: 5px;">
...
<img src="group-management.gif" alt="Managing groups under Settings > Groups" style="width: 90%; border: 5px solid #555; box-shadow: 5px 5px 5px #888; border-radius: 5px;">
...
<img src="template-pages.gif" alt="Template pages available under Settings > Templates" style="width: 90%; border: 5px solid #555; box-shadow: 5px 5px 5px #888; border-radius: 5px;">
...
![](group-users-by-type.png){fig-alt="A documentation project with the stakeholders shown as grouped by the type of role they hold." fig-align="center" width=60%}
