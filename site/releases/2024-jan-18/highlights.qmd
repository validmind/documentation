...
Try it in the {{< var platform >}}: [User directory]({{< var vm_url >}}/settings/user-directory)
...
Try it in the {{< var platform >}}: [Groups]({{< var vm_url >}}/settings/groups)
...
Try it in the {{< var validmind_platform >}}: [Templates]({{< var vm_url >}}/settings/templates)
