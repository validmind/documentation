...
![](group-users-by-type.png){fig-alt="Model documentation with the stakeholders shown as grouped by the type of role they hold" fig-align="center" width="60%"class="screenshot"}
