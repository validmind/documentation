...
![Managing groups under {{< fa gear >}} Settings &gt; Groups](group-management.gif){fig-alt="An animated gif showcasing how to manage groups under Settings &gt; Groups" .screenshot}
:::
...
::: {.w-50-ns}
![Templates available under {{< fa gear >}} Settings &gt; Templates](template-pages.gif){fig-alt="Animated gif showcasing templates available under Settings &gt; Templates" .screenshot}
