...
::: grid
::: g-col-5
![Light mode](light-mode.png){fig-alt="The ValidMind Platform  in light mode" .screenshot .screenshot}
:::

::: g-col-5
![Dark mode](dark-mode.png){fig-alt="The ValidMind Platform in dark mode" .screenshot .screenshot}
:::
:::
