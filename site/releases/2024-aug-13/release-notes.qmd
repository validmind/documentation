...
::: {.w-60-ns}
We enhanced the dashboard with new customization options. 
Now, you can resize and rearrange widgets to suit your preferences. 
...
::: {.callout-important}
You need to pass a list of lists for `datasets` or `models`, since the original input is a list of inputs.
::: 
...
This summarizes key information from your reports for you to view at a glance.
...
Now, you can configure model dependencies on the inventory model overview page. You can edit upstream and downstream model dependencies as shown in the images below.
