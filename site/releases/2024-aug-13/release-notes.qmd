...
::: {.w-60-ns}
We enhanced the dashboard with new customization options. Now, you can resize and rearrange widgets to suit your preferences. Additionally, you can add charts from the Reports section to your dashboard, providing a more personalized and flexible experience.

![Customizing your dashboard](customize-dashboard-demo.gif){fig-alt="A demonstration of dashboard widgets being moved and resized."}
:::
