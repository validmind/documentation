...
This release brings many user experience upgrades to ValidMind, including customization for your {{< var vm.platform >}} dashboard, support for more input types in comparison tests within the {{< var vm.developer >}}, model dependency management, and more.
