...
![New `Findings` Report summary widgets](new-reports-widget.png){fig-alt="An image showing the new summary widgets added to Reports on the Findings tab" class="screenshot"}
...
Labels: enhancement
--->
### Manage model interdependencies
