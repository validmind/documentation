...
[Set up model workflows](/guide/model-workflows/set-up-model-workflows.qmd){.button target="_blank"}
...
[add_extra_column()](https://docs.validmind.ai/validmind/validmind/vm_models.html#VMDataset.add_extra_column){.button target="_blank"}
...
[Manage roles](/guide/configuration/manage-roles.qmd){.button target="_blank"}

[Manage permissions](/guide/configuration/manage-permissions.qmd){.button target="_blank"}
