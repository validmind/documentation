...
On top of our increased support for tests and arrays in the {{< var validmind.developer >}} and our first {{< var vm.product >}} Academy training modules, we've introduced customizable model workflows, new role functionality, and new report types.
...
We're introducing the first training modules that are part of our {{< var vm.product >}} Academy training program for:
