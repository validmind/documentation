...
- **[SC-2236] Demo notebook for changing config/parameters**. The notebook that demo for changing config/parameters. It demonstrate the following:
...
- **[SC-2143] Metrics for safety toxicity and bias in text summarization**. Added the following metrics for text summarization: 

- ~`DisplayTextDataset`~
- ~`SummarizationPredictions`~
- `ToxicityScore` (safety risk)
- `ToxicityHistogram` (safety risk)
- `RegardScore` (bias risk)
- `RegardHistogram` (bias risk)
