...
This release introduces a number of new code samples to demonstrate support for different use cases in the ValidMind Developer Framework, along with a new feature in the Platform UI that enables you to remove blocks from model documentation. Additionally, our user guides have received a number of improvements.
