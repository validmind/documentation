...
The notebook that demo for changing config/parameters. It demonstrate the following:
...
You can now remove text blocks and test-driven blocks from documentation projects. To remove blocks, you first select the block you want to remove and click {{< fa trash-can >}}, either in the text-block's toolbar or in the test-driven's block single-button toolbar.
