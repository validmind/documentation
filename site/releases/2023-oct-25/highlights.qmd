...
This release introduces a new guide for modifying configurations and parameters within the {{< var vm_framework >}}. It also brings new features to the Platform UI that enable you to remove blocks of content from model documentation and work with your settings more effectively.
