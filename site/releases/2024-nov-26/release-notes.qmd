...
Did you know that along with our {{< var validmind.developer >}}, the code for our documentation site is also open-source?* (FOOTNOTE: https://github.com/validmind/documentation)

Below are some improvements we've made to our authoring tools to streamline the process: 
