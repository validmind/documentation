...
::: {.w-70-ns}
We continue to add new functionality to model workflows within the {{< var validmind.platform >}}, including the ability to select a **User Role** or **User Type** inventory fields in Approval steps, and the ability to configure diverging paths in Condition Branch steps and updated our resources to include reference information on these features.
:::
...
::: {.w-70-ns}
On top of support for custom analytics,* (FOOTNOTE) we've updated our feature documentation for reporting to include overviews of default report pages provided out-of-the-box by {{< var vm.product >}} and moved this information into its own section under **Guides** in **[reporting]{.smallcaps}**.
