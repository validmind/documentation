...
Labels: enhancement
--->
#### Ability to submit product feedback
...
![{{< var validmind.platform >}} main dashboard](/assets/img/validmind-demo-compact.png){width=85% fig-alt="An image showing the ValidMind Platform main dashboard" .screenshot}
