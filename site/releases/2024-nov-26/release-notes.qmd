...
::: {.w-40-ns .tc}
![Old documentation site in mobile view](old-site-mobile.png){fig-alt="AAn animated gif showing the old documentation site in mobile view" .screenshot}

:::

::: {.w-40-ns .tc}
![New documentation site in mobile view](new-site-mobile.gif){fig-alt="An animated gif showing the new documentation site in mobile view" .screenshot}
