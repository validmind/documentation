...
::: {.w-60-ns}
Check out our **RAG Model Documentation Demo** Jupyter Notebook — learn how to build a basic RAG (Retrieval-Augmented Generation) model to help automatically answer RFP (Request for Proposal) questions using GenAI. 
...
::: {.w-30-ns .tc}
[Work with test results](/developer/model-documentation/work-with-test-results.qmd#filter-historical-test-results){.button}
