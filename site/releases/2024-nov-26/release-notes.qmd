...
::: {.tc}
[Submit feedback from the {{< var validmind.platform >}}](/support/support.qmd){.button}
:::
...
<!-- MANUAL ADD:
Removed model documentation workflows: https://github.com/validmind/documentation/pull/282 -->
...
- revamped organization setup guides
...
- revamped managing users guides, clarified definitions
- New prereq class
...
Approval Step enhancement
: def

New Condition Branches
: def
...
::: {.w-40-ns .tc}
![Old documentation site in mobile view](old-site-mobile.png){fig-alt="A screenshot of the old documentation site in mobile view" .screenshot}

:::

::: {.w-40-ns .tc}
![New documentation site in mobile view](new-site-mobile.png){fig-alt="A screenshot of the new documentation site in mobile view" .screenshot}
...
::: {.w-50-ns}
Previously, visiting a non-existing page within the documentation would present you with a default XML error. 
...
::: {.w-50-ns}
::: {.preview source="404.qmd" offset="70"}
:::
:::
