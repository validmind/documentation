...
**Updated Python requirements**. We have updated our user guide to clarify the Python versions supported by the {{< var validmind.developer >}}. We now support **Python {{< var python_version >}}**. 
