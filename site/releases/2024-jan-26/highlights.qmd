...
<form method="get" action="/notebooks/how_to/configure_dataset_features.html" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Configure dataset features
</button>
</form>
...
<form method="get" action="/notebooks/how_to/run_documentation_sections.html" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Run individual documentation sections
</button>
</form>
...
::: {.callout title="Refer also to:"}
[Standard inputs are deprecated](#custom-input-legacy)
:::
...
The {{< var validmind.developer >}} now supports running LLM-powered tests with the Azure OpenAI Service via API, in addition to the previously supported OpenAI API. 
...
<form method="get" action="/validmind/validmind.html#init" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">init()
</button>
</form>
...
The {{< var validmind.developer >}} now supports passing custom inputs as an `inputs` dictionary when running individual tests or test suites. 
...
::: {.callout title="Refer also to:"}
[Support for custom inputs](#support-for-custom-inputs)
:::
