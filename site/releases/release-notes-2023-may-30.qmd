...
- You can now export model documentation to Word documents from the {{< var vm_ui >}}. This feature enables you make use of model documentation or validation report files outside of the {{< var vm_platform >}}. [Learn more ...](export-documentation.qmd)
