...
::: {.w-40-ns .tc}
[Manage model stakeholder types](/guide/configuration/manage-record-stakeholder-types.qmd){.button .button-green target="_blank"}
...
[^4]: [Setting up workflows](/guide/workflows/setting-up-workflows.qmd#conditional-requirements)

[^5]: [Work with test results](/guide/documentation/work-with-test-results.qmd)

[^6]: [Working with model documentation](/guide/documentation/working-with-model-documentation.qmd)
