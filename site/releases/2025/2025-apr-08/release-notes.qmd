...
[{{< fa brands github >}} Access Notebooks on GitHub](https://github.com/validmind/validmind-library/blob/main/notebooks/code_samples/credit_risk/application_scorecard_full_suite.ipynb){.button .button-green target="_blank"}

:::

::: {.w-50-ns .tc}

[{{< fa brands github >}} Access Notebooks on GitHub](https://github.com/validmind/validmind-library/blob/main/notebooks/code_samples/credit_risk/application_scorecard_with_ml.ipynb){.button .button-green target="_blank"}
