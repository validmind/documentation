...
listing:
  - id: test-desc
    ...
    # image-height: 100%
    contents:
      - path: /notebooks/how_to/tests/run_tests/configure_tests/customize_test_result_descriptions.ipynb
        title: "Customize test result descriptions"
        description: "Learn how to take control over the context that drives test description generation. {{< fa chevron-right >}}"
  - id: credit-risk
    type: grid
    grid-columns: 1
    max-description-length: 250
...
::: {.column-margin}
[Assess compliance](/guide/validation/assess-compliance.qmd){.button .button-green}
