...
![Optional prompt for risk assessments](risk-assessment-prompt.png){.screenshot}
...
::: {.w-50-ns .tr}
[Adding Context to LLM-based Descriptions](https://github.com/validmind/validmind-library/blob/main/notebooks/code_sharing/llm/add_context_to_llm_descriptions.ipynb){.button}
:::
...
::: {.w-50-ns .tr}
[Document an application scorecard model<br>(individual tests)](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_with_ml.ipynb){.button}

[Document an application scorecard model<br>(full test suite)](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_full_suite.ipynb){.button}

[Document an application scorecard model<br>(single function)](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_executive.ipynb){.button}
:::
...
::: {.w-50-ns .pl4 .pr4}
- Use our new metrics for data and model drift, and populate the ongoing monitoring documentation [for a scorecard model](https://jupyterhub.validmind.ai/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_executive.ipynb).
:::
...
This enhancement makes it easier to distinguish between ValidMind's standard test documentation and the dynamic, context-aware descriptions generated for your specific test results. You can browse the full catalog of official test descriptions in our [test documentation](/developer/model-testing/test-descriptions.html).
