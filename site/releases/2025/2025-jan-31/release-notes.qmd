...
listing:
  - id: test-desc
    ...
    # image-height: 100%
    contents:
      - path: https://github.com/validmind/validmind-library/blob/main/notebooks/code_sharing/llm/add_context_to_llm_descriptions.ipynb
...
::: {.callout}
Our documentation now follows the new **unified versioning scheme** for our software, starting with this `25.01` release. Included in this release is:
...
::: {.w-30-ns .tc}
[log_metric()](/validmind/validmind.html#log_metric){.button .button-green}
...
::: {.column-margin}
[Assess compliance](/guide/model-validation/assess-compliance.qmd){.button}
...
::: {.column-margin}
[Working with workflows](/guide/model-workflows/working-with-workflows.qmd){.button}
