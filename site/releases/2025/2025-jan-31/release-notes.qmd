...
::: {.w-70-ns .pr4}
For a detailed introduction to how this feature can benefit your organization, check out our companion blog post.
:::
...
::: {.w-70-ns}
Or, to get started with customizing your dashboards and reports, read our docs.
:::
...
The [`split`](https://docs.validmind.ai/validmind/validmind/datasets/regression/lending_club.html#preprocess) function in `lending_club.py` has been enhanced to support an optional validation set, allowing for more flexible dataset splitting.

A new utility function, [`get_demo_test_config`](https://docs.validmind.ai/validmind/validmind/datasets/credit_risk/lending_club.html#get_demo_test_config), has been added to generate a default test configuration for demo purposes.
...
Several enhancements and bug fixes to the {{< var validmind.developer >}} focus on documenting and testing credit risk scorecard models and ongoing monitoring capabilities:
