  ...
  - id: credit-risk
    ...
    contents:
      - title: "Document an application scorecard model"
        path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_with_ml.ipynb"
        categories: ["Individual Tests"]
        description: "Open notebook in JupyterHub {{< fa chevron-right >}}"
      - title: "Document an application scorecard model"
        path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_full_suite.ipynb"
        categories: ["Full Test Suite"]
        description: "Open notebook in JupyterHub {{< fa chevron-right >}}"
      - title: "Document an application scorecard model"
        path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/code_samples/credit_risk/application_scorecard_executive.ipynb"
  ...
  - id: ongoing-monitoring
    ...
    contents:
      - title: "Ongoing monitoring for application scorecard"
        path: "{{< var url.jupyterhub >}}/hub/user-redirect/lab/tree/code_samples/ongoing_monitoring/application_scorecard_ongoing_monitoring.ipynb"
        description: "Open notebook in JupyterHub {{< fa chevron-right >}}"
  - id: e2e-template
    type: grid
    grid-columns: 1
...
::: {.w-30-ns .tr} 
[log_metric()](/validmind/validmind.html#log_metric){.button .button-green target="_blank"}
...
::: {.w-20-ns .tr}
[print_env()](/validmind/validmind.html#print_env){.button target="_blank"}
:::
