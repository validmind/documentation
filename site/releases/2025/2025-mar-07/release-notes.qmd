...
::: {.column-margin}
[Breaking changes & deprecations](/releases/breaking-changes-and-deprecations.qmd){.button .button-green target="_blank"}
...
::: {.w-30-ns}
[Export documents](/guide/reporting/export-documents.qmd#export-validation-report){.button}
:::
