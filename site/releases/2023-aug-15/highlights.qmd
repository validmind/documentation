...
- **Update LICENSE to AGPL 3**. Added the GNU Affero General Public License version 3 to the documentation and validmind-python repos.

### ValidMind Platform UI (v1.4.10)

<!---Release 1.4.7 by @cachafla in [#444](https://github.com/validmind/frontend/pull/444)--->
- **Release 1.4.7**. - Redesigned application and navigation bar layout providing a consistent design language on every page of the ValidMind dashboard
