...
This release includes a number of improvements for the developer experience when using the {{< var vm_framework >}}, along with a visual redesign of the Platform UI.
