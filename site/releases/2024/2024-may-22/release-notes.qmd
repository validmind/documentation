...
[Document Overview](/guide/documentation/working-with-model-documentation.qmd#document-overview){.button .button-green}
...
::: {.w-40-ns .tc}
[Working with model documentation](/guide/documentation/working-with-model-documentation.qmd){.button .button-green}
...
::: {.w-30-ns .tc}
[Add model findings](/guide/validation/add-manage-artifacts.qmd#add-artifacts){.button}

:::

::::

![Adding a finding to a documentation section](/guide/validation/add-section-finding.gif){fig-alt="An animated gif demonstrating how to add a finding to a documentation section" .screenshot width=90%}
...
::: {.w-40-ns}
[Assign documentation section statuses](/guide/documentation/assign-documentation-section-statuses.qmd){.button}
...
::: {.w-30-ns}
[Inventory display views](/guide/inventory/customize-inventory-layout.qmd#inventory-display-views){.button}
