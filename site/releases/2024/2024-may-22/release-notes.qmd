...
[Document Overview](/guide/documentation/working-with-documentation.qmd#document-overview){.button .button-green}
...
::: {.w-40-ns .tc}
[Working with model documentation](/guide/documentation/working-with-documentation.qmd){.button .button-green}
...
::: {.w-30-ns .tc}
[Log artifacts](/guide/validation/log-artifacts.qmd#add-artifacts-on-documentation){.button}
...
::: {.w-40-ns}
[Assign documentation section statuses](/guide/documentation/assign-development-section-statuses.qmd){.button}
