...
::: {.w-30-ns}
[Archive and delete models](/guide/inventory/archive-delete-records.qmd){.button .button-green}
:::
...
::: {.w-30-ns}
[Inventory field types](/guide/inventory/manage-inventory-fields.qmd#inventory-field-types){.button}
:::
::::
...
::: {.w-40-ns .tc}
[Manage supporting documentation](/guide/validation/add-manage-artifacts.qmd#manage-supporting-documentation){.button}
:::
...
[Add or edit inventory fields](/guide/inventory/manage-inventory-fields.qmd#add-or-edit-inventory-fields){.button}
:::
...
::: {.w-40-ns .tl}
[Delete model findings](/guide/validation/add-manage-artifacts#delete-artifacts){.button}
:::
...
[Filter activity](/guide/inventory/view-record-activity.qmd#filter-activity){.button}
...
::: {.tc}
[Edit guidelines](/guide/validation/manage-validation-guidelines.qmd#edit-guidelines){.button}
:::
:::
