...
::: {.w-30-ns}
[Archive and delete models](/guide/inventory/archive-delete-models.qmd){.button .button-green}
:::
...
::: {.w-30-ns}
[Inventory field types](/guide/inventory/manage-model-inventory-fields.qmd#inventory-field-types){.button}
:::
::::
...
::: {.w-40-ns .tc}
[Manage supporting documentation](/guide/model-validation/add-manage-artifacts.qmd#manage-supporting-documentation){.button}
:::
...
[Add or edit inventory fields](/guide/inventory/manage-model-inventory-fields.qmd#add-or-edit-inventory-fields){.button}
:::
...
::: {.w-40-ns .tl}
[Delete model findings](/guide/model-validation/add-manage-artifacts#delete-artifacts){.button}
:::
...
[Filter activity](/guide/inventory/view-model-activity.qmd#filter-activity){.button}
