...
[View test result metadata](/guide/documentation/work-with-test-results.qmd#view-test-result-metadata){.button .button-green}
...
[View and filter model findings](/guide/validation/view-filter-artifacts.qmd){.button .button-green}
...
::: {.w-40-ns}
[Customize inventory layout](/guide/inventory/customize-inventory-layout.qmd){.button .button-green}

:::

::::

![Manage Columns on {{< fa cubes >}} Inventory page](/guide/inventory/manage-columns-demo.gif){fig-alt="An animation that shows how to manage columns in the model inventory" .screenshot}
...
::: {.w-30-ns}
[View model findings](/guide/validation/view-filter-artifacts.qmd#view-artifacts){.button .button-green}
...
You can specify the inventory fields that are [required when creating models]{.smallcaps} under **{{< fa gear >}} Settings** > **Model Inventory Fields**.

[Manage inventory fields](/guide/inventory/manage-inventory-fields.qmd){.button .button-green}
...
[Log in to {{< var vm.product >}}](/guide/access/log-in-to-validmind.qmd){.button}
...
::: {.w-40-ns .tc}
[Working with the inventory](/guide/inventory/working-with-the-inventory.qmd){.button}
...
::: {.w-40-ns .tc}
[Working with model documentation](/guide/documentation/working-with-model-documentation.qmd){.button}
...
::: {.w-60-ns} 
- All actions and information previously available for model documentation or validation reports continue to be available, now on the **Documentation** and **Validation Report** pages.
:::

::: {.w-40-ns .tc}
[Preparing validation reports](/guide/validation/preparing-validation-reports.qmd){.button}
