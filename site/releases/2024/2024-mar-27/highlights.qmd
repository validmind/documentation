...
[View and filter model findings](/guide/model-validation/view-filter-artifacts.qmd){.button .button-green}
...
::: {.w-30-ns}
[View model findings](/guide/model-validation/view-filter-artifacts.qmd#view-artifacts){.button .button-green}
