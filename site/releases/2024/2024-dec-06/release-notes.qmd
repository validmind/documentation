...
[Add and manage model findings](/guide/model-validation/add-manage-artifacts.qmd#manage-supporting-documentation){.button}
...
::: {.w-30-ns .tc}
[Working with model findings](/guide/model-validation/working-with-artifacts.qmd){.button}
...
::: {.w-25-ns}
[Track issue resolution](/guide/model-validation/add-manage-artifacts#track-artifact-resolution){.button}
