...
::: {.w-30-ns .tc}
[Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd#calculation){.button}
...
::: {.w-40-ns .tc}
[Edit model inventory fields](/guide/inventory/edit-model-inventory-fields.qmd#manage-supporting-documentation){.button}
...
::: {.w-40-ns .tc}
[Register models in the inventory](/guide/inventory/register-models-in-inventory.qmd){.button}
...
::: {.w-30-ns .tc}
[View model activity](/guide/inventory/view-model-activity.qmd){.button}
...
::: {.w-40-ns .tr}
[Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd){.button}
