...
::: {.w-40-ns .tc}
[Accessing {{< var vm.product >}}](/guide/access/accessing-validmind.qmd){.button .button-green}
...
::: {.w-30-ns .tc}
[Setting up workflows](/guide/workflows/setting-up-workflows.qmd){.button}
...
::: {.w-30-ns .tc}
[Workflow step types](/guide/workflows/setting-up-workflows.qmd#workflow-step-types){.button}

:::

::::

![Example Condition Branch where GenAI models require special approval from the User group Legal Team](/guide/workflows/example_condition-branch.png){fig-alt="A screenshot showing an example Condition Branch where GenAI models require special approval from the User group Legal Team" .screenshot width=90%}
...
::: {.w-30-ns .tc}
[Manage inventory fields](/guide/inventory/manage-inventory-fields.qmd#calculation){.button}

:::

::::

![Adding a calculation type field](/guide/inventory/calculation-field.png){fig-alt="A screenshot showing the screen for adding a calculation type field" width=90% .screenshot}
...
::: {.w-40-ns .tc}
[Edit inventory fields](/guide/inventory/edit-inventory-fields.qmd#manage-supporting-documentation){.button}

[Add and manage model findings](/guide/validation/add-manage-artifacts.qmd#manage-supporting-documentation){.button}

:::

::::

![Adding attachment notes](/guide/inventory/add-attachment-note.gif){ fig-alt="An animated gif demonstrating how to add attachment notes" .screenshot width=90%}
...
::: {.w-30-ns .tc}
[Work with test results](/guide/documentation/work-with-test-results.qmd#filter-historical-test-results){.button}
...
::: {.w-30-ns .tc}
[Assess compliance](/guide/validation/assess-compliance.qmd#link-developer-evidence){.button}
...
::: {.w-30-ns .tc}
[View record activity](/guide/inventory/view-record-activity.qmd){.button}
...
::: {.w-30-ns .tc}
[Work with content blocks](/guide/documentation/work-with-content-blocks.qmd){.button}
...
::: {.w-30-ns .tc}
[Working with model findings](/guide/validation/working-with-artifacts.qmd){.button}
...
::: {.w-40-ns .tr}
[Manage record stages](/guide/workflows/manage-record-stages.qmd){.button}
...
::: {.w-40-ns .tr}
[Manage inventory fields](/guide/inventory/manage-inventory-fields.qmd){.button}
...
::: {.w-25-ns}
[Track issue resolution](/guide/validation/add-manage-artifacts#track-artifact-resolution){.button}
...
[^9]: [Register with {{< var vm.product >}}](/guide/access/register-with-validmind.qmd)
