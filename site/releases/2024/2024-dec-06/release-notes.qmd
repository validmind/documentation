...
::: {.w-40-ns .tc}
[Edit inventory fields](/guide/inventory/edit-inventory-fields.qmd#manage-attachments){.button}

[Update artifacts](/guide/validation/update-artifacts.qmd#manage-attachments){.button}
