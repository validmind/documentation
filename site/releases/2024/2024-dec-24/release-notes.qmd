...
::: {.w-40-ns .tc}
[View and filter model findings](/guide/validation/customize-artifact-layouts.qmd){.button .button-green}
...
::: {.tc}
[Add and manage model findings](/guide/validation/add-manage-artifacts.qmd#delete-artifacts){.button}
