...
::: {.w-40-ns .tc}
[Knockout option pricing model](/notebooks/use_cases/capital_markets/quickstart_option_pricing_models.ipynb){.button .button-green}

[Heston option pricing model](/notebooks/use_cases/capital_markets/quickstart_option_pricing_models_quantlib.ipynb){.button .button-green}
...
::: {.w-40-ns .tc}
[View and filter model findings](/guide/model-validation/customize-artifact-layouts.qmd){.button .button-green}
...
::: {.w-30-ns .tc}
[Collaborate with others](/guide/documentation/collaborate-with-others.qmd#revision-history){.button}
...
::: {.tc}
[Add and manage model findings](/guide/model-validation/add-manage-artifacts.qmd#delete-artifacts){.button}
