...
[Edit model inventory fields](/guide/inventory/edit-model-inventory-fields.qmd){.button}
...
::: {.w-30-ns .tc}
[Search, filter, and sort models](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models){.button}
