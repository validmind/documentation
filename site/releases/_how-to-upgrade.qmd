...
1. Within your Jupyter Notebook:
    ...
    - **Using JupyterHub:**^[[Using JupyterHub](/get-started/developer/try-with-jupyterhub.qmd)] Hard refresh your browser tab.
    - **In your own developer environment**:^[[In your own developer environment](/developer/model-documentation/install-and-initialize-client-library.qmd)] Restart your notebook.
