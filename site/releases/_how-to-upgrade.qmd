...
To access the latest version of the {{< var validmind.platform >}},^[[Log in to {{< var vm.product >}}](/guide/access/log-in-to-validmind.qmd)] hard refresh your browser tab:
