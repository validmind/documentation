...
We've introduced a new guide for modifying configurations and parameters within the {{< var developer >}}, and new features to the {{< var platform >}} that enable you to remove blocks of content from documentation and work with your settings more effectively.

### {{< var validmind_developer >}} (v1.22.0)
...
The {{< var validmind_developer >}} has added support for regression models. The updates include:
...
The {{< var validmind_developer >}} has added support for clustering models. The updates include:
...
We added initial support for text embeddings models in the {{< var validmind_developer >}} which enables you to create, use and test a BERT embeddings model utilizing the Hugging Face library. The updates include:

- A new demo notebook
- A new folder in `model_validation` tests for embeddings, along with initial versions of tests for text embedding models
- Support for `feature_extraction` tasks in the Hugging Face model wrapper of the {{< var validmind_developer >}}
...
This notebook serves as a guide for modifying configuration and parameters within the {{< var validmind_developer >}}. It includes the following features:
...
You can now remove blocks of text or test-related content from model documentation in the editor of the {{< var platform >}}. This new feature gives you more control over your documentation and enables you to remove content that is no longer needed.
...
![New Settings page](settings-page.png)
