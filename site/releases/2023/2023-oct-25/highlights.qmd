...
We've introduced a new guide for modifying configurations and parameters within the {{< var vm_dev >}}, and new features to the {{< var vm_ui >}} that enable you to remove blocks of content from documentation and work with your settings more effectively.

### {{< var vm_framework >}} (v1.22.0)
...
This notebook serves as a guide for modifying configuration and parameters within the {{< var vm_framework >}}. It includes the following features:
...
- **Improved handling of Jupyter Notebooks for code samples and testing how-to content**. We now programmatically embed these notebooks in our documentation site and generate a downloadable `notebooks.zip` file with all notebooks and supporting datasets. Try it:
  ...
  - [Code samples](../../../developer-framework/samples-jupyter-notebooks.qmd)
  - [Tests and test suites](../../../developer-framework/testing-overview.qmd)
