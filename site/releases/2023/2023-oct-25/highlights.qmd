...
![](/guide/model-documentation/remove-test-driven-block.gif){width=80% fig-alt="A gif showcasing the process of removing a test-driven block" class="screenshot"}
...
![New Settings page](settings-page.png){width=80% fig-alt="A screenshot showing the new platform UI settings page" class="screenshot"}
