...
We've introduced a new guide for modifying configurations and parameters within the {{< var developer >}}, and new features to the {{< var vm.platform >}} that enable you to remove blocks of content from documentation and work with your settings more effectively.
