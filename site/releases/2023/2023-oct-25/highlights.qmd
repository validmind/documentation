...
[Remove content blocks](/guide/documentation/work-with-content-blocks.qmd#remove-content-blocks){.button .button-green}

:::

::: {.w-50-ns}

![Removing a test-driven block](/guide/documentation/remove-test-driven-block.gif){fig-alt="A gif showcasing the process of removing a test-driven block" .screenshot}
...
::: {.w-30-ns}
[Run tests and test suites](/developer/how-to/testing-overview.qmd){.button}
