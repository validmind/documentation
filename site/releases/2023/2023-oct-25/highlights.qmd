...
#### Added tests for safety toxicity and bias in text summarization
...
#### Improved handling of Jupyter Notebooks for code samples & testing how-to content

We now programmatically embed these notebooks in our documentation site and generate a downloadable `notebooks.zip` file with all notebooks and supporting datasets. 

:::: {.flex .flex-wrap .justify-around}

::: {.w-30-ns}
<form method="get" action="/developer/samples-jupyter-notebooks.htmll" target="_blank">
