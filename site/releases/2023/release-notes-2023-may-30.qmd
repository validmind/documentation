...
- You can now export model documentation to Word documents from the {{< var vm_ui >}}. This feature enables you make use of model documentation or validation report files outside of the {{< var vm_platform >}}. [Learn more ...](../../guide/export-documentation.qmd)

- We added a new demo model that allows you to test the {{< var vm_framework >}} with a time-series forecasting model. [Learn more ...](../../guide/samples-jupyter-notebooks.qmd)
