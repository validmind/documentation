...
![](list-tests.png){width=80% fig-alt="A screenshot showing examples for `list_tests()`" class="screenshot"}

`describe_test()`:

![](describe-test.png){width=80% fig-alt="A screenshot showing examples for `describe_test()`" class="screenshot"}

View the tests associated with a documentation template by running `preview_template()`:

![](preview-template.png){width=80% fig-alt="A screenshot showing examples for `preview_template()`" class="screenshot"}
...
![](test-results.png){width=80% fig-alt="A screenshot showing the example output `test_results`" class="screenshot"}
