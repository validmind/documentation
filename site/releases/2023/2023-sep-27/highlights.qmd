...
![](list-tests.png){fig-alt="A screenshot showing examples for `list_tests()`" class="screenshot"}

`describe_test()`:

![](describe-test.png){fig-alt="A screenshot showing examples for `describe_test()`" class="screenshot"}

View the tests associated with a documentation template by running `preview_template()`:

![](preview-template.png){fig-alt="A screenshot showing examples for `preview_template()`" class="screenshot"}
...
```
Output:
![](test-results.png){fig-alt="A screenshot showing the example output `test_results`" class="screenshot"}
