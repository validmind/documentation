...
![](onboarding-guide.png){width=80% fig-alt="A screenshot showing the new platform UI onboarding guide" class="screenshot"}
...
![](test-descriptions.gif){width=80% fig-alt="A screenshot showing improved test descriptions for the developer framework" class="screenshot"}
