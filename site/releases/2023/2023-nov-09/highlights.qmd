...
<form method="get" action="/guide/configuration/manage-your-profile.html#onboarding" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Getting started guide
</button>
</form>
...
![New ValidMind Platform onboarding guide](onboarding-guide.png){width=80% fig-alt="A screenshot showing the new ValidMind Platform onboarding guide" class="screenshot"}
...
<form method="get" action="/guide/model-inventory/customize-model-inventory-layout.html#inventory-display-views" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Inventory display views
</button>
</form>
...
![Table view](table-view.png){fig-alt="Model inventory table view" class="screenshot"}
...
![Card view](card-view.png){fig-alt="Model inventory card view" class="screenshot"}
...
![Improved test descriptions for the ValidMind Library](test-descriptions.gif){width=80% fig-alt="A screenshot showing improved test descriptions for the ValidMind Library" class="screenshot"}
