...
![New platform UI onboarding guide](onboarding-guide.png){width=80% fig-alt="A screenshot showing the new platform UI onboarding guide" class="screenshot"}
...
![Improved test descriptions for the developer framework](test-descriptions.gif){width=80% fig-alt="A screenshot showing improved test descriptions for the developer framework" class="screenshot"}
