...
This release includes a number of improvements for the developer experience when using the {{< var vm_framework >}}, along with a visual redesign of the {{< var vm_platform >}}.

### {{< var vm_framework >}} (v1.17.0)
...
- **Improved developer experience for the Metric test class**. We made a number of enhancements to the {{< var vm_framework >}} to improve the experience for developers:
