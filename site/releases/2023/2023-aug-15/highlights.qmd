...
::: {.w-20-ns}
<form method="get" action="https://docs.validmind.ai/validmind/validmind/vm_models.html#Test" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">Test()
</button>
</form>
...
Renamed `required_context` to `required_inputs` across the whole {{< var vm.product >}} SDK.
...
::: {.w-80-ns}
The new function `vm.get_test_suite()` allows you to access a specific test suite instance via the high-level {{< var vm.product >}} API.

:::

::: {.w-20-ns}
<form method="get" action="/validmind/validmind.html#get_test_suite" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">get_test_suite()
</button>
</form>
...
::: {.w-20-ns}
<form method="get" action="https://docs.validmind.ai/validmind/validmind/vm_models.html#TestSuite.get_default_config" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">get_default_config()
</button>
</form>
...
::: {.w-20-ns}
<form method="get" action="https://docs.validmind.ai/validmind/validmind/vm_models.html#TestContext" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">TestContext
</button>
</form>
