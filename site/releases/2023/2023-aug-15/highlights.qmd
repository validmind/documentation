...
A complementary new method, `get_required_context()`, now returns a list of all the context variables needed for tests to run, making it easier for you to ensure that everything is set up correctly.
