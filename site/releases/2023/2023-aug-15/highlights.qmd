...
This release includes a number of improvements for the developer experience when using the {{< var validmind_developer >}}, along with a visual redesign of the {{< var validmind.platform >}}.
