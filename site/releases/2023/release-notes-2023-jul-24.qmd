...
::: {.w-40-ns .tc}
[View model activity](/guide/inventory/view-model-activity.qmd){.button .button-green}

[Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd){.button .button-green}
