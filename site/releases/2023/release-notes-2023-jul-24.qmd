...
::: {.w-30-ns}
[Collaborate with others](/guide/documentation/collaborate-with-others.qmd){.button .button-green}
...
::: {.w-30-ns}
[Work with content blocks](/guide/documentation/work-with-content-blocks.qmd){.button .button-green}
...
::: {.w-40-ns}
[Manage document templates](/guide/templates/manage-document-templates.qmd){.button .button-green}
...
[Working with model findings](/guide/model-validation/working-with-artifacts.qmd){.button .button-green}

:::

::: {.w-40-ns .tc}
[View record activity](/guide/inventory/view-record-activity.qmd){.button .button-green}

[Working with the inventory](/guide/inventory/working-with-the-inventory.qmd){.button .button-green}
