...
- **User journey improvements**. We enhanced the architecture and content of our external docs site to make the user journey more efficient for model developers and model validators who are new to our products:
   ...
   * **Revised the "What is the {{< var vm_framework >}}?"** section to provide an end-to-end overview of the workflow that model developers should follow as they adopt the {{< var vm_dev >}}.  [Try it ...](../../guide/get-started-developer-framework.qmd)
