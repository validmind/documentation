...
This extensive release brings many improvements ValidMind, from the display of new metric metadata for test results in the {{< var developer >}}, to two new core features of {{< var vm.platform >}} — **Model Findings** and **Reports** pages, and many more!
