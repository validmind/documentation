...
#### Display results metadata on the UI
...
- [Reports](https://app.prod.validmind.ai/reports)
...
We enhanced both the **Model Inventory** page and the **Model Findings** page to give you the option to show or hide table columns. This feature enables you to customize the page to your own preferences, for example to include specific columns that are of specific interest to you. Columns can also be sorted by clicking on the column header.
...
You can add custom fields under **Settings** > **Custom Fields**:
...
Try it: [Custom Fields](https://app.prod.validmind.ai/settings/inventory-model-custom-fields)
...
<video src="create-new-group.mp4" width="80%" controls alt="A video that demonstrates how you can create new user groups under Settings > Groups." style="width: 90%; border: 4px solid #333; box-shadow: 5px 5px 5px #ccc, -5px 5px 5px #ccc; border-radius: 5px;">
  Your browser does not support the video tag.
</video>
...
![](311622556-c680428c-3dc9-4a16-8fa9-be277d8407ae.png)
...
: In this release, we are introducing the option to log in to ValidMind using SSO. Single sign on (SSO) allows your enterprise organizations to have a centralized authentication mechanism, more integrated control over internal applications, and integration with existing identity management systems, such as Google Workspace, LDAP or Active Directory. AAO also provides more enhanced security and customization control over authentication processes according to the organization's security policies and compliance requirements. 

In order for this feature to apply to an organization, we can configure our Auth0 authentication provider to integrate with your organization's identity provider. The steps required to make SSO available to you include:
