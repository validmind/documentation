...
New metric metadata available in the {{< var validmind.platform >}} makes it easy to see information about the test results that were generated with the {{< var validmind_developer >}}. Test results metadata includes:
