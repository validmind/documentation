...
You can specify the inventory fields that are [required on registration]{.smallcaps} under **{{< fa gear >}} Settings** > **{{< fa sliders >}} Model Inventory Fields**.
...
You can create new user groups under **{{< fa gear >}} Settings** > **{{< fa users >}} Groups**.
