...
|----------|----------|
| ![](model-findings-page.png){fig-alt="A screenshot of the new Model Findings page showing a table of findings that can be clicked on" class="screenshot"} | ![](reports-page.png){fig-alt="A screenshot of the new Reports page showing several tiles with bar charts that can be clicked on" class="screenshot"} |
...
![](model-findings-manage-columns.png){width=80% fig-alt="A screenshot that highlights how you can show or hide table columns on the Model Findings page by clicking the Manage Columns button and toggling individual columns on or off" class="screenshot"}
