...
- [Model Findings]({{< var vm_url >}}/model-findings)
- [Reports]({{< var vm_url >}}/reports)
...
- [Model Inventory]({{< var vm_url >}}/model-inventory)
- [Model Findings]({{< var vm_url >}}/model-findings)
...
Try it: [Custom Fields]({{< var vm_url >}}/settings/inventory-model-custom-fields)
