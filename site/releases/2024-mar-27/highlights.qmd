...
![](user-invite-history.png){width=80% fig-alt="A screenshot that highlights the user invitation history, showing both pending and accepted invitations to join your organization" class="screenshot"}
