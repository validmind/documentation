...
[Learn more ...](/get-started/developer-framework/try-in-your-own-environment.qmd)
...
- [Using JupyterHub](/get-started/developer-framework/try-with-jupyterhub.qmd): Reload your browser tab and re-run the `%pip install --upgrade validmind` cell.
