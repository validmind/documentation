...
New metric metadata available in the ValidMind Platform UI makes it easy to see information about the test results that were generated with the {{< var vm_framework >}}. Test results metadata includes:
