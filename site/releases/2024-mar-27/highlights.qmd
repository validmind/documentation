...
This extensive release brings many improvements {{< var vm.product >}}, from the display of new metadata for test results in the {{< var vm.developer >}}, to two new core features of {{< var vm.platform >}} — **{{< fa triangle-exclamation >}} Model Findings** and **{{< fa square-poll-vertical >}} Analytics** pages, and many more!
...
![Detail expansion of test runs on the test result timeline](/developer/model-documentation/test-run-details.gif){fig-alt="A gif showcasing detail expansion of test runs on the test result timeline" .screenshot}
...
#### New {{< fa triangle-exclamation >}} Model Findings & {{< fa square-poll-vertical >}} Analytics pages

We're introducing two important new features to the {{< var validmind.platform >}}: 

- **{{< fa triangle-exclamation >}} Model Findings** 
- **{{< fa square-poll-vertical >}} Analytics** 

The **{{< fa square-poll-vertical >}} Analytics** page offers access to essential information about your model validation efforts, summarizing findings, while the **{{< fa triangle-exclamation >}} Model Findings** page facilitates efficient tracking of issues identified during model validation. Together, these pages improve your model validation workflow and simplify compliance with organizational standards and regulatory requirements.
...
![New {{< fa triangle-exclamation >}} Model Findings page with a table of clickable findings](model-findings-page.png){fig-alt="A screenshot of the new Model Findings page showing a table of findings that can be clicked on" .screenshot}

The new **{{< fa triangle-exclamation >}} Model Findings** page allows you to efficiently track all findings flagged during model validation, such as major and minor issues, deficiencies, model limitations, or other concerns that must be addressed. 
...
[Working with analytics](/guide/model-validation/working-with-analytics.qmd){.button}
...
#### Customize {{< fa cubes >}} Model Inventory and {{< fa triangle-exclamation >}} Model Findings pages

We enhanced both the **{{< fa cubes >}} Model Inventory** and **{{< fa triangle-exclamation >}} Model Findings** pages to allow for the customization of table views. 
...
##### {{< fa cubes >}} Model Inventory

:::: {.flex .flex-wrap .justify-around}

::: {.w-50-ns}

On the **{{< fa cubes >}} Model Inventory** page, you can show or hide table columns by clicking the **Manage Columns** button and toggling individual columns on or off.
...
![Manage Columns on {{< fa cubes >}} Model Inventory page](/guide/model-inventory/manage-columns-demo.gif){fig-alt="An animation that shows how to manage columns in the model inventory" .screenshot}

##### {{< fa triangle-exclamation >}} Model Findings

The same customization is available on the **{{< fa triangle-exclamation >}} Model Findings** page:

:::: {.flex .flex-wrap .justify-around}

::: {.w-70-ns}

![Manage Columns on {{< fa triangle-exclamation >}} Model Findings page](model-findings-manage-columns.png){fig-alt="A screenshot of the Model Findings page with Manage Columns highlighted" .screenshot}
...
![Invite New Users page with user invitation history](user-invite-history.png){fig-alt="A screenshot that highlights the user invitation history, showing both pending and accepted invitations to join your organization" .screenshot}
...
::: {.w-60-ns}
- This change aims to improve navigation by providing you with a single entry point from the **{{< fa cubes >}} Model Inventory** page. 
...
::: {.w-60-ns}
- Previously, both the **{{< fa cubes >}} Model Inventory** and the (deprecated) **Documentation Projects** pages offered similar navigation pathways which were redundant. 
