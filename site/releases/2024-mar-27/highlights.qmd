...
[Learn more ...](../../get-started/quickstart-try-developer-framework-in-your-own-developer-environment.qmd)
...
- [Using JupyterHub](../../get-started/quickstart-try-developer-framework-with-jupyterhub.qmd): Reload your browser tab and re-run the `%pip install --upgrade validmind` cell.
