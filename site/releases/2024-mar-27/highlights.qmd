...
New metric metadata available in the ValidMind Platform UI allows you to view information about the test results that were generated with the ValidMind Developer Framework. Test results metadata includes:

- The history of values for test results that get included in your model documentation
- User attribution to tell you who updated the test results
- Relevant inputs associated with the test results

Here is an example for how you can access test results metadata:
