...
#### Customize {{< fa cubes >}} Inventory and {{< fa triangle-exclamation >}} Model Findings pages

We enhanced both the **{{< fa cubes >}} Inventory** and **{{< fa triangle-exclamation >}} Model Findings** pages to allow for the customization of table views. 
