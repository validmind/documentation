...
![Manage Columns on Model Inventory page](/guide/model-inventory/manage-columns-demo.gif){fig-alt="An animation that shows how to manage columns in the model inventory" .screenshot}
