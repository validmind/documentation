...
This extensive release brings many improvements ValidMind, from the display of new metric metadata for test results in the {{< var vm_dev >}}, to two new core features of {{< var vm_ui >}}: **Model Findings** and **Reports** pages, and many more!

### {{< var vm_framework >}} (v2.0.0)
...
New metric metadata available in the {{< var vm_platform >}} makes it easy to see information about the test results that were generated with the {{< var vm_framework >}}. Test results metadata includes:
...
: Documentation projects have been removed from the {{< var vm_platform >}}, streamlining navigation for accessing model documentation. You can now easily locate a model of interest and then access its documentation or validation report directly within the context of that model. 
...
[Learn more ...](../../get-started/developer-framework/quickstart-try-developer-framework-in-your-own-developer-environment.qmd)
...
[Learn more ...](../../developer-framework/supported-models.qmd)
...
- [In your own developer environment](../../developer-framework/install-and-initialize-developer-framework.qmd): Restart your notebook and re-run:
