...
This extensive release brings many improvements ValidMind, from the display of new metric metadata for test results in the {{< var developer >}}, to two new core features of {{< var platform >}} — **Model Findings** and **Reports** pages, and many more!

### {{< var validmind_developer >}} (v2.0.0)
...
New metric metadata available in the {{< var validmind_platform >}} makes it easy to see information about the test results that were generated with the {{< var validmind_developer >}}. Test results metadata includes:
...
### {{< var validmind_platform >}} (v1.18.4)
...
- [Model Findings]({{< var vm_url_us1 >}}/model-findings)
- [Reports]({{< var vm_url_us1 >}}/reports)
...
- [Model Inventory]({{< var vm_url_us1 >}}/model-inventory)
- [Model Findings]({{< var vm_url_us1 >}}/model-findings)
...
Try it: [Custom Fields]({{< var vm_url_us1 >}}/settings/inventory-model-custom-fields)
...
Try it: [Groups]({{< var vm_url_us1 >}}/settings/groups)
...
Try it: [Invite New Users]({{< var vm_url_us1 >}}/settings/invitation)
...
: Documentation projects have been removed from the {{< var validmind_platform >}}, streamlining navigation for accessing model documentation. You can now easily locate a model of interest and then access its documentation or validation report directly within the context of that model. 
...
To access the latest version of the [{{< var validmind_platform >}}](http://app.prod.validmind.ai/), reload your browser tab.

To upgrade the {{< var validmind_developer >}}:
