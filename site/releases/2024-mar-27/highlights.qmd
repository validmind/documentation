...
A new **Reports** page provides quick insights into your model validation efforts to ensure effective oversight and management of model-related risks. Close integration between the **Reports** and **Model Findings** pages enhances your ability to make informed decision-making and helps ensure compliance with organizational standards and regulatory requirements. Reports are grouped into bar charts for different types of findings, including:
...
When registering new models in the model inventory, you can now designate custom fields as mandatory. When this feature is enabled, users must complete these custom fields before they can proceed with registering a model. This feature ensures that all necessary information is provided upfront, improving the completeness and accuracy of the model registration process.
...
- Enabled the creation of new groups
...
- Added a **Invite History** table to show accepted invitations
- Renamed the existing table to **Pending Invites** and updated it to show only users that have not yet accepted

Combined, these changes make it easier to see both pending and accepted invitations for new users to join your organization:
