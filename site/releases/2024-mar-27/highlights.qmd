...
This extensive release brings many improvements ValidMind, from the display of new metric metadata for test results in the {{< var vm.developer >}}, to two new core features of {{< var vm.platform >}} — **Model Findings** and **Reports** pages, and many more!
...
New metric metadata available in the {{< var validmind.platform >}} makes it easy to see information about the test results that were generated with the {{< var validmind.developer >}}. Test results metadata includes:
...
- [In your own developer environment](/developer/model-documentation/install-and-initialize-developer-framework.qmd): Restart your notebook and re-run:
