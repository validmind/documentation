...
The new metric metadata in the ValidMind Platform UI allows you to view information about the results that were generated with the ValidMind Developer Framework, including:

- The history of values for results that get shown in your model documentation
- User attribution to tell you who updated those results
- Relevant inputs associated with the results
