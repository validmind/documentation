...
Learn how model developers and model validators can get started and collaborate with the ValidMind platform.

TO DO add a graphic that shows how developers document and validators validate

These instructions show you how to:

- **Model developers** — Initialize the developer framework, add documentation, run tests, and send the resulting information to the ValidMind SaaS platform.
- **Model validators** — TO DO Step through the model validation process.
