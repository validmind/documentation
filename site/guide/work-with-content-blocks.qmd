...
7. For test-driven blocks, a menu containing available tests will appear:


      ![](test-driven-block-menu.png){width=85%}

   - Select tests using the checkboxes on the left.
   - Search by name using **{{<fa magnifying-glass >}} Search** on the top-left.
   - Click on a test to preview it. By default, selected tests are previewed.

8. Click **Insert test result to document** when you are ready.
