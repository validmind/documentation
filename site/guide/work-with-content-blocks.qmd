...
While editing a content block, you can insert math equations using the editor. Its interface is accessed by clicking the square-root icon within the toolbar. You can use the interface to type out the equation, or paste in a LaTeX formula. See [the editor's docs](https://ckeditor.com/docs/ckeditor5/latest/features/math-equations.html) for detailed instructions.
