...
While editing a content block you can insert math equations using the MathType editor, accessed via the **√** icon within the toolbar.
::: 

You can use the interface to type out the equation, or paste in a LaTeX formula:
