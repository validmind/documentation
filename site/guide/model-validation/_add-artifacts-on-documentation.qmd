...
1. When you are done, click **Save** to submit the artifact. 
   ...
   Once created, you can then [add supporting documentation to your artifact](/guide/model-validation/add-manage-artifacts.qmd#manage-attachmentsn){target="_blank"}.
