...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select the **Latest** or **Saved Versions** tab.[^7]

4. Click on a Validation Report type file.[^8]

### Add or edit validation reports

Modify the contents of the **Latest** version of your validation report:[^9]
...
2. Add **Risk Assessment Notes**, as well as assess compliance for each section of your validation report:
    ...
    - Validation guidelines are displayed under the header of each section of your report to help ensure that you are compliant with your organization's requirements.[^10]
    - Whenever you make a change, a log of the action is recorded under **{{< fa wifi >}} Model Activity**.[^11]
...
3. For any **Risk Assessment Notes**, save your edits to retain your changes:
   ...
   You can also suggest changes and leave comments.[^12]
...
[^10]: [Manage validation guidelines](/guide/model-validation/manage-validation-guidelines.qmd)

[^11]: [View model activity](/guide/model-inventory/view-model-activity.qmd)

[^12]: [Collaborate with others](/guide/model-documentation/collaborate-with-others.qmd)
