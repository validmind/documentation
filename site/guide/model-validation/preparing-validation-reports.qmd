...
2. Add **Risk Assessment Notes**, as well as assess compliance for each section of your validation report:
    ...
    - Validation guidelines are displayed under the header of each section of your report to help ensure that you are compliant with your organization's requirements.[^9]
    - Whenever you make a change, a log of the action is recorded under **{{< fa wifi >}} Model Activity**.[^10]
...
3. For any **Risk Assessment Notes**, save your edits to retain your changes:
   ...
   You can also suggest changes and leave comments.[^11]
...
[^9]: [Manage validation guidelines](/guide/model-validation/manage-validation-guidelines.qmd)
