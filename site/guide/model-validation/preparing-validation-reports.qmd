...
4. You can now add any **Risk Assessment Notes**, as well as assess compliance[^5] for each section of your validation report.
     ...
     Whenever you make a change, a log of the action is recorded under **Model Activity**.[^6]
...
As you work with your validation report, view the guidelines associated with that template to ensure that you are compliant with the requirements for that report:
