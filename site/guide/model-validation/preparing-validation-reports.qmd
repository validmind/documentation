...
3.  In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Validation Report type file under Documents.[^6]

    Jump to any section of the validation report by expanding the table of contents on the left and selecting the relevant section you would like to view.

4. Add **Risk Assessment Notes**, as well as assess compliance[^7] for each section of your validation report:
