...
1. In the left sidebar, click **{{< fa triangle-exclamation >}} Model Findings**.
   ...
   ![List of findings across all models](all-model-findings.png){width=80% fig-alt="A screenshot showing a list of findings across all models" .screenshot}
...
3. In the left sidebar that appears for your model, click **Model Findings**.
   ...
   ![List of findings specific to a model](model-specific-findings.png){width=80% fig-alt="A screenshot showing a list of findings specific to a model" .screenshot}
...
3. On the **Select Your Filters** dialog that opens, enter your filtering criteria for:
   ...
   ![Filter dialog with some options selected](filter.png){width=80% fig-alt="A screenshot of the filter dialog with some options selected" .screenshot}
