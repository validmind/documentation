...
3. On the **Select Your Filters** dialog that opens, enter your filtering criteria.[^7]
...
2. Click **{{< fa table >}} Manage Columns**.
   ...
   - Available columns are determined by your model finding fields.[^8]
...
[^8]: [Manage model finding fields](manage-model-finding-fields.qmd)

[^9]: [Manage custom findings views](#manage-custom-findings-views)

[^10]: [Customize model findings layout](#customize-model-findings-layout)

[^11]: [Filter and sort model findings](#filter-and-sort-model-findings)