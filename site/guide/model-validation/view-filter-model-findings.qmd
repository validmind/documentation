...
4. Select a finding type[^5] to view from the tabs:
...
4. Click on any model finding for more information, including the proposed remediation plan and any supporting attachments.[^6]
...
[^5]: [Manage finding types](/guide/model-validation/manage-finding-types.qmd)
...
[^10]: [Manage model finding fields](manage-model-finding-fields.qmd)

[^11]: [Manage custom findings views](#manage-custom-findings-views)

[^12]: [Customize model findings layout](#customize-model-findings-layout)

[^13]: [Filter and sort model findings](#filter-and-sort-model-findings)