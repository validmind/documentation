...
2. Click **{{< fa table >}} Manage Columns** to manage column visibility and order:
   ...
   ![Manage Columns on all Model Findings](manage-finding-columns-demo.gif){width=40% fig-alt="An animation that shows how to manage columns on all model findings" .screenshot}
...
[^4]: [Filter and sort model findings](#filter-and-sort-model-findings)
