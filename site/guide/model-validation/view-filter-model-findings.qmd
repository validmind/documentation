...
Filter this list to only findings you want to see,[^4] or toggle visibilty for column headers that can be dragged and dropped to change the order with the **{{< fa table >}} Manage Columns** menu.
