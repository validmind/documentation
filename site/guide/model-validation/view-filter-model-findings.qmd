...
1. In the left sidebar, click **{{< fa triangle-exclamation >}} Model Findings**.
   ...
   ![](all-model-findings.png){width=80% fig-alt="A screenshot showing a list of findings across all models"}
...
3. In the left sidebar that appears for your model, click **Model Findings**.
   ...
   ![](model-specific-findings.png){width=80% fig-alt="A screenshot showing a list of findings specific to a model"}
