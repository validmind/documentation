...
3. On the Add New View modal that appears, enter the:
...
2. Click **{{< fa bookmark >}} Select View**.
...
[^9]: [Save new findings view](#save-new-findings-view)
