...
1. In the left sidebar, click **Reports**.
   ...
   ![](reports-models.png){width=60% fig-alt="Screenshot of the Reports page that shows several bar charts with model data"}

   :::

   ::: {.w-50-ns}

   ![](reports-findings.png){width=60% fig-alt="Screenshot of the Reports page that shows several bar charts with findings data"}
...
2. For each of the bar charts, you can hover over individual bars to get a more detailed view.
