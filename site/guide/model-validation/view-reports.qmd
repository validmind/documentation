...
1. In the left sidebar, click **Reports**.
   ...
   In the page that opens, you can see bar charts for different types of data, including:
   ...
   ![Reports page showing several bar charts with model data](reports-models.png){fig-alt="Screenshot of the Reports page that shows several bar charts with model data"}

   :::

   ::: {.w-50-ns}

   ![Reports page showing several bar charts with findings data](reports-findings.png){fig-alt="Screenshot of the Reports page that shows several bar charts with findings data"}
...
3. For each of the bar charts, you can click on individual bars to get a more detailed view.
...
You can also add any of the report widgets to your dashboard.[^1]
