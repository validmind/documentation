...
Viewing reports in the {{< var validmind_platform >}} is closely related to [working with model findings](work-with-model-findings.qmd). For example, you can drill down into specific model findings which will take you to the **Model Findings** page.