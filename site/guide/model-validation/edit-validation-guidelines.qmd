...
Edit the guidelines for validation reports associated with a template to ensure that you are compliant with the requirements for validation reports.
...
- [x] Model documentation has already been submitted for review by the model validation team for this project.[^2]
