...
![Reports page showing several bar charts with model data](reports-models.png){fig-alt="Screenshot of the Reports page that shows several bar charts with model data" .screenshot}
...
![Reports page showing several bar charts with findings data](reports-findings.png){fig-alt="Screenshot of the Reports page that shows several bar charts with findings data" .screenshot}
