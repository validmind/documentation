...
1. Select a finding type^[[Manage finding types](/guide/model-validation/manage-finding-types.qmd)] to view:
...
1. Select a [finding type](/guide/model-validation/manage-finding-types.qmd){target="_blank"} to view:
