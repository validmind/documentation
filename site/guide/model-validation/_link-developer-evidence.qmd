...
1. In the left sidebar that appears for your model, click **Validation Report** under [{{< fa file >}} Documents](/guide/templates/working-with-model-documents.qmd){target="blank"}.
