...
Prepare to track the progress and resolution of findings by customizing finding types and their associated statuses available to be logged on models in your inventory.
...
[^3]:
    ...
    To further customize fields displayed on finding types, refer to: [Manage artifact fields](manage-artifact-fields.qmd)
