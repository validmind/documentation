...
- Default artifact types cannot be deleted, only archived.[^4]
- When archiving an artifact type, existing artifacts of that type will remain viewable, but no new artifacts of that type can be created.
