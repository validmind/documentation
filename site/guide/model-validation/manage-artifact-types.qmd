...
4. Make your desired changes to the artifact type's details:
    ...
    - **[model fields display]{.smallcaps}** — Select which upstream model inventory fields to display as read-only on artifacts of this type.[^6] Selected fields appear in a "Model Information" section on the artifact detail page. Drag fields to reorder them.
...
[^6]: Validation Issue types have a curated set of core model fields enabled by default. Other artifact types have this feature disabled by default.
