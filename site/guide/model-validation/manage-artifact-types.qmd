...
4. Make your desired changes to the artifact type's details:
    ...
    - **[artifact statuses]{.smallcaps}** — Configure the statuses available to this artifact type.[^4]
...
Artifact statuses cannot be deleted if in use on a artifact. Ensure that the status you're deleting is not associated with any artifacts before proceeding.
:::
...
[^4]: [Manage artifact type statuses](#manage-artifact-type-statuses)
