...
3. Click the existing artifact type you want to edit,[^12] or create a new artifact type[^13] to add, edit, or delete artifact statuses.
...
[^12]: [Edit artifact types](#edit-artifact-types)

[^13]: [Add artifact types](#add-artifact-types)
