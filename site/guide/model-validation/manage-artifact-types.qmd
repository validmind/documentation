...
4. Enter or make your desired changes to the artifact type's details and permissions.

    - Changes made to configurations other than [model fields display]{.smallcaps} are saved automatically.
    - Click **Save Model Fields Configuration** to apply changes to your [model fields display]{.smallcaps}.

## Manage artifact type statuses

::: {.callout}
`Open` and `Closed` are [[{{< fa lock >}} default]{.smallcaps}]{.bubble} stages, meaning they cannot be modified or removed.
