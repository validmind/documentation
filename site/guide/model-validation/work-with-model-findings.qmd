...
- A model document project is completed or in progress.[^2]

- To work with model findings, you must have the following permissions:[^3] 
...
[^3]: [Manage permissions](manage-permissions.qmd)
