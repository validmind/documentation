...
1. On **{{< fa triangle-exclamation >}} Model Findings**, click {{< fa filter >}} **Filter**.
...
### Delete project findings

If project findings were created in error or otherwise need to be removed:

1. On **{{< fa triangle-exclamation >}} Model Findings**, click on the finding you want to delete or apply a filter to locate the correct finding first.[^5]

2. Once you confirm, that finding will be removed from the model.

   Whenever a finding is deleted, a log of the action is recorded under **Model Activity**.[^6]
...
[^4]: [Filter project findings](#filter-model-findings)

[^5]: [Filter project findings](#filter-model-findings)

[^6]: [View documentation activity](/guide/model-documentation/view-documentation-activity.qmd)
