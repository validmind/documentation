...
4. When you are done, click **Save** to submit the finding. 
   ...
   Once created, you can then add supporting documentation to your finding.[^7]
...
1. On the findings detail page under **[attachments]{.smallcaps}**:
...
1. On the findings detail page under **[attachments]{.smallcaps}**, locate the attachment you'd like to delete.
...
[^6]: [Manage supporting documentation](#manage-supporting-documentation)

[^7]: [Manage supporting documentation](#manage-supporting-documentation)

[^8]: [View model findings](#view-model-findings)
