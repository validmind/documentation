...
After a finding is created, you're able to add supporting documentation to it in the form of a `.pdf` file.

#### Add attachment to finding

1. On the findings detail page under **Supporting Documentation**:
...
2. Click **Upload File** to submit the file.
   ...
   After you upload the file, it will be available for review under that finding. 
...
1. On the findings detail page under **Supporting Documentation**, locate the attachment you'd like to delete.
