...
2. On the page that opens, click on the finding you want to update or apply a filter to locate the correct finding first.[^5]
...
1. Locate your finding:

   - Through the the list of all **Model Findings**[^6]
   - Or via a model's specific findings page by first locating your model, then clicking on **Model Findings**

2. Click on the finding you want to add an attachment to.

3. Under Supporting Documentation:

    - Drag and drop a PDF to upload.
    - Or, click **choose a .pdf file** to select your file manually.
...
[^5]: [Filter model findings](#filter-model-findings)
