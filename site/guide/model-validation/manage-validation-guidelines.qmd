...
- [x] {{< var link.login >}}
- [x] You are a [{{< fa hand >}} Customer Admin]{.role} or [{{< fa circle-check >}} Validator]{.role}, or assigned another role with sufficient permissions to perform the tasks in this guide.[^1] 
...
By default, the [{{< fa hand >}} Customer Admin]{.role} role has all these permissions.[^4]
:::
