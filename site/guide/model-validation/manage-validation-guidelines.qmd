...
- [x] {{< var link.login >}}
- [x] You are a [Customer Admin]{.role} or [Validator]{.role}, or assigned another role with sufficient permissions to perform the tasks in this guide.[^1] 
...
By default, the [Customer Admin]{.role} role has all these permissions.[^4]
:::
