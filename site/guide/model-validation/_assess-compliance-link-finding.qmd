...
1. In any section of the documentation where the button is available, click **{{< fa plus >}} Link Finding to Report**. 
   ...
   ![Validation report section 2.1.1. that shows a compliance assessment with the option to link to finding](/guide/model-validation/link-finding.png){width=80% fig-alt="A screenshot of the validation report section 2.1.1. that shows a compliance assessment with the option to link to finding" .screenshot}

1. On the **Link Finding to Report** page that opens, select from the list of available findings, or [create a new finding](/guide/model-validation/add-manage-model-findings.qmd){target="_blank"}. 
