...
When linking findings to validation reports, you can add findings as you assess a model's compliance:
...
3. In the left sidebar that appears for your model, click **{{< fa shield >}} Validation Report** and then locate 2. Validation.

4. In any section of the documentation where the button is available, click **{{< fa link >}} Link Finding to Report**. 

5. On the **Link Finding to Report** modal that opens, click **{{< fa plus >}} Create New Finding**.^[[Create new finding](/guide/model-validation/add-manage-model-findings.qmd)] 
