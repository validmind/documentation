...
3. On the **Add Model Finding** page that opens,  provide information for: 
   ...
   ![Adding a finding with the ValidMind Insights™ panel](add-section-finding.gif){width=80% fig-alt="An animated gif demonstrating how to add a finding with the ValidMind Insights™ panel" .screenshot}
...
2. On the finding's detail page, click **{{< fa trash-can>}} Delete Finding** in the right sidebar.
   ...
   ![Deleting a finding](delete-model-finding.gif){width=80% fig-alt="An animated gif demonstrating how to delete a finding" .screenshot}
