...
5. On the Link Artifact to Report modal that opens, click **{{< fa plus >}} Add {Artifact Type}**.

6. On the modal that opens, provide information for your artifact.

7. When you are done, click **Add {Artifact Type}** to submit the artifact.
...
- While artifact deletion will be logged under your {{< fa wifi >}} Model Activity,[^10] deleted artifacts cannot be retrieved.
...
[^11]: [Link artifacts to reports](/guide/model-validation/assess-compliance.qmd#link-artifacts-to-reports)
