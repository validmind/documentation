...
[^2]: [Working with model documentation](/guide/documentation/working-with-model-documentation.qmd)
...
[^8]: [Preparing validation reports](/guide/model-validation/preparing-validation-reports.qmd#validation-overview)
