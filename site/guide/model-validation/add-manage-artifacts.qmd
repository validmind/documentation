...
[^6]: [Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models)
...
[^11]: [View model activity](/guide/inventory/view-model-activity.qmd)
