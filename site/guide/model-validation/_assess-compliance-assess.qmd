...
1. In any section of the documentation where the **[assessment]{.smallcaps}** dropdown menu is available, select one of the available options:
   ...
   ![Validation report section 2.1.1. that shows a compliance assessment with the option to link to finding](/guide/model-validation/assess-compliance.png){fig-alt="A screenshot of the validation report section 2.1.1. that shows a compliance assessment with the option to link to finding" .screenshot}
   ...
   ![Risk assessment compliance summary](/guide/model-validation/assess-compliance-summary.png){fig-alt="A screenshot of the risk assessment compliance summary" .screenshot}
...
1. In any section of the documentation where the **[assessment]{.smallcaps}** dropdown menu is available, select one of the available options:
   ...
   ![Validation report section 2.1.1. that shows a compliance assessment with the option to link to finding](/guide/model-validation/assess-compliance.png){width=80% fig-alt="A screenshot of the validation report section 2.1.1. that shows a compliance assessment with the option to link to finding" .screenshot}
