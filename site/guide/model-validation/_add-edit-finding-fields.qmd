...
a. Finding fields require a [type]{.smallcaps},^[[Finding field types](/guide/model-validation/manage-model-finding-fields.qmd#finding-field-types)] a [name]{.smallcaps}, a [description]{.smallcaps} and a [finding type]{.smallcaps}.^[[Manage finding types](/guide/model-validation/manage-model-finding-fields.qmdmanage-finding-types.qmd)]
    ...
    - Assign **[write permissions]{.smallcaps}** to allow granular access to editing this field gated by model stakeholder types.^[edit-finding-fields]
...
1. Finding fields require a [type]{.smallcaps}, a [name]{.smallcaps}, a [description]{.smallcaps} and a [finding type]{.smallcaps}.
