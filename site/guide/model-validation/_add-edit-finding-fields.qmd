...
a. Finding fields require a [type]{.smallcaps},^[[Finding field types](/guide/model-validation/manage-model-finding-fields.qmd#finding-field-types)] a [name]{.smallcaps}, a [description]{.smallcaps} and a [finding type]{.smallcaps}.^[[Manage finding types](/guide/model-validation/manage-finding-types.qmd)]
