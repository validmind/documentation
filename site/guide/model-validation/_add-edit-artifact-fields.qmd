...
a. Artifact fields require you to enter a **[title]{.smallcaps}** (name), select a field **[type]{.smallcaps}**,^[[Artifact field types](/guide/model-validation/manage-artifact-fields.qmd#artifact-field-types)] and indicate what **[artifact types]{.smallcaps}**^[[Manage artifact types](/guide/model-validation/manage-artifact-types.qmd)] the field is available on.
