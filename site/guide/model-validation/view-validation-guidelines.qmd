...
- To view validation guidelines, you must have permission to read and add comments to validation reports, as well as access asessment guidelines. By default, the `Validator` role has all these permissions.[^3]
