...
1. In any section of the documentation where the button is available, click **{{< fa plus >}} Link Evidence to Report**. 
   ...
   ![Validation report section 2.1.1. that shows a compliance assessment with the option to link to evidence](/guide/model-validation/link-evidence.png){fig-alt="A screenshot of the validation report section 2.1.1. that shows a compliance assessment with the option to link to evidence" .screenshot}
...
1. In any section of the documentation where the button is available, click **{{< fa plus >}} Link Evidence to Report**. 
   ...
   ![Validation report section 2.1.1. that shows a compliance assessment with the option to link to evidence](/guide/model-validation/link-evidence.png){width=80% fig-alt="A screenshot of the validation report section 2.1.1. that shows a compliance assessment with the option to link to evidence" .screenshot}
