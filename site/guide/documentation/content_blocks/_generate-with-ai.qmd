...
1. Enter in a custom prompt and click **Send**, or click **Generate Content** to compose a draft for review.
   ...
   You can also include record attachments in `.pdf` format^[[Edit inventory fields](/guide/inventory/edit-inventory-fields.qmd#manage-attachments)] as context documents:
