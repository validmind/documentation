...
1. Select test results:
   ...
   - Use **{{<fa magnifying-glass >}} Search by name** on the top-left to locate specific test results.
    ...
    ![Test-driven blocks that have been selected for insertion](/guide/documentation/test-driven-block-menu.png){fig-alt="A screenshot showing several test-driven blocks that have been selected for insertion" .screenshot}
...
1. After inserting the results into your document, click on the text to make changes or add comments,^[[Collaborate with others](/guide/documentation/collaborate-with-others.qmd)] or configure what is displayed on the test result.^[[Configure test result displays](/guide/documentation/work-with-test-results.qmd#configure-test-result-displays)]
