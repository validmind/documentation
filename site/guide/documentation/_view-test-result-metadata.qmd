...
6. Hover over the test result until the top-right hand corner menu appears and select **{{< fa clock >}} See Timeline**:
    ...
    - On the test result timeline, click on the **{{< fa chevron-down >}}** associated with a test run to expand for details, such as **Record Information** or **Dataset Information**.
