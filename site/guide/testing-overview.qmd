...
ValidMind provides built-in tests and test suites, which help you produce documentation during stages of the model development lifecycle where you need to validate that your work satisfies MRM (model risk management) requirements.
...
- [Integrate an External Test Provider](../notebooks/code_samples/custom_tests/external_test_providers.ipynb)
