...
## Can I use my own test provider?

Yes, ValidMind supports custom test providers for running custom tests. We provide a code sample that demonstrates how to load and register these providers with ValidMind. It also shows how to use tests from these providers in documentation templates. [Read more...](../notebooks/code_samples/custom_tests/external_test_providers_demo.ipynb)
