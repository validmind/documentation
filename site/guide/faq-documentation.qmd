...
## Can the documentation be initialized from the UI instead of the {{< var vm_dev >}}?

ValidMind allows you to write documentation directly in the online UI editor, without having to use the {{< var vm_dev >}}.

From the online UI editor, you can edit text and tables and upload your test results, including images. Using the {{< var vm_dev >}}, you can execute test suites and generate the corresponding documentation.
