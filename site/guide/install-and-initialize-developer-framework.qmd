...
In order to integrate the {{< var vm_dev >}} and to be able to upload to the ValidMind Platform, you must provide the following information through a code snippet that you copy from the ValidMind Platform UI:
