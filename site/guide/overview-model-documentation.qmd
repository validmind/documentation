...
keywords: "overview, model testing, model documentation, Developer Framework, cloud, ai risk, model risk management, ValidMind"
date: last-modified
---
...
The Developer Framework consists of a client-side library, API endpoints for models and testing, and validation tests that streamline the model development process. Implemented as a series of independent libraries in Python and R, our framework ensures compatibility and flexibility with diverse sets of developer environments and requirements.
...
::: {.g-col-5}
What the Developer Framework does:

- Easy to install with `pip install validmind`.
...
- Dual-licensed: it's available as open-source under AGPL v3 license and also with a commercial software license.
:::
...
- You can easily add support for new models and data types by defining new classes within the framework. We provide templates to guide you through this process.
- To include custom tests in the library, you can define new functions. We offer templates to help you create these custom tests.
- You have the flexibility to integrate third-party test libraries seamlessly. These libraries can be hosted either locally within your infrastructure or remotely, for example, on GitHub. Leverage additional testing capabilities and resources as needed. [Read more ...](../notebooks/external_test_providers_demo.ipynb)
:::
