...
- You can easily add support for new models and data types by defining new classes within the framework. We provide templates to guide you through this process. [Read more ...](view-templates.qmd)
...
::: {.callout-important}
ValidMind does not send any personal identifiable information (PII) or any data used by your models when generating documentation reports.
:::
