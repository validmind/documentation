...
e. After approving a validation issue, you can further customize it by clicking on the issue to edit fields such as owner, due date, and status.^[[Add and manage artifacts](add-manage-artifacts.qmd)]
...
Use AI to automatically suggest validation issues based on the gaps identified in your assessment.
