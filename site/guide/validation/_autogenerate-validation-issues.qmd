...
e. After approving a validation issue, you can further customize it by clicking on the issue to edit fields such as owner, due date, and status.^[[Update artifacts](/guide/validation/update-artifacts.qmd)]
