...
c. Make your desired changes to the risk area's **Name** and **Description**.
...
d. Make your desired changes to the risk area's **Title** and **Description**.
...
5. For the section you'd like to add a guideline to,[^6] click **{{< fa plus >}}** and select **{{< fa circle-check >}} Guideline Block** under **Content**.
...
[^6]: **{{< fa circle-check >}} Guideline Block**s can only be added to sections that do not contain any children.
