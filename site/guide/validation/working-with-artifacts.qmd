...
Good artifacts help explain how well the records such as models perform in terms of predictive accuracy, generalization to new data, and the importance of variables or features used in the modeling process. For example, artifacts logged on models typically include:
