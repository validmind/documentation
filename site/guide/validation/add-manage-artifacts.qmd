...
1. Locate the artifact[^9] you want to edit fields for.

2. On the artifact details page:

    - Click on the core fields in the right sidebar to make changes.
    - Select the **Overview** tab to click on highlighted fields, or click on the Description field to make changes.
