...
Locate the artifact you want to update[^9] to edit artifact fields or leave comments on the artifact:

::: {.panel-tabset}

#### Edit fields on artifacts

1. On the artifact details page:

    - Click on the core fields in the right sidebar to make changes.
    - Select the **Overview** tab to click on highlighted fields, or Description, Proposed Remediation Plan, and Attachments fields to make changes.
