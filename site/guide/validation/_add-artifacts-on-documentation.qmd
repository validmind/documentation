...
1. When you are done, click **Add {Artifact Type}** where `{Artifact Type}` is the artifact type you want to add to submit the artifact.
   ...
   Once created, you can then upload attachments to your artifact.^[[Manage attachments on artifacts](/guide/validation/update-artifacts.qmd#manage-attachments)]
...
e. When you are done, click **Add {Artifact Type}** where `{Artifact Type}` is the artifact type you want to add to submit the artifact.
   ...
   Once created, you can then [upload attachments to your artifact](/guide/validation/update-artifacts.qmd#manage-attachments){target="_blank"}.
