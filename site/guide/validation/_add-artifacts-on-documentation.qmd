...
1. Click on a Development type file.^[[Working with documentation](/guide/documentation/working-with-documentation.qmd#document-overview)]
...
1. On your record's documentation page, click **{{< fa square-plus >}} Add Artifact**.
...
1. When you are done, click **Add {Artifact Type}** where `{Artifact Type}` is the artifact type you want to add to submit the artifact.
   ...
   Once created, you can then add supporting documentation to your artifact.^[[Manage attachments on artifacts](/guide/validation/update-artifacts.qmd#manage-attachments)]
...
e. When you are done, click **Add {Artifact Type}** where `{Artifact Type}` is the artifact type you want to add to submit the artifact.
   ...
   Once created, you can then [add supporting documentation to your artifact](/guide/validation/update-artifacts.qmd#manage-attachments){target="_blank"}.
