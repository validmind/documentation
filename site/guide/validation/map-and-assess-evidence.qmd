...
::: {.callout}
## Currently, automatic mapping and assessment retrieve only content from Development type documents.[^4]

To manually add and assess evidence for other document types, refer to [Assess compliance](/guide/validation/assess-compliance.qmd).
...
4. Click on a Validation type file.[^10]
...
[^7]: [Preparing validation reports](preparing-validation-reports.qmd#validation-overview)
...
[^10]: [Preparing validation reports](preparing-validation-reports.qmd#validation-overview)