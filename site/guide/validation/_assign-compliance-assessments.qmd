...
1. In the same Class Imbalance Assessment sub-section above the Risk Assessment Notes, locate the Guideline with the **Assessment** drop-down.

1. Click **Select a value for this guideline** to choose one of the available assessment options.

1. At the top of the page, confirm that the compliance summary shown for each subsection under 2. Validation provides an accurate overview for current qualitative and quantitative risk assessments:
