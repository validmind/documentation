...
2. Explore the Platform UI (15 minutes):
    ...
    - [Explore Sample Model Documentation](explore-sample-model-documentation.qmd)
    - [Register Your First Model](register-your-first-model.qmd)
    - [Generate documentation for your model](upload-to-documentation.qmd)
