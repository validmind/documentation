...
First, let's learn how to create your own documentation project. You can use this project to upload tests and documentation and then add that to the Quickstart notebook you looked at earlier.
...
Ready to learn more about how you can use ValidMind? Check out [Upload from the developer framework to the platform UI](upload-from-dev-framework-to-platform-ui.qmd.qmd).