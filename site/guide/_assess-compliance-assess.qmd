...
1. In any section of the documentation where the **Assessment** dropdown menu is available, select one of the available options:
   ...
   ![](../guide/assess-compliance.png){width=60% fig-alt="A screenshot of the validation report section 2.1.1. that shows a compliance assessment with the option to link to finding."}
...
![](../guide/assess-compliance-summary.png){width=60% fig-alt="A screenshot of the risk assessment compliance summary."}
