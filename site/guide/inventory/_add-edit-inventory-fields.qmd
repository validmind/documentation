...
a. Inventory fields require you to enter a **[title]{.smallcaps}** (name) and select a **[type]{.smallcaps}**.^[[Inventory field types](/guide/inventory/manage-model-inventory-fields.qmd#inventory-field-types)]
...
a. Include optional information for your field:
    ...
    - Assign a field to a **[group]{.smallcaps}**.^[Ungrouped fields will be listed under No Group: [Add inventory field groups](/guide/inventory/manage-model-inventory-fields.qmd#add-inventory-field-groups)]
...
{{< include /guide/inventory/_example-next-review-date-and-days-remaining.qmd >}}
...
a. Under the Default Fields grouping, click on the inventory field you would like to edit.
    ...
    Expand any inventory field group to see more fields.^[[Add inventory field groups](/guide/inventory/manage-model-inventory-fields.qmd#add-inventory-field-groups)]

a. Toggle the following options on or off:

    - **[disable field]{.smallcaps}** — Hide this field from all models in your inventory.^[[Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd)]
    - **[show on registration]{.smallcaps}** — Show this field when registering models in your inventory.^[[Register models in the inventory](/guide/inventory/register-models-in-inventory.qmd)]
...
Custom inventory fields are fields created by your organization. Expand any inventory field group to see more fields.^[[Add inventory field groups](/guide/inventory/manage-model-inventory-fields.qmd#add-inventory-field-groups)]
...
a. Make your desired changes to your inventory field, then click **Save**.
    ...
    Field keys for custom inventory field can be renamed under the **[actions]{.smallcaps}** column.^[[Rename custom field keys](/guide/inventory/manage-model-inventory-fields.qmd#rename-custom-field-keys)]
