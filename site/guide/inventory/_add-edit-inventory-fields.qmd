...
[^edit-fields]:
    ...
    - [**Inventory Record Stakeholders**](/guide/configuration/manage-model-stakeholder-types.qmd) — Write permissions on a per record basis.
    - [**Application Roles**](/guide/configuration/manage-roles.qmd) — Write permissions on a per field basis across all inventory records.
