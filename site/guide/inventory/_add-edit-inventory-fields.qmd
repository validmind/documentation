...
a. Inventory fields require you to enter a **[title]{.smallcaps}** (name), select a field **[type]{.smallcaps}**,^[[Inventory field types](/guide/inventory/manage-inventory-fields.qmd#inventory-field-types)] and indicate what **[inventory record types]{.smallcaps}** the field is available on.
