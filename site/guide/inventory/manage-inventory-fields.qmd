...
aliases:
  ...
  - /guide/inventory/manage-model-inventory-fields.html
includes:
    inventory: true
---
...
2. Under {{< fa cube >}} Inventory, select **Inventory Record Fields**.
    ...
    Displayed in groups[^2] as lists are the inventory fields available to records in your organization with a quick view of:[^3]
