...
3. Any existing record interdependencies are shown under the **Interdependencies** section.
...
3. Click **{{< fa square-plus >}} Manage Dependencies** to open up the interdependencies detail menu.
...
5. On your list of related records from the inventory, add or remove interdependencies as desired:
