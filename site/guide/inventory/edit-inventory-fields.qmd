...
b. On the record details page:

    - Click on the core fields in the right sidebar to make changes.
    - Select the **Overview** tab to click on highlighted fields to make changes, or to manage inventory record stakeholders.
    - Select the **Inventory Fields** tab to click on additional fields to make changes.[^6]
...
c. Click **Save** to apply your changes to the field.
