...
:::: {.content-visible when-format="html" when-meta="includes.inventory"}
Attachments
: Upload supporting files for your model.^[[Manage supporting documentation](/guide/inventory/edit-inventory-fields.qmd#manage-supporting-documentation)] Files must be less than 50 MB each in size.
::::
...
Attachments
: Upload supporting files for your [model](/guide/inventory/edit-inventory-fields.qmd#manage-supporting-documentation){target="_blank"} or [artifact](/guide/model-validation/add-manage-artifacts.qmd#manage-supporting-documentation){target="_blank"}. Files must be less than 50 MB each in size.
