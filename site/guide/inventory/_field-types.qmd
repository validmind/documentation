...
Attachments
: Upload supporting files for your artifact.^[[Manage attachments on artifacts](/guide/model-validation/add-manage-artifacts.qmd#manage-attachments)] Files must be less than 50 MB each in size.
::::
...
Attachments
: Upload supporting files for your [record](/guide/inventory/edit-inventory-fields.qmd#manage-attachments){target="_blank"} or [artifact](/guide/model-validation/add-manage-artifacts.qmd#manage-attachments){target="_blank"}. Files must be less than 50 MB each in size.
