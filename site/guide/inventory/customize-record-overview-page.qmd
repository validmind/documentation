...
4. On the Customize Section Layout modal that appears, configure the model inventory fields[^3] that appear: 
   ...
   - Click and hold a field or field group and drag-and-drop to rearrange the order of fields and field groups. Fields and field groups can be moved from the Side Column to the Main Column and vice versa.[^4]
