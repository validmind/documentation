...
## View all record activity

{{< include _view-record-activity-overview.qmd >}}

{{< include _view-record-activity-steps.qmd >}}

## Filter all record activity

Filter to narrow down all record activity per model by category or specific values:
...
[^21]: [Working with the inventory](/guide/inventory/working-with-the-inventory.qmd#search-filter-and-sort-models)
