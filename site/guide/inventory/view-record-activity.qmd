...
aliases:
  ...
  - /guide/inventory/view-model-activity.html
---
...
1. Select a record or find your record by applying a filter or searching for it.[^2]

2. In the expanded sidebar that appears for your record, click **{{< fa wifi >}} Activity**.
...
5. From the **Select category** dropdown, choose your filter options:
   ...
   - **Logged Artifacts**[^3] — Artifacts logged on the record, by type.[^4] Only types of artifacts logged on the record will appear for selection.
   - **Logged Metrics**[^5] — Metrics over time logged on the record.
   - **Record Stakeholders**[^6] — Stakeholders added or removed from the record.
   - **Record Fields**[^7] — Inventory fields updated on the record *(label reflects current UI)*.
   - **Record Documents**[^8] — Updates made to documents on the record, including any logged test results from the {{< var validmind.developer >}}.[^9]
   - **Record Lifecycle**[^10] — Record stage transitions.
   - **Record Workflows**[^11] — Workflow activity on the record.
   ...
   - **Logged Artifacts**[^12] — Artifacts logged on the record, by type.[^13] Only types of artifacts logged on the record will appear for selection.
   - **Record Fields**[^14] — Inventory fields updated on the record. Only inventory fields populated on the record will appear for selection.
   - **Record Documents**[^15] — Updates made to documents on the record, including any logged test results from the {{< var validmind.developer >}}.[^16] Only documents with activity will appear for selection.
   - **Record Workflows**[^17] — Workflow activity on the record. Only workflows applied to the record will appear for selection.
   - **User**[^18] — Events performed by user. Only users with activity on the record will appear for selection.
...
To view activity for individual inventory fields:[^20]

1. In the left sidebar, click **{{< fa cubes >}} Inventory**.

2. Under the [record type]{.smallcaps} drop-down, select the type of record you want view field activity for.[^21]

3. Select a record or find your record by applying a filter or searching for it.[^22]
...
[^6]: [Manage record stakeholder types](/guide/configuration/manage-record-stakeholder-types.qmd#manage-stakeholder-types-on-models)

[^7]: [Edit inventory fields](edit-inventory-fields.qmd)
...
[^14]: [Edit inventory fields](edit-inventory-fields.qmd)
...
[^20]: [Edit inventory fields](edit-inventory-fields.qmd)

[^21]: [Manage inventory record types](/guide/inventory/manage-inventory-record-types.qmd)

[^22]: [Working with the inventory](/guide/inventory/working-with-the-inventory.qmd#search-filter-and-sort-records)
