...
- You can now export model documentation to Word documents from the {{< var vm_ui >}}. This feature enables you make use of model documentation or validation report files outside of the ValidMind Platform. [Learn more ...](export-documentation.qmd)

- We added a new demo model that allows you to test the {{< var vm_framework >}} with a time-series forecasting model. [Learn more ...](samples-jupyter-notebooks.qmd)
