...
subtitle: "Our guides offer step-by-step instructions for frequent tasks you perform within the {{< var validmind.platform >}}."
date: last-modified
sidebar: false
page-layout: full
...
<style>
  body {
    background-image: url('/assets/img/ecosystem-checks.svg'); 
    background-position: calc(100% - 25px) calc(100% - 100px); 
