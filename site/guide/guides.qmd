...
listing:
  ...
  - id: guides-attestation
    ...
    fields: [title, description]
    contents:
    - attestation/set-up-attestation.qmd
    - attestation/review-attestation.qmd
    - attestation/approve-attestation.qmd
    - attestation/manage-attestation-templates.qmd
  - id: guides-reports
    contents: 
...
- [Manage validation guidelines](/guide/model-validation/manage-validation-guidelines.qmd) — Set up and customize validation guidelines for your organization
- [Preparing validation reports](/guide/model-validation/preparing-validation-reports.qmd) — Review model documentation and assess compliance
- [Working with model findings](/guide/model-validation/working-with-model-findings.qmd) — View, filter, and manage model validation findings
