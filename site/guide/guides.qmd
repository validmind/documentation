...
Use workflows to match your organizational needs for overseeing the review and approval of models throughout the model lifecycle:
...
### VIDEOS TO BE DISCUSSED — INDIVIDUAL

<!-- Scripts for these videos are in https://app.shortcut.com/validmind/story/4906/how-to-video-for-preparing-validation-reports#activity-6483 -->
<!-- The original recordings for these videos are in are in https://streamyard.com/ — refer to the scripts for the recording links  -->
<!-- Copies of these videos are in https://drive.google.com/open?id=1tNg9-fRxutp_XF3BPKKn1RkTE6k0XEVU&usp=drive_fs -->

:::: {.flex .flex-wrap .justify-around}

::: {.w-50-ns}
{{< video https://youtu.be/e_j7_gBgKjU >}}
{{< video https://youtu.be/4jnGCbnKzL8 >}}
{{< video https://youtu.be/3aHUls9fJGg >}}
:::

::: {.w-50-ns}
{{< video https://youtu.be/kP15G1NgSuE >}}
{{< video https://youtu.be/dllEkYd-HeY >}}
:::

::::

### ALTERNATE EMBED VIA PLAYLIST 

<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PL8vB59eD-pJ6srM3cuaxaqdC6jXRXhcBh" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
