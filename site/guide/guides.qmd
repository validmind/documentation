...
Use workflows within the {{< var vm.platform >}} to match your organizational needs for risk management oversight:
...
Then, prepare validation reports, work with artifacts and evidence, and collaborate with model developers within the {{< var validmind.platform >}}:
