...
Customize your personal user experience within the {{< var validmind_platform >}}:
...
To work with documentation, documentation templates, and model documentation in the {{< var platform >}}, and to collaborate with model validators: 
