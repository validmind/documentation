...
To work with documentation projects, documentation templates, and model documentation in the Platform UI, and to collaborate with model validators: 
...
To set up approvals, prepare validation reports, collaborate with model developers, link evidence to your reports, or work with project findings:
