...
Learn how to run our introductory Jupyter notebook with the ValidMind Docker image.
...
1. From the command line, pull and run the ValidMind Docker image:
...
2. Copy the browser URL that starts with `http://127.0.0.1:8888` from the message and paste it into a new browser tab.

   After JupyterLab opens, you should see a link for our `Quickstart_Customer Churn_full_suite.ipynb` notebook.
...
If you downloaded our Docker image instead of using Google Colaboratory, continue with the section [Explore the ValidMind Platform](explore-validmind.qmd#explore-the-validmind-platform) in the Quickstart.
