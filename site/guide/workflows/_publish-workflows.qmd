...
c. Locate the workflow you want to publish.

d. Under the **Actions** column, click **{{< fa ellipsis-vertical >}}** and select **{{< fa circle-check >}} Publish Workflow**.

    You can also publish a draft workflow from its details page — under Actions, click **{{< fa circle-check >}} Publish Workflow**.
