...
[^on-webhook]:
    ...
    2. Under [select target model for payload]{.smallcaps}, choose a model from [your inventory](/guide/inventory/working-with-the-inventory.qmd) to populate the target for the payload.
