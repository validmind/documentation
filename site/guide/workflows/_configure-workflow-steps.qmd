...
[^on-webhook]:
    ...
    4. Click **{{< fa copy >}}** to the right of the `x-api-key` and its value to copy them to your clipboard.
    5. Click **{{< fa copy >}}** to the right of the `x-api-secret` and its value to copy them to your clipboard.
    6. Send your `POST` request to the webhook URL and include these headers with your request to authenticate your call.
