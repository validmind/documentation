...
Once you've created a saved personal view, you can shared it with others in your organization.[^11]
...
::: {.callout}
To publish a saved personal view to your organization, you must have permissions to manage shared timeline views.^
:::
...
3. Hover over the view you want to removed from shared organization access.
