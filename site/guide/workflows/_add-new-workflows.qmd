...
a. Under **[workflow start]{.smallcaps}**, select when the workflow should be initiated:
    ...
    - **Manually** — Start this workflow manually.^[[Initiate model workflows](/guide/workflows/manage-workflows.qmd#initiate-model-workflows)]
...
a. Under **[workflow start]{.smallcaps}**, select when the workflow should be initiated:
    ...
    - **Manually** — [Start this workflow manually.](/guide/workflows/manage-workflows.qmd#initiate-model-workflows){target="_blank"}
