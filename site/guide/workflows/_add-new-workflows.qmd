...
1. Under **[workflow start]{.smallcaps}**, select when the workflow should be initiated:
    ...
    - **Manually** — Start this workflow manually.^[[Initiate model workflows](/guide/workflows/manage-model-workflows.qmd#initiate-model-workflows)]
...
1. Click **Add Workflow** to save your blank workflow, and then [configure your workflow steps](/guide/workflows/configure-model-workflows.qmd#configure-workflow-steps).
...
a. Under **[workflow start]{.smallcaps}**, select when the workflow should be initiated:
    ...
    - **Manually** — [Start this workflow manually.](/guide/workflows/manage-model-workflows.qmd#initiate-model-workflows){target="_blank"}
