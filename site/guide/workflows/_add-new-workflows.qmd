...
1. Select the tab for the type of workflow to add:
    ...
    - **Finding Workflows** — Workflows that apply to logged findings.^[[Working with artifacts](/guide/model-validation/working-with-artifacts.qmd)]
...
a. Select the **[finding type]{.smallcaps}**^[[Manage artifact types](/guide/model-validation/manage-artifact-types.qmd)] this workflow applies to.
