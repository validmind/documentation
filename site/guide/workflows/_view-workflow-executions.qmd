...
2. Select the type of `{Record}` you want to view all workflow executions for by clicking on **{Record} Inventory**:^[[Manage inventory record types](/guide/inventory/manage-inventory-record-types.qmd)]
...
2. Select the type of `{Record}` you want to view all workflow executions for by clicking on **{Record} Inventory**:
