...
When all the actions that can be performed by your role are completed for that model or finding at that stage of the workflow, actions will disappear from your view.
:::
