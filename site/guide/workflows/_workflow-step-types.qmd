...
4. When you are finished setting up all your branch paths, click **Update Step** to save your step.
    ...
    Proceed with linking the Condition Branch with your subsequent steps.^[[Link workflow together](/guide/workflows/configure-model-workflows.qmd#link-workflow-together)]
...
- Use this step when all of your other steps have been configured and linked together.^[[Link workflow together](/guide/workflows/configure-model-workflows.qmd#link-workflow-together)]
:::
...
[^step-types-2]: **[Configure model workflows](/guide/workflows/configure-model-workflows.qmd#create-custom-workflows):**<br><br>
