...
1. Under [select target model for payload]{.smallcaps}, choose a model from your inventory^[[Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd)] to populate the target for the payload.
...
[^wait]:
    ...
    - [Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd#inventory-field-types)
