...
- Available when configuring workflows for the **Intake** inventory record type.
...
| **Classification Method** | Select **Automated routing** or **Manual review**. Recorded in record activity as how the inventory record type was assigned. |
