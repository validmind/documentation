...
2. Click **{{< fa copy >}} Copy** to the right of Payload to copy the payload to your clipboard.
    ...
    Include this payload in your `POST` request to the webhook URL.
...
- Include these headers with your `POST` request to authenticate your call when you send the request to the webhook URL.
