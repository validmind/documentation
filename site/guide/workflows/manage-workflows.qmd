...
[^4]: [Conditional step requirements](conditional-step-requirements.qmd#wait)

[^5]: [Working with the inventory](/guide/inventory/working-with-the-inventory.qmd#search-filter-and-sort-records)

[^6]: [View and filter artifacts](/guide/validation/view-filter-artifacts.qmd#view-artifacts)
...
[^11]: [View and filter artifacts](/guide/validation/view-filter-artifacts.qmd#view-artifacts)