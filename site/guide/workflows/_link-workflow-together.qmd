...
To initiate the beginning of your workflow:^[After you’ve [configured your workflow steps](/guide/workflows/configure-model-workflows.qmd#configure-workflow-steps), you can then link your workflow together.]
...
{{< fa users >}} Approval steps need to be subsequently linked to both a [Rejected]{.bubble .red .red-bg} and an [Approved]{.bubble .green .green-bg} {{< fa cube >}} Model Stage Change step:^[[Workflow step types](/guide/workflows/setting-up-workflows.qmd#workflow-step-types)]
