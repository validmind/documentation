...
1. On the details page of your finding,^[[View and filter artifacts](/guide/model-validation/view-filter-artifacts.qmd#view-artifacts)] locate the Workflows section.
...
1. On the [details page of your finding](/guide/model-validation/view-filter-artifacts.qmd#view-artifacts){target="_blank"}, locate the Workflows section.
