...
While your model stages^[[Manage model stages](/guide/model-workflows/manage-model-stages.qmd)] and workflows states^[[Workflow states](/guide/model-workflows/setting-up-workflows.qmd#workflow-states)] are custom to your organization, some examples are:
