...
Conditional requirements are required or allowed for the following step types:^[[Workflow step types](/guide/workflows/setting-up-workflows.qmd#workflow-step-types)]
