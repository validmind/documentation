...
1. Enter a **Name** and a **Description**, then select a **Color** for your workflow state.
...
1. Make your changes to the **Name**, **Description**, and **Color** for your workflow state.
