...
[^15]: [Manage model stakeholder types](/guide/configuration/manage-record-stakeholder-types.qmd)

[^16]: [Manage roles](/guide/configuration/manage-roles.qmd)

[^17]: [Manage model stakeholder types](/guide/configuration/manage-record-stakeholder-types.qmd)
