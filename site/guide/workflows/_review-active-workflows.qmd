...
1. On the details page of your finding,^[[View and filter model findings](/guide/model-validation/view-filter-artifacts.qmd#view-model-findings)] locate the [active workflows]{.smallcaps} section.
...
1. On the [details page of your finding](/guide/model-validation/view-filter-artifacts.qmd#view-model-findings){target="_blank"}, locate the [active workflows]{.smallcaps} section.
