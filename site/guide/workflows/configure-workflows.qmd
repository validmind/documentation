...
#### Via workflows applied to findings

1. On the details page of your finding,[^4] locate the [active workflows]{.smallcaps} section.
...
a. Make your desired changes to step configuration[^5] and step relationships[^6] on your workflow.
...
[^4]: [View and filter model findings](/guide/model-validation/view-filter-model-findings.qmdl#view-model-findings)

[^5]: [Configure workflow steps](#configure-workflow-steps)

[^6]: [Link workflow together](#link-workflow-together)