...
2. Hover over the workflow you'd like to clone.
...
4. Make your changes to the workflow's **[title]{.smallcaps}** and **[workflow type]{.smallcaps}**.
    ...
    Additional changes can be made to the cloned workflow after cloning by editing.[^3]
...
- Workflows executed on models or artifacts will not be updated to the new version. To apply the latest version of a workflow, abort the existing version of the workflow and manually initiate the workflow again.[^4]
...
a. Make your desired changes to step configuration[^7] and step relationships[^8] on your workflow.
...
[^4]: [Manage workflows](/guide/workflows/manage-workflows.qmd#update-workflow-versions)
...
[^7]: [Configure workflow steps](#configure-workflow-steps)

[^8]: [Link workflow together](#link-workflow-together)
