...
- Workflows executed on models or artifacts will not be updated to the new version. To apply a newer version of a workflow, abort the existing version of the workflow and manually initiate the new version.[^6]
- Older versions of a workflow are read-only and cannot be edited.
