...
::: {.callout title="Saving edits to a workflow already applied to models or artifacts will create a new version of the workflow."}

- Versions of a workflows applied to models or artifacts will not be updated to the new version.
