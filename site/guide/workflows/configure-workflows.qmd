...
- Older versions of a workflow are read-only and cannot be edited or executed on models or artifacts.
...
[^6]: [Manage workflows](/guide/workflows/manage-workflows.qmd)
