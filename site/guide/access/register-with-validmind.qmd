...
Register with our cloud-hosted {{< var validmind.platform >}}, so you can begin working with documentation or configure {{< var vm.product >}} for your organization.
...
7. Return to the main {{< var vm.product >}} dashboard[^7] by clicking on **Back to {{< var vm.product >}}**. 
    ...
    Sample records[^8] are populated for you in this new organization to demonstrate the usage of {{< var vm.product >}}.
...
:::
::: {.w-40-ns}
![Sample records populated by ValidMind](sample-models.png){fig-alt="Screenshot of the sample records populated by ValidMind" .screenshot group="dashboard"}
...
[^7]: [Customize your dashboard](/guide/configuration/customize-your-dashboard.qmd)

[^8]: [Working with the inventory](/guide/inventory/working-with-the-inventory.qmd)
