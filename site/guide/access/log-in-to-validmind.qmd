...
Log in to {{< var validmind.platform >}} to work with your documentation, prepare validation reports, perform governance tasks, or to configure {{< var vm.product >}} for your organization.
...
Once you have the necessary access, you can work with records and workflows and perform actions such as editing documentation, running tests, or completing validations.
