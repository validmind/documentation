...
4. In the left sidebar that appears for your model, click **Documentation**. 
   ...
   ::: {.callout-tip title="Unresolved conversations" appearance="minimal"}
   ...
   You can also resolve conversations directly from this popup.
   :::

   At the bottom of the Document Overview, you will also see quick view of any [documentation activity](view-documentation-activity.qmd).
