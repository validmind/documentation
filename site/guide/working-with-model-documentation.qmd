...
This section describes how to work with model documentation in the {{< var vm_platform >}}. Typically, you perform the tasks described here _after you have uploaded some initial model documentation_ with the {{< var vm_framework >}}. 
...
4. In the left sidebar that appears for your model, click **Documentation**.
   ...
   Here on this documentation overview page, **you can view a summary of:**
