...
After you upload initial model documentation through the {{< var vm_dev >}}, use the Platform UI to make qualitative edits to model documentation, view guidelines, collaborate with validators, and submit your model documentation for approval. 

::: {.callout-tip}
## Looking to get started as a model developer?

This section describes how to work with model documentation in the ValidMind Platform UI. Typically, you perform the tasks described here _after you have uploaded some initial model documentation_ with the {{< var vm_framework >}}. 
