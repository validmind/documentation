...
- Model documentation has submitted for review or validation by the model validation team^3^ 
...
1. Suggested changes appear in green or red highlighted text, depending on if the change is adding or removing content. To accept or decline a change, click the highlighted text, then click <span style="color: green">{{< fa check >}}</span> or <span style="color: red">{{< fa check >}}</span>. You can also reply to a suggested change.
