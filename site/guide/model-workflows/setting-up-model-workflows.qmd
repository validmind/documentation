...
- Must be connected to both a rejection and approval {{< fa cube >}} Model Stage Change step.[^13]
...
| [threshold]{.smallcaps} | Percentage of approvers required for approval.[^14] |
| Approval Message | When your workflow reaches this {{< fa users >}} Approval step, the selected [approval group]{.smallcaps}  will shown this message.[^15] |
...
2. Enter in the **[path name]{.smallcaps}** and designate the **[conditions]{.smallcaps}**[^16] that apply to this path.
...
- Use this step when all of your other steps have been configured and linked together.*

:::

### Conditional requirements*

Conditional requirements can be configured for the following step types:**
...
[^13]: **[Configure custom workflows](configure-custom-workflows.qmd#create-custom-workflows):**<br><br>
...
[^16]: [Conditional requirements](#conditional-requirements)

[^17]: [Configure custom workflows](configure-custom-workflows.qmd#create-custom-workflows)

[^18]: [Manage model inventory fields](/guide/model-inventory/manage-model-inventory-fields.qmd#inventory-field-types)

[^19]: Make model inventory fields **[required on registration]{.smallcaps}** to ensure necessary fields have valid values.
