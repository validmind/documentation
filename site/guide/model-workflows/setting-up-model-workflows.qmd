...
::: {.w-25-ns .pl2 .mt2}
[{{< fa maximize >}} &hairsp; condition branch](#condition-branch){.button .button-fill}
...
Transitions the workflow into another state.[^6]
...
Workflow states are stauses unique to a specific workflow. Set up workflow states by either:

- Adding them while configuring a **{{< fa wifi >}} Workflow State Change** step,
- Or 
