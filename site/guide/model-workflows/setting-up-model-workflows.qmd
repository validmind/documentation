...
::: {.w-30-ns .pl3}
[{{< fa cube >}} model stage change&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;](#stage-change){.button-small}
<br>
[{{< fa wifi >}} workflow state change](#state-change){.button-small}
<br>
[{{< fa arrow-pointer >}} user action v2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;](#user-action){.button-small}
<br>
[{{< fa users >}} approval&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;](#approval){.button-small}

:::

::: {.w-70-ns}
[{{< fa maximize >}} Condition Branch](#condition-branch){.button-small}
<br>
[{{< fa clock >}} wait&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;](#wait){.button-small}
<br>
[{{< fa arrow-right-arrow-left >}} run workflow&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;](#run-workflow){.button-small}
<br>
[{{< fa circle-stop >}} end&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;](#end){.button-small}
...
- Requires available model stages associated with the workflow.[^3]
