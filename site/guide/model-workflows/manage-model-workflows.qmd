...
[^2]: [Configure model workflows](configure-model-workflows.qmd)
...
[^6]: [Abort workflows](#abort-workflows)

[^7]: [Initiate model workflows](#initiate-model-workflows)

[^8]:

    ::: {.callout title="Workflows can be set to run automatically on specific triggers."}
    Refer to [Configure model workflows](configure-model-workflows.qmd) for more details.
    :::
