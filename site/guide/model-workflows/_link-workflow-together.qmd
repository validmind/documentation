...
To initiate the beginning of your workflow:^[After you’ve configured your workflow steps, you can then link your workflow together.]
...
1. When you are finished linking your configured steps together, designate an **{{< fa circle-stop >}} End** step.^[[End the workflow](#end-the-workflow)]
...
1. When you are finished linking your configured steps together, designate an **{{< fa circle-stop >}} End**  step.
