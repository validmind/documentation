...
![Example {{< fa bullhorn >}} Broadcast email notification](example_broadcast-notif.png){fig-alt="A screenshot showing an example Broadcast email notification" .screenshot group="broadcast"}
