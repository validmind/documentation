...
- In this workflow, the model stage remains as [In Initial Validation]{.smallcaps} throughout, while the state of the workflow transitions to reflect the status of validation.
...
- Depending on whether or not the model is a GenAI model the validation report is also submitted for additional review to the organization's legal team.
