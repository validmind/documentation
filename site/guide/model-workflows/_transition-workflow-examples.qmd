...
While your model stages^[[Manage model stages](/guide/model-workflows/manage-model-stages.qmd)] and workflows states^[[Setting up model workflows](/guide/model-workflows/setting-up-model-workflows.qmd#workflow-states)] are custom to your organization, some examples are:
