...
- [ ] You are a `Customer Admin` or assigned another role with sufficient permissions to perform the tasks in this guide.[^4] 
...
4.  If an action is available to your role, you'll see it listed under your document status on the model's landing page.
