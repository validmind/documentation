...
::: {.callout}
Refer to [Available step types](/guide/model-workflows/setting-up-model-workflows.qmd#workflow-step-types) for information on available step types and details on how to set up conditional requirements.
:::
