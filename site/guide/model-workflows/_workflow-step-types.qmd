...
| [request fields]{.smallcaps} (optional) | Include required inventory fields alongside your action.[^longnote1]  |
...
- Must be connected to both a rejection and approval {{< fa cube >}} Model Stage Change step.[^longnote2]
...
[^longnote2]: **[Configure model workflows](/guide/model-workflows/configure-model-workflows.qmd#create-custom-workflows):**<br><br>
