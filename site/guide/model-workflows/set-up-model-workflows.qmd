...
- [x] {{< var link.login >}}
- [x] Resource statuses must be fully configured.[^1]
...
4. Select the process you'd like to add or edit the steps for:
...
![](user-action-custom-field.png){fig-alt="A screenshot showing the action transition panel with the Date On Hold inventory field"}
...
![](approval-group-setup.png){fig-alt="A screenshot showing an Approval Group step configuration with a inventory field selection of Approval Users"} 
...
[^1]: [Customize resource statuses](customize-resource-statuses.qmd)
...
[^7]: [Manage model inventory fields](manage-model-inventory-fields.qmd)

[^8]: [Manage roles](/guide/configuration/manage-roles.qmd)

[^9]: [Manage model inventory fields](manage-model-inventory-fields.qmd)
