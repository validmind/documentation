...
^7^ [Manage inventory custom fields](../model-inventory/manage-inventory-custom-fields.qmd)
:::
...
^8^ [Manage inventory custom fields](../model-inventory/manage-inventory-custom-fields.qmd)
...
- [Register models in the inventory](../model-inventory/register-models-in-model-inventory.qmd)
- [Working with model documentation](../model-documentation/working-with-model-documentation.qmd)
