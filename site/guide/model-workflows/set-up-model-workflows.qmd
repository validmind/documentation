...
::: {.w-50-ns}
![APPROVAL GROUP step configuration with an inventory field selection of Approval Users](configure-approval-step.png){fig-alt="A screenshot showing an APPROVAL GROUP step configuration with a inventory field selection of Approval Users" .screenshot group="approval"}

:::

::: {.w-40-ns}
![Setup for the approval message shown to the Validator role APPROVAL GROUP](approval-group-setup.png){fig-alt="A screenshot showing the setup for the approval message shown to the Validator role APPROVAL GROUP" .screenshot group="approval"}
