...
- [x] You are a [{{< fa hand >}} Customer Admin]{.role} or assigned another role with sufficient permissions to perform the tasks in this guide.[^2] 
...
2. Then, drag two **Status Change** steps onto the canvas:[^29]
