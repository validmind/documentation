...
1. Enter an optional prompt to guide the output, then click **Generate Content** to compose a draft for review.
   ...
   You can also include model attachments^[[Edit model inventory fields](/guide/model-inventory/edit-model-inventory-fields.qmd#manage-supporting-documentation)] as context documents:
...
1. Enter an optional prompt to guide the output, then click **Generate Content** to compose a draft for review.
   ...
   You can also include [model attachments](/guide/model-inventory/edit-model-inventory-fields.qmd#manage-supporting-documentation){target="_blank"} as context documents:
