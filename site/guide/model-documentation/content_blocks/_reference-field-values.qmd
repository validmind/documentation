...
- The associated model's inventory fields^[[Edit model inventory fields](/guide/inventory/edit-model-inventory-fields.qmd)]
...
b. Select the **Model {{< fa arrow-right >}}** variable you want to reference from the drop-down menu.^[Model inventory field values: [Edit model inventory fields](/guide/inventory/edit-model-inventory-fields.qmd)]
