...
1. Select the **Model {{< fa arrow-right >}}** variable you want to reference from the drop-down menu.^[Model inventory field values: [Edit model inventory fields](/guide/model-inventory/edit-model-inventory-fields.qmd)]
