...
- Model documentation has submitted for review or validation by the model validation team.[^2]

- To use real-time collaboration features, you must have the following permissions:[^3] 
   ...
   - **Validation reports** — Permission to read and update validation reports, as well as add and remove report blocks. By default, the `Validator` role has all these permissions.

   By default, both `Developer` and `Validator` roles have permission to add comments to model documentation and validation reports.
