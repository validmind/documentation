...
1. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and [select a Document type file](/guide/templates/working-with-model-documents.qmd){target="_blank"}.
