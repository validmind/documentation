...
date: last-modified
aliases:
  - ../assign-documentation-section-statuses.html
---
...
- [x] You are a [{{< fa code >}} Developer]{.role} or assigned another role with sufficient permissions to perform the tasks in this guide.[^2]
