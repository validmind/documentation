...
- To assign section statuses, you must have permission to read resource statuses as well as read and update model documentation. By default, the `Developer` role has all these permissions.[^2]
