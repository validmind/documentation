...
3. Click **Duplicate Block** to save the copy of your text block.

## Edit text blocks

To modify an existing text block:
...
To remove an existing text block:
