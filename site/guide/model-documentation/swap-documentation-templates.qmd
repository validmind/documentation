...
date: last-modified
aliases:
  - ../swap-documentation-templates.html
---
...
- [x] {{< var link.login >}}
- [x] You are a [{{< fa code >}} Developer]{.role} or [{{< fa circle-check >}} Validator]{.role}, or assigned another role with sufficient permissions to perform the tasks in this guide.[^1]
...
![Swapping a documentation template version](swap-template-version.gif){fig-alt="A gif showcasing swapping a documentation template version" class="screenshot"}
