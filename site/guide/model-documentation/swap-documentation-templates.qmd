...
Swap between different versions of your model documentation or validation report templates within the {{< var validmind_platform >}}. Switch to a completely different template, or apply another version of your current template.
...
You must hold the following roles to update templates for:[^1]

- **Model documentation** — `Developer` 
