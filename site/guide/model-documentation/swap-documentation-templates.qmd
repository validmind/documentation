...
4. On your Document Overview or Validation Report Overview page, locate: 
   ...
   - **[document template]{.smallcaps}** — Lists the template used for model documentation.
   - **[validation report template]{.smallcaps}** — Lists the template used for validation reports.
...
4. On your Document Overview or Validation Report Overview page click on the name and the version of the template under:
   ...
   - Document Overview — **[document template]{.smallcaps}**
   - Validation Report — **[validation report template]{.smallcaps}**
