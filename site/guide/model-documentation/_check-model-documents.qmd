...
a. Select a model or find your model by applying a filter or searching for it.^[[Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models)]
