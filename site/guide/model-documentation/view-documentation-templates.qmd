...
View the structure and configuration of existing documentation templates within {{< var vm.platform >}}. ValidMind provides default templates for documentation, validation reports, and ongoing monitoring.  
