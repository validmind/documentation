...
- You have provided some content for the documentation, either by uploading it through the {{< var validmind.developer >}}[^2] or via the online UI editor.

- To work with model documentation, you must have the following permissions:[^3]

    - Read and update model documentation
    - Add and remove blocks on model documentation
    - Add comments to model documentation
    - Swap documentation templates

  By default, the `Developer` role has all these permissions.
