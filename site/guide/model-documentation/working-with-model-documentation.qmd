...
After you upload initial model documentation through the {{< var developer >}}, use the {{< var vm.platform >}} to make qualitative edits to model documentation, view guidelines, collaborate with validators, and submit your model documentation for approval. 
...
- You have provided some content for the documentation, either by uploading it through the {{< var validmind.developer >}}[^3] or via the online UI editor.
