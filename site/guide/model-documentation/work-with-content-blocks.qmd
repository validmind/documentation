...
- [x] You are a [{{< fa code >}} Developer]{.role} or [{{< fa circle-check >}} Validator]{.role}, or assigned another role with sufficient permissions to perform the tasks in this guide.[^4]
