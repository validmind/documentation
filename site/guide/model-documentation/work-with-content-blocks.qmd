...
7. After adding the block to your document, click on the text to make changes or add comments.[^8]
...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Document type file.[^12]
...
[^12]: [Working with model documents](/guide/templates/working-with-model-documents.qmd)
