...
6. Click {{< fa square-plus >}} and then select one of the available options:
   ...
   b. [from library]{.smallcaps}:
      - **Text Block** — Inserts a text block from a template in your block library.[^6] Select the reusable blocks you want to add, then click **Insert # Text Block(s) to Document**.
      - **Test-Driven**[^7] — Adds a new section with logged test results.
      - **Metric Over Time**[^8] — Adds a new section with logged metric over time results. 
