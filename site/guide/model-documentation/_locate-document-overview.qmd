...
1. Select a model or [find your model by applying a filter or searching for it](/guide/inventory/working-with-the-inventory.qmd#search-filter-and-sort-models){target="blank"}.
