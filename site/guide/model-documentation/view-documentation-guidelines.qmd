...
^4^ [{{< var vm_framework >}}](/developer-framework/get-started-developer-framework.qmd)
:::
...
- [Get started with the {{< var vm_framework >}}](/developer-framework/get-started-developer-framework.qmd)
