...
- Model documentation is completed or in progress.[^2]

- You have permission to export model documentation. By default, the `Developer` or `Validator` roles have this permission.[^3]
...
4. In right sidebar, click **Export Document**.
...
6. Click **Download file** to download the file locally on your machine.
