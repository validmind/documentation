...
2. Select **{{< fa gear >}} Configure** and toggle the following options on or off as desired:[^4]
...
3. In the left sidebar that appears for your model, under {{< fa file >}} Documents and select **Documentation**, **Validation Report**, or **Ongoing Monitoring**.[^6]
