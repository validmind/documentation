...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation, Validation Report, or Ongoing Monitoring type file.[^4]
...
6. Click {{< fa square-plus >}} and then select **Test-Driven**[^5] under [from library]{.smallcaps}.
...
9. After inserting the results into your document, click on the text to make changes or add comments,[^6] or configure what is displayed on the test result.[^7]
...
2. Select **{{< fa gear >}} Configure** and toggle the following options on or off as desired:[^8]
...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation, Validation Report, or Ongoing Monitoring type file.[^10]
...
[^7]: [Configure test result displays](#configure-test-result-displays)
