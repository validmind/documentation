...
3. In the left sidebar that appears for your model, under {{< fa file >}} Documents select **Documentation**, **Validation Report**, or **Ongoing Monitoring**.[^5]
...
3. In the left sidebar that appears for your model, under {{< fa file >}} Documents and select **Documentation**, **Validation Report**, or **Ongoing Monitoring**.[^11]
