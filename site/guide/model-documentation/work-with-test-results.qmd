...
- [x] {{< var link.login >}}
- [x] The model you want to attach test results to is registered in the model inventory.[^1]
- [x] Test results have already been documented via the {{< var validmind.developer >}} for your model.[^2]
...
<!-- CAN'T ADD TEST RESULTS TO ANYTHING BUT MODEL DOCUMENTATION, VALIDATION REPORTS, OR ONGOING MONITORING REPORTS CURRENTLY -->
...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation, Validation Report, or Ongoing Monitoring type file.[^5]
...
6. Click {{< fa square-plus >}} and then select **Test-Driven**[^6] under [from library]{.smallcaps}.
...
8. Click **Insert # Test Results to Document** when you are ready.

9. After inserting the results into your document, click on the text to make changes or add comments,[^7] or configure what is displayed on the test result.[^8]
...
2. Select **{{< fa gear >}} Configure** and toggle the following options on or off as desired:[^9]
...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation, Validation Report, or Ongoing Monitoring type file.[^11]
...
[^8]: [Configure test result displays](#configure-test-result-displays)
