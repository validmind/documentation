...
1. If an action is available to your role, you'll see it listed under your document status under your **Documentation** or **Validation Report**. 

   Initiate the transition from the current state to the next workflow state.
