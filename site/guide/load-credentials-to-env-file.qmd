...
2. Locate the project identifier credentials for your documentation project. These credentials can be found on the **Client Integration** page. Copy the values from this page and paste them into your .env file in the following format:
...
3. Insert this code snippet above where you have just insterted your project identifier credentials:
