...
2. Locate the project identifier credentials for your documentation project. This can be found on the **Getting Started** page. Copy the values from this page and paste them into your .env file in the following format:
