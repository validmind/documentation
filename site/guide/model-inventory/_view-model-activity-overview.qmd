 The **{{< fa tower-broadcast >}} Model Activity** page shows a record of all activities, including actions performed by users in your organization and updates generated via the {{< var vm.developer >}} such as:
