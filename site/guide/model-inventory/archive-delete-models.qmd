...
2. Click **Save** to proceed with archival.
    ...
    - Once a model has been archived, you can then proceed with deleting the model or making it active again [^5]

Note: by default, only Admin users can see and deleted archived models in the inventory. This is a user permission configuration that can be changed. 
