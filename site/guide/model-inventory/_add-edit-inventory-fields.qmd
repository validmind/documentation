...
a. Inventory fields require you to enter a **[title]{.smallcaps}** (name) and a select a **[type]{.smallcaps}**.^[[Inventory field types](/guide/model-inventory/manage-model-inventory-fields.qmd#inventory-field-types)]
