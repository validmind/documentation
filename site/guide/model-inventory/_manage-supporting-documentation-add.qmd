...
![Adding attachment notes](/guide/model-inventory/add-attachment-note.gif){width=80% fig-alt="An animated gif demonstrating how to add attachment notes" .screenshot}