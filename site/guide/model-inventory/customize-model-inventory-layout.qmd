...
2. Click **{{< fa table >}} Manage Columns** to manage column visibility and order. To use this feature, make sure you're in table view.[^2]
   ...
   ![Manage Columns in the model inventory](manage-columns-demo.gif){width=80% fig-alt="An animation that shows how to manage columns in the model inventory" .screenshot}
