...
- [x] You are the model owner for the model you would like edit the details of, a [{{< fa hand >}} Customer Admin]{.role}, or assigned another role with sufficient permissions to perform the tasks in this guide.[^2]
