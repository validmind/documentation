...
To rename the field key for custom inventory fields:

1. Hover over the **[actions]{.smallcaps}** column on the far-right for the field whose key you want to rename.

2. When the **{{< fa ellipsis-vertical >}}** appears, click on it and select **{{< fa pen-to-square >}} Rename Key**.

3. Enter in the [new key]{.smallcaps} and click **Check Availability**.
