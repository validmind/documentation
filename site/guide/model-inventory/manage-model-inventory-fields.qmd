...
Calculation
: Define a `formula(params)` function that automatically returns value using the params dictionary, which includes selected custom field keys retrieved from your other inventory model fields.
