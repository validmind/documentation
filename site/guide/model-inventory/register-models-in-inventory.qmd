...
| What type of model is it? | Whether the model is a new model, or an existing model. If it is a new model, **Template**[^3] selection is required. |
| Business Unit | Business unit associated with the model. |
| Use Case | The model's use case. |
| Is it a vendor model? (optional) | If the model is a vendor model, toggle **Is Vendor Model**[^4] and provide the vendor name. |
