...
1. First enter the basic model information, then click **Next {{< fa chevron-right >}}**.
...
[^1]: [Manage stakeholder types on models](/guide/configuration/manage-model-stakeholder-types.qmd#manage-stakeholder-types-on-models)
