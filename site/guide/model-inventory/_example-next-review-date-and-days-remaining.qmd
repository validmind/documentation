...
You can use date and time field types for scheduling and countdowns to calculate the next review date and the days remaining until the next review.

Common date and time field types available in formulas:
