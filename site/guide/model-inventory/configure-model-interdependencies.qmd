...
![Upstream Model linked to the downstream Current Model](upstream-model.png){fig-alt="A screenshot showing the Upstream Model linked to the downstream Current Model" .screenshot}

:::

::: {.w-40-ns}

![Downstream Model linked to the upstream Current Model](downstream-model.png){fig-alt="A screenshot showing the Downstream Model linked to the upstream Current Model" .screenshot}
