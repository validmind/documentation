...
These steps show you how you can create a new project in the ValidMind platforms. You can use this new project to upload tests and documentation to the ValidMind platform, review and validate models, and generate validation reports. 
