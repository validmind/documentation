...
2. Under Workspace, select **Attestations** and then click an attestation to configure.
...
2. Under Workspace, select **Attestations** and then click the attestation you want to configure.
