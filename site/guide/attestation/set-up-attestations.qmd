...
3. Under **Scheduling**, click **{{< fa ellipsis-vertical >}}** and select **Execute Schedule**.
...
3. Under **Scheduling**, click **{{< fa ellipsis-vertical >}}** and select **{{< fa pencil >}} Edit**.

4. Make changes to one of the following:
...
2. Under **Scheduling**, click **{{< fa ellipsis-vertical >}}** and select [**{{< fa trash >}} Remove**]{.red}.
