...
- **Submitter** — Must be a model stakeholder (assigned directly to a model)
- **Reviewer/Approver** — Can be a model stakeholder (bottoms-up management) or a role (top-down management)

___

When reviewers or approvers are assigned by role, they can only act on models within groups they belong to — resulting in one attestation submission per model owner per group.
:::
...
b. Select the **[reviewer]{.smallcaps}** from the model stakeholders or roles dropdown.

c. Select the **[approver]{.smallcaps}** from the model stakeholders or roles dropdown.
...
a. Select the **[reviewer]{.smallcaps}** from the model stakeholders or roles dropdown.

a. Select the **[approver]{.smallcaps}** from the model stakeholders or roles dropdown.
