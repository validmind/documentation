...
b. Configure the field:
   ...
   ![Add Field dialog](/guide/attestation/attestations-add-field.png){width=80% fig-alt="Add Field dialog showing field type, label, description, help text, and required field options." .screenshot}
