...
- [x] You are assigned a role with sufficient permissions to perform attestation tasks:[^3]
   ...
   - [Submitter]{.bubble} — Completes attestation questionnaires
   - [Reviewer]{.bubble} — Reviews attestation questionnaires
   - [Approver]{.bubble} — Signs off on attestation questionnaires
...
Attestation participants see a banner on their dashboard when an attestation requires action. The banner links directly to their active attestation tasks, also known as _attestation instances_:
