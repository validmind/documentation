...
The process tracks progress from questionnaire assignment to final sign-off. Responsibilities are shared — the model owner completes the questionnaire and the validator reviews, requests changes if needed, and signs off:
...
**Model owners** are responsible for moving the questionnaire through these states:

- **Not Started** — When attestation is first assigned to the model owner
- **In Progress** — While the model owner completes the questionnaire or addresses change requests
- **Ready for Review** — When the model owner has submitted the completed questionnaire

**Validators** are responsible for moving the questionnaire through these states:

- **Reviewed** — When a validator has reviewed the questionnaire
