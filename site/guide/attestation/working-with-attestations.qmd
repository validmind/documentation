...
listing:
  - id: attestation-listing
    ...
    contents:
      ...
      - submit-attestation-questionnaires.qmd
      - review-attestation-questionnaires.qmd
      - approve-attestation-questionnaires.qmd
---
...
- [x] You are assigned a role with sufficient permissions to perform attestation tasks:[^3]
   ...
   - [Submitter]{.bubble} — Submits attestation questionnaires
   - [Reviewer]{.bubble} — Reviews attestation questionnaires
   - [Approver]{.bubble} — Approves attestation questionnaires
...
A reviewer can request changes from the submitter by rejecting the attestation questionnaire. 
...
:::: {.column width="30%" .pr1}
Submitter  
: Completes the attestation questionnaire and addresses any requested changes.
::::

:::: {.column width="30%" .pl2 .pr2}
Reviewer  
: Reviews the questionnaire and may request further changes if needed.
::::

:::: {.column width="30%" .pl3}
Approver  
: Signs off to finalize and complete the attestation process.
::::
:::
