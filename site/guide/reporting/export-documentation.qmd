...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Monitoring type file.^

4. In right sidebar, click **{{< fa download >}} Export Document**.

    Configure whether or not comments[^11] left on your document should be exported in your document.
...
[^11]: [Collaborate with others](/guide/model-documentation/collaborate-with-others.qmd#commenting)
