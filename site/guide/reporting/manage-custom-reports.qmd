...
::: {.w-50-ns}
![Example setup for a stacked bar chart](custom-visualization-setup.png){fig-alt="Screenshot of an example setup for a stacked bar chart" .screenshot}

:::

::: {.w-40-ns}
![Example y-axis on a custom bar chart](example-custom-visualization.png){fig-alt="Screenshot of an example y-axis on a custom bar chart" .screenshot}
