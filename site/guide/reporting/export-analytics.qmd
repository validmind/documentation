...
- [x] {{< var link.login >}}
- [x] To export data on records (models), there must be records registered in the inventory.[^1]
- [x] To export data on artifacts (findings), there must be artifacts logged on any record.[^2]
