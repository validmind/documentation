...
a. Select a **[dataset]{.smallcaps}**:
    ...
    - **Artifact - Model Limitations** — Logged Model Limitation type artifacts only.^[[Working with artifacts](/guide/validation/working-with-artifacts.qmd)]
...
a. Select a **[dataset]{.smallcaps}**:
    ...
    - **Artifact - Model Limitations** — Logged Model Limitation type [artifacts](/guide/validation/working-with-artifacts.qmd){target="_blank"}. only.
