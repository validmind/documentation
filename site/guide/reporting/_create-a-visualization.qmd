...
a. Select a **[dataset]{.smallcaps}**:
    ...
    - **Findings** — All finding types.^[[Working with model findings](/guide/model-validation/working-with-model-findings.qmd)]
    ...
    - Model Limitations — Model Limitation type findings only.^[[Manage finding types](/guide/model-validation/manage-finding-types.qmd)]
    - Policy Exceptions — Policy Exception type findings only.
    - Validation Issues — Validation Issue type findings only.
...
a. Select a **[dataset]{.smallcaps}**:
    ...
    - **Findings** — [All finding types](/guide/model-validation/working-with-model-findings.qmd){target="_blank"}.
    - **Inventory Models** — [Models logged in your inventory](/guide/model-inventory/working-with-model-inventory.qmd){target="_blank"}.
    - Model Limitations — Model Limitation type findings only.
    - Policy Exceptions — Policy Exception type findings only.
    - Validation Issues — Validation Issue type findings only.
