...
You can also add any of the report widgets to your personal dashboard.[^5]

:::

Rearrange report widgets on your custom analytics pages:[^6]
...
[^5]: [Customize your dashboard](/guide/configuration/customize-your-dashboard.qmd#manage-widgets)

[^6]: [Manage custom reports](manage-custom-reports.qmd#add-custom-analytics) 
