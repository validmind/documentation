...
![Analytics `Models` report page](analytics-models.png){fig-alt="Screenshot of the Analytics `Models` report page" .screenshot}
...
![Analytics `Findings` report page](analytics-findings.png){fig-alt="Screenshot of the Analytics `Findings` report page" .screenshot}
...
2. Click on the tab for the reports page you'd like to rearrange.

3. Hover over the title of a widget until the **{{< fa hand>}}** appears.

4. Click and drag to position your widget as desired.
...
<!-- [^3]: [Customize your dashboard](/guide/configuration/customize-your-dashboard.qmd) -->