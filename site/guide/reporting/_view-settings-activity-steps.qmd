...
2. Select the **Settings Activity** tab.
   ...
   2. Select the **Event Type**s you want to filter by from the drop-down menu:
      ...
      - **Documents** to view activity related to creation of, updates to, and deletions of document types,^[[Manage document types](/guide/templates/manage-document-types.qmd)] templates,^[[Manage document templates](/guide/templates/manage-document-template-library.qmd)] and library blocks.^[[Manage text block library](/guide/templates/manage-text-block-library.qmd)]
