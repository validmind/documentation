...
2. Select the **Settings Activity** tab:
   ...
   When enough activity categories are displayed, click {{< fa chevron-left >}} or {{< fa chevron-right >}} to scroll through left or right respectively through the list.
...
2. Select the **Settings Activity** tab:
 ...
 - Narrow down settings activity by clicking on the tab for the category you want to view activity for. When enough categories are displayed, click {{< fa chevron-left >}} or {{< fa chevron-right >}} to scroll through left or right respectively through the list.
