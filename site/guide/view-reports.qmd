...
Reports provide a high-level overview of model validation activities, focusing on critical findings and risk exposure.  
...
- Model validators or developers who need to see  role or be a risk officer who needs to get a quick overview for findings related to model validation, including the severity of these findings.

## Steps

1. [Log in to the ValidMind UI]({{< var vm_ui >}}).

2. In the left sidebar, click **[Reports](https://app.prod.validmind.ai/reports)**.
