...
- **Limited live query scope** — When querying your organization's data, the assistant can currently access inventory records and artifacts only. Questions about workflows, analytics, or other platform areas are not yet supported.
