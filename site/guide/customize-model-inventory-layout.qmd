...
3. Click **{{< fa table >}} Manage Columns** to manage column visibility and order. You can toggle visibility for each category and drag each option to change the order. To use this feature, make sure you're in table view.
...
To display the inventory in table view, click **{{< fa table >}} Display table**. To display the inventory in card view, click **Display cards**.
:::
