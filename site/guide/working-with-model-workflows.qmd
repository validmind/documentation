...
::: {.column-margin}
^5^ [Working with the model inventory](working-with-model-inventory.qmd#search-filter-and-sort-models)
:::
...
::: {.column-margin}
^6^ [Working with the model inventory](working-with-model-inventory.qmd#search-filter-and-sort-models)
:::
...
::: {.column-margin}
^7^ [Working with the model inventory](working-with-model-inventory.qmd#search-filter-and-sort-models)
:::
...
::: {.column-margin}
^8^ [Working with the model inventory](working-with-model-inventory.qmd#search-filter-and-sort-models)
:::
