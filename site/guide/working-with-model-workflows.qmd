...
- The model is registered in the model inventory
- You've already customized your resource statuses for use in workflows
- Workflows have already been set up for use with your models
...
- [Working with model workflows](set-up-model-workflows.qmd)
