...
![](see-workflow.gif){fig-alt="See workflow under the Model Status section."}
...
![](transition-workflow.gif){fig-alt="Transitioning a workflow status under the Actions section."}
