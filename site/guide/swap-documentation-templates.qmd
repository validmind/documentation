...
Easily swap between different versions of your model documentation or validation report templates within the {{< var vm_platform >}}. Switch to a completely different template, or apply another version of your current template.
