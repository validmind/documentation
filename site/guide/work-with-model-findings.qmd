...
3. On the page that opens, click on the finding you want to update or [apply a filter](../guide/work-with-model-findings.qmd#filter-project-findings) to locate the correct finding first.
