...
5. On the **Add Project Finding** page that opens,  provide information for: 
...
2. On the page that opens, click on the finding you want to update or [apply a filter](work-with-model-findings.qmd#filter-project-findings) to locate the correct finding first.
