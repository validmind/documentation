...
- A model document project is completed or in progress^3^
...
^2^ [Register models in the inventory](model-inventory/register-models-in-model-inventory.qmd)

^3^ [Working with model documentation](model-documentation/working-with-model-documentation.qmd)
:::
...
2. In the left sidebar, click **Model Findings**.
...
2. In the left sidebar, click **Model Findings** and then click {{< fa filter >}} **Filter**.
...
::: {.column-margin}
^4^Learn how to [work with the model inventory](model-inventory/working-with-model-inventory.qmd).
:::
...
1. On the **Add Model Finding** page that opens, provide information for: 
...
3. On the page that opens, click on the finding you want to update or apply a filter to locate the correct finding first^5^.
