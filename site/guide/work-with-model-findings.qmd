...
::: {.column-margin}
Learn how to [work with the model inventory](working-with-model-inventory.qmd).
:::
...
3. On the page that opens, click on the finding you want to update or apply a filter to locate the correct finding first.
...
::: {.column-margin}
Learn how to [filter project findings](#filter-project-findings).
:::
