...
4. In the left sidebar that appears for your model, click **Documentation**. 
   ...
   - You can now either log a finding on this overview page, or via a specific documentation section. 
   - Both methods will allow you to associate a finding with a documentation section if desired.
