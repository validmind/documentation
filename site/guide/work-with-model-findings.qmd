...
3. On the **Add Model Finding** page that opens,  provide information for: 
   ...
   At a minimum, you must provide the required information indicated by `*`. **Documentation section will auto-populated with the section you are working from** — you are able to select another section if desired.
