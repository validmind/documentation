...
1. Once you click **{{< fa plus >}} Add Stakeholder Type**, you can:
    ...
    - Configure stakeholder types available upon mode registration^[[Configure stakeholder types on registration](/guide/configuration/manage-model-stakeholder-types.qmd#configure-stakeholder-types-on-registration)]
...
1. Once you click **{{< fa plus >}} Add Stakeholder Type**, you can:
    ...
    - Configure stakeholder types available upon mode registration
