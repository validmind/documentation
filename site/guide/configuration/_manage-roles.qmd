...
1. Enter the unique **[name]{.smallcaps}** and **[description]{.smallcaps}** for the role.^[**Note:** Role names and stakeholder type names cannot be duplicated to reduce confusion.<br><br>[Manage model stakeholder types](manage-model-stakeholder-types.qmd)]
