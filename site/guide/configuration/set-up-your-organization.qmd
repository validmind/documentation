...
- To set up your organization, you must have the following permissions:[^1] 

    - **Business units** — Permission to read, add, update, and delete business units. 
    - **Risk areas** — Permission to read, add, update, and delete risk areas.
    - **Use cases** — Permission to read, add, update, and delete use cases.
