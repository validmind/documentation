...
2. Under {{< fa cube >}} Inventory, select **Model Inventory Fields**.
...
[^2]: To edit the display behavior of this field on models and model registration, refer to: [Manage inventory fields](/guide/inventory/manage-inventory-fields.qmd#add-or-edit-inventory-fields)
