...
a. Hover over the business unit you want to edit.

b. When the **{{< fa ellipsis-vertical >}}** appears, click on it to rename or delete the unit:
...
a. Hover over the use case you want to edit.
