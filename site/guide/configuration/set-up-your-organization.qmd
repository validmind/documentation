...
1. Hover over the business unit you want to edit.

2. When the **{{< fa ellipsis-vertical >}}** appears, click on it to rename or delete the unit:
...
1. Hover over the use case you want to edit.

2. When the **{{< fa ellipsis-vertical >}}** appears, click on it.

3. If you are sure you want to remove the use case, click **{{< fa trash-can >}} Delete Use Case** to delete it.
