...
| ------------ | ------------------------------------ | ---------------------------- |
| `us-west-2`  | Email <{{< var vm.support >}}>        | Email <{{< var vm.support >}}> |
...
2. Contact {{< var vm.product >}} at [{{< var vm.support >}}](mailto:{{< var vm.support >}}?subject=VNet%20Endpoint%20Connection%20Request) to get your new private endpoint connection request accepted. Include the following information:
