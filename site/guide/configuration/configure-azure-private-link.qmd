...
1. Create an Azure Private Endpoint:
   ...
   c. Select the resource to connect: In the **Resource** tab, choose the **resource type**, the specific **resource**, and the **sub-resource**.
   d. Configure the networking: Choose the **virtual network** (VNet) and **subnet** for the private endpoint. Ensure the selected subnet complies with your security policies.
   e. Configure DNS: When prompted, integrate with an Azure **Private DNS zone** to simplify private IP name resolution.
