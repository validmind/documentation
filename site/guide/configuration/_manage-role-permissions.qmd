...
1. Select a permission type to manage:
      ...
      - **Field Permissions** — Read and update (write) permissions for model inventory fields^[[Manage inventory fields](/guide/inventory/manage-inventory-fields.qmd)] and artifact fields.^[[Manage artifact fields](/guide/model-validation/manage-artifact-fields.qmd)]
...
a. Select a permission type to manage:
      ...
      - **Field Permissions** — Read and update (write) permissions for [inventory fields](/guide/inventory/manage-inventory-fields.qmd){target="_blank"} and [artifact fields](/guide/model-validation/manage-artifact-fields.qmd){target="_blank"}.
