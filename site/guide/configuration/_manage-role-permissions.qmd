...
1. Select a permission type to manage:
      ...
      - **Field Permissions** — Read and update (write) permissions for model inventory fields^[[Manage inventory fields](/guide/inventory/manage-inventory-fields.qmd)] and artifact fields.^[[Manage artifact fields](/guide/validation/manage-artifact-fields.qmd)]
