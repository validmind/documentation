...
1. Select a permission type to manage:
      ...
      - **Field Permissions** — Read and update (write) permissions for model inventory fields^[[Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd)] and artifact fields.^[[Manage artifact fields](/guide/model-validation/manage-artifact-fields.qmd)]
...
a. Select a permission type to manage:
      ...
      - **Field Permissions** — Read and update (write) permissions for [model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd){target="_blank"} and [artifact fields](/guide/model-validation/manage-artifact-fields.qmd){target="_blank"}.
