...
<!--- | us-west-2    | com.amazonaws.vpce.us-west-2.vpce-svc-0b956fa3e03afa538 | [{{< var vm_privatelink >}}]({{< var vm_privatelink >}}) | --->
...
5. Test the connection:
   ...
   c. From your developer environment, confirm that you can connect to ValidMind with the {{< var developer >}}.
