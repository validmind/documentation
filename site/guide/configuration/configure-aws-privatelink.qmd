...
2. Contact {{< var vm.product >}} at [{{< var vm.support >}}](mailto:{{< var vm.support >}}?subject=VPC%20Endpoint%20Connection%20Request) to get your new VPC endpoint connection request accepted. Include the following information:
