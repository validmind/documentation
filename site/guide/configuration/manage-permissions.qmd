...
Note that the [{{< fa hand >}} Customer Admin]{.bubble} role is a <sup>[{{< fa lock >}} Locked]{.bubble}</sup> role with the highest level of access and, as such, cannot be modified.[^3]

:::

{{< include _manage-permissions.qmd >}}

<!-- HIDING THE OUTLINED PERMISSIONS FOR NOW AS NIK IS AUTOMATING THE UPDATING THE PERMISSIONS TABLES IN ANOTHER STORY -->
