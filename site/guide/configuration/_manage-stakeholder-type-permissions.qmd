...
1. Select a permission type to manage:
   ...
   - **Models** — Read and update (write) permissions for model inventory fields^[[Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd)] and document types.^[[Manage document types](/guide/templates/manage-document-types.qmd)]
...
a. Select a permission type to manage:
   ...
   - **Models** — Read and update (write) permissions for [model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd){target="_blank"} and [document types](/guide/templates/manage-document-types.qmd){target="_blank"}.
