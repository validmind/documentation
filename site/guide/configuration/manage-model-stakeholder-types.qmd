...
5. Add at least one user to each of your desired custom stakeholder types to save the display settings for that model:
    ...
    b. Select a user from the drop-down menu.
...
[^2]:**Note:** Role names and stakeholder type names cannot be duplicated to reduce confusion. (Learn more: [Manage roles](manage-roles.qmd))
