...
- A valid email address registered with the {{< var validmind.platform >}} and your password.
...
After successful login, you are redirected to the main dashboard of the {{< var validmind.platform >}}.
