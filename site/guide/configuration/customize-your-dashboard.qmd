...
##### {{< fa border-all >}} Model Artifacts View
...
##### {{< fa flask >}} Other
Retrieve a list of the latest model artifacts[^5] or recent activity.[^6]
...
5. Select the type of widget you'd like to add:[^7]
    ...
    - **{{< fa cubes >}} Model Inventory View**
    - **{{< fa warning >}} Model Artifacts View**
    - **{{< fa square-poll-vertical >}} Visualization**
...
6. On the modal that appears, configure the information retrieved by the widget: 
    ...
    - **Model Artifacts View** — Select a **[view name]{.smallcaps}** then cick **Add Model Artifacts View**.
...
[^2]: [Manage custom inventory views](/guide/inventory/customize-model-inventory-layout.qmd#manage-custom-inventory-views)

[^3]: [Customize artifact layouts](/guide/model-validation/customize-artifact-layouts.qmd)

[^4]: [Working with analytics](/guide/reporting/working-with-analytics.qmd)

[^5]: [Working with artifacts](/guide/model-validation/working-with-artifacts.qmd)

[^6]: [View model activity](/guide/inventory/view-model-activity.qmd)
