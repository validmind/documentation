...
3. Hover over the title of a widget you'd like to remove until the **{{< fa ellipsis-vertical>}}**  appears, then click on it. 

4. After you select **{{< fa trash-can>}} Remove from Dashboard**, the widget will be removed from your personal view of the dashboard.
