...
Along with the default Model Findings and Recent Activity widgets, report widgets from Analytics[^1] can be added to your dashboard:
...
[^1]: [Working with analytics](/guide/model-validation/working-with-analytics.qmd)
