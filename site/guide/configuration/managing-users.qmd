...
Users
: Individuals interacting with the {{< var platform >}}, each having a unique account.

Roles
: Sets of permissions defining which actions users can perform on the {{< var platform >}}.
...
Developer
: Model developers are responsible for documenting and testing models. They may have access to development tools and resources that interact with the {{< var platform >}} and they can upload model documentation and test results through the {{< var developer >}}.
