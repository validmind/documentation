...
listing:
  - id: user-management
    ...
    contents:
      ...
      - ./manage-groups.qmd
      - ./manage-roles.qmd
      - ./manage-record-stakeholder-types.qmd
...
groups
: Collections of users managed at the organization or team level with similar roles or permissions, such as developers or validation teams in a specific business unit.
...
developer
: Developers are responsible for documenting and testing records. They may have access to development tools and resources that interact with the {{< var vm.platform >}} and they can upload documentation and test results through the {{< var vm.developer >}}.

validator
: Validators review, test and validate records and documentation. They may have limited access to modify content or configurations.
...
- [Manage platform notifications](/guide/configuration/manage-platform-notifications.qmd)