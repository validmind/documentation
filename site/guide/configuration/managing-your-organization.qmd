...
3. Under Document Defaults, toggle whether you would like to **Enable Track Changes by default**[^5] for all document blocks for your current active organization.
