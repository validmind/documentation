...
#### Onboarding
The {{< var vm_ui >}} provides an interactive onboarding journey right in the interface. You can toggle the onboarding wizard on or off at any time, as well as restart the onboarding tasks after you've completed them:
...
Under User Interface Preferences, you can switch between the dark and light modes of the {{< var vm_platform >}}.
...
- [Onboarding users](onboarding-users.qmd)