...
With an email address or a Google,[^1] GitHub,[^2] or Microsoft[^3] account, you can only gain access to {{< var vm.product >}} by:

1. [Accepting an invite](#accept-an-invite)
...
- [x] You have been invited by someone else in your organization to join {{< var vm.product >}}.
- [x] Additionally, an email address that is able to receive messages from {{< var vm.product >}}.[^4]

::: {.callout}
ValidMind access is invite-only. To use the platform, your organization must already have a ValidMind account, and you must be invited by someone with the Customer Admin role[^5].
:::
...
These steps require that you have been invited[^6] by a Customer Admin user to join your organization on {{< var vm.product >}}.
:::
...
[^6]: [User invitations](/guide/configuration/manage-users.qmd#user-invitations)
