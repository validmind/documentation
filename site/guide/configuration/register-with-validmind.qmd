...
![ValidMind organization invite email](organization-invitation-email.png){width=90% fig-alt="Screenshot of the Validmind organization invite email"}
...
![ValidMind accept invitation to join an organization screen](organization-accept-invitation.png){fig-alt="Screenshot of the ValidMind accept invitation to join an organization screen"}
