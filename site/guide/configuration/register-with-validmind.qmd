...
To access {{< var vm.product >}}, you must be invited by someone in your organization. Once you [receive an invitation](#accepting-an-invite), you can register using your email address or an existing Google,[^1] GitHub,[^2] or Microsoft[^3] account.
...
::: {.callout}
{{< var vm.product >}} access is invite-only. To use the platform, your organization must already have a {{< var vm.product >}} account, and you must be invited by someone with the Customer Admin role[^6].
:::
