...
![Verification email sent by {{< var vm.product >}}](verify-email.png){width=80% fig-alt="Screenshot of the verification email sent by ValidMind" .screenshot group="verify"}
...
::: {.column-margin}
![Confirmation of email verification](email-verified.png){fig-alt="Screenshot of the confirmation of email verification" .screenshot  group="verify"}
:::
...
::: {.w-40-ns}
![{{< var vm.product >}}'s main dashboard](main-dashboard.png){fig-alt="Screenshot of the main ValidMind dashboard" .screenshot group="validmind"}

:::
::: {.w-40-ns}
![Sample models populated by {{< var vm.product >}}](sample-models.png){fig-alt="Screenshot of the sample models populated by ValidMind" .screenshot group="validmind"}
