...
::: {.column-margin}
![ValidMind signup welcome screen](signup-welcome-screen.png){width=90% fig-alt="Screenshot of the Validmind signup welcome screen" .screenshot}
:::
...
![ValidMind profile completion screen](signup-complete-profile.png){width=80% fig-alt="Screenshot of the ValidMind profile completion screen" .screenshot}
...
![Verification email sent by ValidMind](verify-email.png){width=80% fig-alt="Screenshot of the verification email sent by ValidMind" .screenshot}
...
::: {.w-40-ns}
![ValidMind's main dashboard](main-dashboard.png){fig-alt="Screenshot of the main ValidMind dashboard" .screenshot}
:::
::: {.w-40-ns}
...
![ValidMind organization invite email](organization-invitation-email.png){width=80% fig-alt="Screenshot of the Validmind organization invite email" .screenshot}

3. On the page that opens up in your web browser, click **Accept Invitation**.

![ValidMind accept invitation to join an organization screen](organization-accept-invitation.png){width=80% fig-alt="Screenshot of the ValidMind accept invitation to join an organization screen" .screenshot}
