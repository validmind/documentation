...
::: {.callout}
To customize which platform notifications are sent to users in your organization, you must be a [{{< fa hand >}} Customer Admin]{.bubble} or assigned another role with sufficient permissions.[^5]
:::
...
3. Under Email Notifications, toggle the options for each event on or off.
