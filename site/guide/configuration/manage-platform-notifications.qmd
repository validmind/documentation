...
a. Click **{{< fa filter >}} Filter** to narrow down the kinds of updates displayed:
    ...
    - Select between a select number of different in-{{< var vm.platform >}} notifications with the drop-down menu.[^1]
...
: Invitations to join {{< var vm.product >}} organizations.[^5]

Test Threshold Breaches
: Logged metric threshold breaches on your models.[^6]
...
[^5]: [Manage users](/guide/configuration/manage-users.qmd#manage-user-invitations)

[^6]: [Set thresholds and alerts](/guide/monitoring/set-thresholds-and-alerts.qmd)