...
| -- | -- | --------------- | ------------------------------------------------------- | ---------------------------- |
| US3 | GCP | `us-west1`    | Email [{{< var support.email >}}](mailto:{{< var support.email >}}) | Email [{{< var support.email >}}](mailto:{{< var support.email >}}) |
...
Contact {{< var vm.product >}} at [{{< var support.email >}}](mailto:{{< var support.email >}}?subject=VPC%20Endpoint%20Connection%20Request) to get your new VPC endpoint connection request accepted. Include the following information:
