...
| -- | -- | --------------- | ------------------------------------------------------- | ---------------------------- |
| US3 | GCP | `us-west1`    | Email <{{< var validmind.support >}}> | Email <{{< var validmind.support >}}> |
...
Contact {{< var vm.product >}} at [{{< var validmind.support >}}](mailto:{{< var validmind.support >}}?subject=VPC%20Endpoint%20Connection%20Request) to get your new VPC endpoint connection request accepted. Include the following information:
