...
![Active `private` endpoint in the Google Cloud Console](gcp-add-validmind-endpoint.png)
...
![Active `auth` endpoint in the Google Cloud Console](gcp-add-auth-endpoint.png)
