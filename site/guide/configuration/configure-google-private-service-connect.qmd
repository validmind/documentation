...
| -- | -- | --------------- | ------------------------------------------------------- | ---------------------------- |
| US3 | GCP | `us-west1`    | Email <{{< var vm.support >}}> | Email <{{< var vm.support >}}> |
...
Contact {{< var vm.product >}} at [{{< var vm.support >}}](mailto:{{< var vm.support >}}?subject=VPC%20Endpoint%20Connection%20Request) to get your new VPC endpoint connection request accepted. Include the following information:
