...
![Creating an endpoint in the Google Cloud Console](gcp-add-validmind-endpoint-panel.png){fig-alt="Screenshot of an endpoint being created with the options specified in the steps" class="screenshot" width=90%}
...
![Active `private` endpoint in the Google Cloud Console](gcp-add-validmind-endpoint.png){fig-alt="Active endpoint being shown in the Google Cloud Console" class="screenshot" width=90%}
...
![Creating an endpoint in the Google Cloud Console](gcp-add-auth-endpoint-panel.png){fig-alt="Screenshot of an endpoint being created with the options specified in the steps" class="screenshot" width=90%} 
...
![Active `auth` endpoint in the Google Cloud Console](gcp-add-auth-endpoint.png){fig-alt="Active endpoint being shown in the Google Cloud Console" class="screenshot" width=90%}
