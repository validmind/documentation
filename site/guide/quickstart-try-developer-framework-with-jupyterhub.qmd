...
2. After the notebook opens, run the first few cells in the notebook:
   ...
   The notebook will guide you through installing the {{< var vm_framework >}}, initializing the Python environment, and finally initializing the ValidMind Client Library by connecting to the ValidMind Platform.
