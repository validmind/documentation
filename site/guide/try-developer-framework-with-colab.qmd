...
You must have [Colab Desktop](https://www.docker.com/products/docker-desktop/) installed on your machine. 

## Steps

1. From the command line, pull the latest ValidMind Colab image:

   ```bash
   docker pull validmind/validmind-jupyter-demo:latest
   ```

2. Run the ValidMind Colab image:
...
If you downloaded our Colab image instead of using Google Colaboratory, continue with the section [Explore the ValidMind Platform](explore-validmind.qmd#explore-the-validmind-platform) in the Quickstart.
