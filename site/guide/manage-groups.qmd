...
3. Click on the "Add New Group" button to initiate the group creation process.
...
4. Within the group details, you can:
   ...
   Note: Ensure that the group details align with your requirements for access control and group management.
