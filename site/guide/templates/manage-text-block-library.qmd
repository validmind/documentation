...
4. Click on the file you'd like to copy a text block from.[^3]
...
Once added, insert private or shared text blocks into your documents,[^4] or shared text blocks into document templates.[^5]
...
[^5]: [Customize document templates](/guide/templates/customize-document-templates.qmd#add-text-blocks-to-templates)
