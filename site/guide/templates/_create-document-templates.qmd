...
b. Upload a **.pdf** file (drag and drop or choose a file), then click **Upload PDF**.
   ...
   - Maximum size: **250 MB**. Documents of a few hundred pages are supported. Very large documents can take several minutes to process, and if processing cannot finish you are asked to split the file and try again.
