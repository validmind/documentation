...
- Deleting a template deletes all versions of that template.[^5]
...
4. Select the template you would like to delete by clicking on it.
   ...
   Review the details of the template to confirm the template is no longer required.[^10]
...
[^5]: [Customize document templates](customize-document-templates.qmd#edit-template-outlines)
