...
1. In outline editing mode, you can: 
   ...
   a. **Add content to sections:**
      ...
      - Click **{{< fa plus >}}** to add content to that section of the template, such as a **Summary Block** or a **Guideline Block**.^[[Add guidelines to templatesmanage](/guide/model-validation/manage-validation-guidelines.qmd#add-guidelines-to-templates)]
