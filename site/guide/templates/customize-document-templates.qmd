...
7. Add a description in **Version Notes** to track your changes.

8. Click **Save Version #** to save the new version.
...
Add shared text blocks from your library[^11] to your templates through both the template outline or the YAML editor.
...
[^1]: [Manage applied document templates](manage-applied-document-templates.qmd)
