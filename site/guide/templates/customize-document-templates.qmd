...
4. Click the template to edit and on the template details page, click **{{< fa ellipsis-vertical >}}** next to Edit Template then select **{{< fa pencil >}} Edit Raw**.

5. In the Edit Template YAML editor that opens, make your changes according to the template schema,[^8] including the addition of any shared text blocks from your library.[^9]
...
[^12]: [Edit templates via YAML](#edit-templates-via-yaml)
