...
## Configure assessment options[^4]

::: {.callout}
{{< include /guide/model-validation/_assessment-options.qmd >}}


[Configure assessment options](/guide/model-validation/configure-assessment-options.qmd){.button}
:::
...
5. In the Edit Template YAML editor that opens, make your changes according to the template schema,[^6] including the addition of any shared text blocks from your library.[^7]
...
[^4]: [validation report templates only]{.smallcaps .pink}

[^5]: [Working with model documents](/guide/templates/working-with-model-documents.qmd)

[^6]: [Template schema](#template-schema)

[^7]: [Add text blocks to templates](#add-text-blocks-to-templates)

[^8]: [Manage text block library](manage-text-block-library.qmd)

[^9]: [Edit YAML templates](#edit-yaml-templates)
