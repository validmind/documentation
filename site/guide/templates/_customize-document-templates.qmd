...
1. On the template details page, click  **{{< fa pencil >}} Edit Outline**.^[[Visual editor options](customize-document-templates.qmd#visual-editor-options)]
...
{{< include /guide/templates/_visual-editor-options.qmd >}}
...
1. On the template details page, click  **{{< fa pencil >}} Edit Outline**.^[[Visual editor options](manage-applied-document-templates.qmd#visual-editor)]
