...
1. Select one of the tabs for the type of template you want to edit:
   ...
   - **Development**^[[Working with model documentation](/guide/documentation/working-with-model-documentation.qmd)]
...
1. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select the **Latest** or **Saved Versions** tab.^[[Work with document versions](/guide/documentation/work-with-document-versions.qmd)]
