...
Editing outlines for document templates from **{{< fa gear >}} Settings** will create a new version of the template that can be applied to documents:
...
1. Click the template to edit and on the template details page, select **{{< fa pencil >}} Edit Template**.
