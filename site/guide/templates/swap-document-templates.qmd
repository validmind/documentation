...
Swap between different versions of your document templates within the {{< var validmind.platform >}}. Switch to a completely different template, or apply another version of your current template.
...
6. Click on the named version of the template, then select **{{< fa eye >}} View Template Details** to open the details for the template applied to that document.
