...
4. Click **{{< fa arrow-right-arrow-left >}} See workflow** to visualize the entire workflow that this model will go through.
...
4. Under **Actions** on the right, initiate the transition from the current state to the next workflow state.
