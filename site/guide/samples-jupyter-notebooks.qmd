...
Our code samples, based on Jupyter notebooks, showcase the capabilities and features of the {{< var vm_framework >}}, while also providing you with useful examples that you can build on and adapt for your own use cases. 

::: {.grid}
::: {.g-col-6}
 <form method="get" action="https://jupyterhub.validmind.ai/" target="_blank">
   <button type="submit" style="color: white; background-color: #de257e; border-radius: 8px; border: none; font-size: 16px; padding: 6.25px 12.5px; margin-left: 16px; margin-bottom: 20px;">{{< fa code >}} Try Notebooks on JupyterHub</button>
</form>
:::
