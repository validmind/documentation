...
#### Link Approval steps
[Approval](#approval) steps need to be subsequently linked to both a Rejected and an Approval Status Change step:

1. Configure an Approval step.

2. Drag two [Status Change](#status-change) steps onto the canvas:
