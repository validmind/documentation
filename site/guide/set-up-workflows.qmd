...
#### Status Change
- Transitions statuses based on conditional requirements. 
...
- Can be configured to display based on conditional requirements.

#### Approval
- When your resource reaches the approval step, users in the selected Approval Group will receive your configured message. 
- Requires an [available Approval Group](manage-groups.qmd) within your User Permission [**Groups**]({{< var vm_url >}}/settings/groups).
