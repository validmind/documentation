...
| Request fields | Include documentation [custom fields](manage-inventory-custom-fields.qmd) alongside your action if desired. |
| To set status | Select a [status](customize-resource-statuses.qmd) to transition to if desired. |
