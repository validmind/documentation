...
![The ValidMind Platform](platform-overview.png){width=70% fig-align="left" fig-alt="An image showing the two main components of ValidMind. The Developer Framework that integrates with your existing developer environment, and the ValidMind AI risk platform."}
...
- **Upload documentation data** — Send qualitative and quantitative test data to the MRM platform to generate the model documentation for review and approval, fostering effective collaboration with model reviewers and validators.
