...
![The ValidMind Platform](platform-overview.png){width=75% fig-align="left" fig-alt="An image showing the two main components of ValidMind. One component is the developer framework that integrates with your existing data infrastructure and data science or model developer stack. The other component is the platform which the developer framework sends data to."}
