...
- **Work on validation projects** — Review documentation, collaborate seamlessly with developers and validators, keep track of review statuses, and generate validation reports.
- **Configure workflows** — Set up ValidMind to follow your existing model risk management processes, manage statuses for different parts of the workflow, and get an end-to-end view of what your workflows look like and who is involved.
...
- **Integrate with your infrastructure — Import and export model documentation and validation reports.
