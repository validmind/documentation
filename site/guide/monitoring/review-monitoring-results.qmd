...
::: {.w-50-ns .pa2}
![Prediction probabilities histogram drift](/guide/monitoring/prediction-probabilities-histogram-drift-full.png){fig-alt="An image showing sample monitoring results in the ValidMind Platform" .screenshot}
:::
