...
3. In the left sidebar, click **{{< fa desktop >}} Ongoing Monitoring**. 
    ...
    ![Sample monitoring results](target-prediction-distribution-plot.png){width=85% fig-alt="An image showing sample monitoring results in the ValidMind platform" class="screenshot"}
