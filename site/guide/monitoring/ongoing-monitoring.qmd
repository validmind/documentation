...
::: {.callout}
To gain hands-on experience, check out out our code sample for ongoing monitoring of models.[^4]
:::
...
As you run your code, the monitoring template for your model gets populated. To review the monitoring results:
