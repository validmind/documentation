...
Together, thresholds and notifications improve your visibility into record performance and compliance risk, enabling timely intervention when needed.
...
- [x] {{< var link.login >}}
- [x] Metrics over time have already been logged via the {{< var validmind.developer >}} for your record.[^1]
...
::: {.w-50-ns .pa2}
Here, the GINI score drops to `0.5`, breaching the threshold. This indicates potential performance degradation or risk, as indicated in the upper-right corner.
:::
...
An email is sent to inventory record stakeholders notifying them that the record has a metric that did not pass an ongoing monitoring threshold and requires attention.
