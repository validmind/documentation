...
5. Click **Use Template** to apply your desired template.
   ...
   ![Template that gets populated with monitoring results](ongoing-monitoring-template.png){width=85% fig-alt="An image showing the template that gets populated with monitoring results" .screenshot}
