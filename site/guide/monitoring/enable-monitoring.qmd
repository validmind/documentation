...
{{< var vm.product >}} generates a unique _code snippet_ for each registered model to connect with your developer environment. You initialize the client library with this code snippet, which ensures that your documentation and tests are uploaded to the correct model when you run the notebook. 
...
5. Click **Use Template** to apply your desired template.
   ...
   ![Template that gets populated with monitoring results](ongoing-monitoring-template.png){width=85% fig-alt="An image showing the template that gets populated with monitoring results" class="screenshot"}
