...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation or Ongoing Monitoring type file.[^4]
...
6.  Click {{< fa square-plus >}} and then select **Metric Over Time**[^5] under [from library]{.smallcaps}.
...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation or Ongoing Monitoring type file.[^7]
