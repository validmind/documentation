...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation or Ongoing Monitoring type file.[^5]
...
3. In the left sidebar that appears for your model, click **{{< fa file >}} Documents** and select a Model Documentation or Ongoing Monitoring type file.[^8]
...
[^2]: [Log metrics over time](/notebooks/how_to/log_metrics_over_time.ipynb)
