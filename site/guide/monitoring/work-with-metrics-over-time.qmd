...
6. Select metric over time results:
   ...
   - Search by name using **{{<fa magnifying-glass >}} Search** on the top-left to locate specific metrics.
    ...
    ![Metric over time blocks that have been selected for insertion](metrics-over-time-menu.png){width=85% fig-alt="A screenshot showing several metric over time blocks that have been selected for insertion" .screenshot}
