...
Follow the steps in [Install and initialize the Developer Framework](install-and-initialize-get-started-developer-framework.qmd) for detailed instructions on how to integrate the Developer Framework and upload to the ValidMind Platform.
