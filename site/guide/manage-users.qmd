...
Managing users is fundamental to maintaining access control and efficient user management in the ValidMind system. This task topic will guide you through the process of inviting new users, assigning them to specific groups, and configuring their roles and permissions. 

::: {.callout}
Whether you're a group administrator or a superuser, understanding these steps is crucial for ensuring the right individuals have the appropriate access and permissions within the system.
:::
...
1. Check the **Pending Invites** section to track the status of invitations. Users who haven't accepted their invitations yet will be listed here.
...
3. Review the history of previously accepted invitations under the **Invite History** section.
