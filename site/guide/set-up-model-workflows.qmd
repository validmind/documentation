...
::: {.column-margin}
After you’ve [configured your workflow steps](#configure-workflow-steps), you can then link your workflow together.
:::
...
1. First, configure an **Approval** step. [Learn more...]((#configure-workflow-steps))
