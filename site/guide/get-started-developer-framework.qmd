...
After you [**sign up**](https://app.prod.validmind.ai) for ValidMind to get access, start with our QuickStart or watch the video:
...
After you have tried out , continue with: [Model documentation](guides.qmd#model-documentation) in the AI Risk Platform online. There, you can learn how to:
