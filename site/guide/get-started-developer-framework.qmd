...
After you [**sign up**](https://app.prod.validmind.ai) for ValidMind to get access, head to the QuickStart guide or watch the video demonstration:
...
After you have tried out the developer framework, continue [working with your model documentation](working-with-model-documentation.qmd) in the AI Risk Platform ("Platform UI") online. There, you can:
