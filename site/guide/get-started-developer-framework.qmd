...
##  {{< fa angle-right >}} Expand to learn about key ValidMind concepts
...
1. [Register a new model](register-models.qmd).
...
5. {{< fa arrow-right >}} After **With the Developer Framework, Step 6**, [add content blocks](add-content-blocks.qmd) to your model documentation: 
