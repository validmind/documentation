...
[^3]:
  ...
  ![Configure the Databricks connection](configure-databricks.png){width=80% fig-alt="Screenshot of the Configure Databricks connection dialog. Choose Authentication Method (OAuth user login or Personal Access Token), then complete Workspace URL and optional SQL Warehouse ID. OAuth continues with Connect with Databricks; Personal Access Token uses a stored secret and Save Integration." .screenshot}
