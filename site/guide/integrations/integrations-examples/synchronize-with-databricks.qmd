...
g. Test the connection:
   ...
   ii. When the **{{< fa ellipsis-vertical >}}** appears, click on it and select **{{< fa circle-check >}} Test Connection**.
...
e. When the **{{< fa ellipsis-vertical >}}** appears, click on it and select **{{< fa link >}} Link Model**.
