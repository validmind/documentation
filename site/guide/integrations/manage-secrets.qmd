...
4. When the  **{{< fa ellipsis-vertical >}}** menu appears, click on it and select **{{< fa triangle-exclamation >}} Revoke**.
...
4. When the  **{{< fa ellipsis-vertical >}}** menu appears, click it, then select **{{< fa trash >}} Delete**.
