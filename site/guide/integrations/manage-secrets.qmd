...
2. Under {{< fa puzzle-piece >}} Integrations, select **Secrets**, then open the **Integration Secrets** tab to view, add, edit, revoke, or delete integration secrets:
...
2. Under {{< fa puzzle-piece >}} Integrations, select **Secrets**, then open the **Webhook Secrets** tab to view, add, edit, revoke, or delete webhook secrets:
