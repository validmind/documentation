...
Configure scheduled exports of analytics datasets to cloud storage so BI tools such as Tableau, Snowflake, and Looker can consume models, findings, and workflow metrics in your preferred format.
...
- [x] For cloud destinations, the required credentials exist as secrets (for example, AWS access keys) in Integration Secrets.[^2]
...
2. Under Integrations, select **Analytics Exports**.
   ...
   The Analytics Export Configurations page opens. From here you create and manage scheduled exports.

![Settings page with Integrations and Analytics Exports highlighted.](analytics-exports-settings.png){fig-alt="Settings page showing Integrations section with Analytics Exports option highlighted." .screenshot}

## Create an analytics export

1. On the Analytics Exports page, click **{{< fa plus >}} Create Analytics Export**.

2. **Select datasets** — Choose which analytics datasets to export:
...
3. **Configure destination** — Set the cloud storage destination and output settings:
...
4. **Set schedule** — Define how often to export:
