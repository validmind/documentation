...
4. From the **[datasets]{.smallcaps}** dropdown, choose which datasets to export:
...
7. Configure the cloud storage destination and output settings:
   ...
   - **[bucket]{.smallcaps}** — Enter the bucket or container name (example: `my-data-exports-bucket`).
