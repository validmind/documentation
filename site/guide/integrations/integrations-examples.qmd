...
::: {.column-margin}
![Sync with AWS SageMaker](integrations-examples-aws-sagemaker.png){width=80% fig-alt="Screenshot of the AWS Sagemaker connection configured to synchronize the model inventory, showing the required fields described in step 4." .screenshot}
:::
