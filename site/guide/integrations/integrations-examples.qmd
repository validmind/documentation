...
2. Under Workflows, select a workflow you can modify or click  **{{< fa plus >}} Add Model Workflow** to start afresh.

3. From the **Workflow Steps** modal, drag and drop an **HTTP Request** step onto the canvas, then connect it to your workflow.
...
#### Configure the workflow on {{< var vm.product >}}
...
#### Start the workflow from the external system
...
#### Trigger the workflow to continue from the external system
