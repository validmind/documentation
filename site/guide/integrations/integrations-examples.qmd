...
#### Run validations on Databricks data

::: {.column-margin}
[Databricks quickstart](https://docs.validmind.ai/notebooks/databricks/validmind_databricks_quickstart.html){.button}
:::
...
1. Connect to your Databricks workspace and load data from Unity Catalog tables
2. Initialize ValidMind datasets from Databricks DataFrames:
...
3. Register your model and assign predictions
4. Run the test suite to generate validation documentation
