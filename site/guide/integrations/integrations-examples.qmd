...
- [Synchronize the model inventory with AWS SageMaker](#synchronize-the-model-inventory-with-aws-sagemaker)
...
### Synchronize the model inventory with AWS SageMaker

To synchronize the {{< var vm.product >}} model inventory with AWS SageMaker for unified model tracking:

::: {.column-margin}
![Sync with AWS SageMaker](integrations-examples-aws-sagemaker.png){width=80% fig-alt="Screenshot of the AWS Sagemaker connection configured to synchronize the model inventory, showing the required fields described in step 5." .screenshot}
:::
