...
[^12]: [Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models)

[^13]: [Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models)

[^14]: [Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models)