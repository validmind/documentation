---
title: "Glossary"
keywords: "glossary, ai risk, model risk management, ValidMind"
---
...
test suite
: A collection of test plans which are run together to automate generate model documentation end-to-end for specific use-cases, such as the `binary_classifier_full_suite` test suite that runs the `tabular_dataset` and `binary_classifier` test plans to fully document the data and model sections for binary classification model use-cases.
