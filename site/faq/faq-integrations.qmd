...
You can pass data dictionaries to {{< var vm.product >}} via the {{< var vm.developer >}}, such as in CSV format.**
...
[^2]: [Do you include explainability-related testing and documentation?](faq-testing.qmd#explanability)
