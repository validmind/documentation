...
Use {{< var vm.product >}} to assess compliance of your records (models) with guidelines based on analyzing evidence and artifacts (findings),[^3] providing an unbiased starting point that enables more efficient discussions between validators and developers.
