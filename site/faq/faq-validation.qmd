...
{{< var vm.product >}} supports the implementation of custom validation guidelines from within the {{< var validmind.platform >}}: 
...
::: {.callout}
By default, the [{{< fa hand >}} Customer Admin]{.bubble} role[^1] has sufficient permissions to manage validation guidelines. 
:::

## Does {{< var vm.product >}} help with assessing model compliance?

{{< var vm.product >}} allows you assess compliance of your models with guidelines based on analyzing evidence and findings,[^2] providing an unbiased starting point that enables more efficient discussions between validators and developers.
...
- Within the {{< var validmind.platform >}}, you're able to log findings at the model or the documentation section level.[^3]
...
- You can also access a complete list of filterable findings logged across all your models, or look at only findings linked to a specific model.[^4]
...
[^2]: [Assess compliance](/guide/model-validation/assess-compliance.qmd)

[^3]: [Add and manage model findings](/guide/model-validation/add-manage-model-findings.qmd)

[^4]: [View and filter model findings](/guide/model-validation/view-filter-model-findings.qmd)