...
- In addition, {{< var vm.product >}} also provides support for Single Sign-On (SSO) integration as part of our Enterprise and our {{< var validmind.vpv >}} (VPV) edition.[^8]
...
[^8]: [{{< var validmind.vpv >}} (VPV)](/about/deployment/virtual-private-validmind.qmd)
