...
## How do user roles, user groups, and access permissions work? 
 ...
 - Users belong to groups which determine which records (models) they can see, and have roles with attached permissions which define the level of access they have to features.
...
[^2]: [Log in to ValidMind](/guide/access/log-in-to-validmind.qmd)
