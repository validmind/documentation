...
listing:
  - id: faq-inventory
    ...
    - ../guide/inventory/working-with-model-inventory.qmd
    - ../guide/inventory/managing-model-inventory.qmd
...
[^1]: [Register models in the inventory](/guide/inventory/working-with-model-inventory.qmd)

[^2]: [Manage permissions](/guide/configuration/manage-permissions.qmd)

[^3]: [Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd)

[^4]: [Archive and delete models](/guide/inventory/archive-delete-models.qmd)

[^5]: [Configure model interdependencies](/guide/inventory/configure-model-interdependencies.qmd)