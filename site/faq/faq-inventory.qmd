...
Yes. When Record Intake is enabled, the **Intake** holding inventory record type lets submitters register a record first; a classification workflow (or an admin) then converts it in place to the correct type, or rejects and archives it.^[[Record Intake](/guide/inventory/record-intake.qmd)]
