...
- Yes, models can be archived within the {{< var validmind.platform >}}[^3] model inventory to keep your inventory accurate and up to date with your organization’s current resources.[^4]
...
[^3]: [Accessing {{< var vm.product >}}](/guide/configuration/accessing-validmind.qmd)
