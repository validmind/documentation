...
By default, the [{{< fa code >}} Developer]{.bubble} role[^1] has sufficient permissions to register models.

## Are model registration questionnaires customizable?

- Yes, along with default fields provided by {{< var vm.product >}} as part of your basic model information,[^2] you can add additional model information and make these custom fields required on registration. 
...
[^2]: [Basic Model Information](/guide/model-inventory/register-models-in-inventory.qmd#basic-model-information)
