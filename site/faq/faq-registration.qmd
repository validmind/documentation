...
- Yes, along with default fields provided by {{< var vm.product >}} as part of your basic model information,[^3] you can add additional model information and make these custom fields required on registration. 
...
[^3]: [Basic Model Information](/guide/model-inventory/register-models-in-inventory.qmd#basic-model-information)
