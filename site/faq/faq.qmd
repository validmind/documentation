...
listing:
  - id: faq
    ...
    - path: faq-integrations.qmd
      ...
      categories: ["supported libraries", "supported languages", "integrations",  "data dictionaries", "large language models", "explainability", "deployment options", "validmind library"]
