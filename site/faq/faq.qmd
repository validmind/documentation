...
listing:
  - id: faq
    ...
    - path: faq-registration.qmd
      title: "Model registration"
      categories: ["model registration", "model inventory", "customization", "validmind platform"]
    - path: faq-inventory.qmd
      title: "Model inventory and activity"
      categories: ["model inventory", "customization", "model activity", "model stages", "model interdependencies", "auditing", "exports", "validmind platform"]
    - path: faq-documentation.qmd
      title: "Model documentation and templates"
      categories: ["model documentation", "templates", "customization", "validmind platform", "validmind library"]
    ...
    - path: faq-testing.qmd
      title: "Testing and thresholds"
      categories: ["testing", "model documentation", "customization", "custom data", "ongoing monitoring", "validmind library"]
    - path: faq-integrations.qmd
      title: "Integrations and support"
      categories: ["supported libraries", "supported languages", "integrations", "artificial intelligence", "large language models", "data dictionaries", "deployment options", "validmind library"]
    - path: faq-privacy.qmd
      title: "Data handling and privacy"
      categories: ["data handling", "privacy", "access", "datasets", "performance metrics", "model activity", "auditing", "validmind platform", "validmind library"]
---
