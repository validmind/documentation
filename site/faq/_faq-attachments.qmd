...
Yes, attachment type inventory fields are available for custom use.^[[Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd)] Once created, attachment type fields allow you to upload supporting files to your model.
