...
## How does {{< var vm.product >}} manage updates to records (models)?

1. {{< var vm.product >}} allows developers to re-run documentation functions with the {{< var validmind.developer >}}^[[{{< var validmind.developer >}}](/developer/validmind-library.qmd)] to capture changes in the record, such as changes in the number of features or hyperparameters. 
