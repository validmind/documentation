...
{{< var vm.product >}} stores the following artifacts in the documentation via our API:
...
Access to any edition is facilitated through AWS PrivateLink, which provides private connectivity between {{< var vm.product >}} and your on-premises networks without exposing your traffic to the public internet. To learn more, check [Configure AWS PrivateLink](/guide/configuration/configure-aws-privatelink.qmd). {{< var vm.product >}} does not send any personally identifiable information (PII) through our API.
...
<!-- FOOTNOTES -->
[^1]: [Deployment options](/about/deployment/deployment-options.qmd)
