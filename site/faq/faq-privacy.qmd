...
<<<<<<< HEAD
ValidMind does not send datasets outside the client's environment. The {{< var developer >}} executes test suites and functions locally in your environment and is not limited by dataset size. Additionally, ValidMind adheres to a strict data confidentiality and retention policy, compliant with the SOC 2 security standard.
=======
...
>>>>>>> 1bd4b6bcac5f4736fd2a0cb9b9c64e096c61289e
