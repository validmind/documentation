...
[^12]: [Manage model stakeholder types](/guide/configuration/manage-record-stakeholder-types.qmd)
...
[^16]: [Manage model stakeholder types](/guide/configuration/manage-record-stakeholder-types.qmd)