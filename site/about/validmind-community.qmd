...
- **[Join our Slack community:](https://docs.validmind.ai/guide/join-community.html)** Be part of building a space for AI risk practitioners and those looking to break into the industry. Get technical support, share ideas, chat about model risk, AI, large language models, and much more!
...
::: {.callout-tip title="ValidMind style guide" appearance="minimal"}
The first step towards producing material for ValidMind is to familarize yourself with our [style guide](style-guide.qmd). 
...
As a member of the ValidMind community, we invite you to be part of our process. From our public documentation to the code behind our [{{< var vm_dev >}}](../guide/get-started-developer-framework.qmd), we've exposed the wiring for inspection in hopes that great minds think differently and dare to spark change. 

### Contribution ideas
Please note that all community contributions are subject to review by the ValidMind team. See our [software license agreement](license-agreement.qmd) for more details. 

- **[Code samples](../guide/samples-jupyter-notebooks.html):** Have a Jupyter Notebook that works perfectly with ValidMind, or covers a sample use case not already provided? Send it to us!
- **[{{< var vm_framework >}}](https://github.com/validmind/developer-framework/)**: Live by the [{{< var vm_dev >}}](../guide/get-started-developer-framework.qmd), and have an idea that will streamline the experience for others? Let us know!
