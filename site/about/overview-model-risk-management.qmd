...
- **Configure workflows**[^3] — Set up {{< var vm.product >}} to follow your existing model risk management processes, manage statuses for different parts of the workflow, and get an end-to-end view of workflows and who is involved.
...
{{< var vm.product >}}, as a robust tool for implementing Model Risk Management (MRM) best practices, including the _three lines of defense_, significantly aids organizations in adhering to the regulatory guidelines set forth by SR 11-7 and SS1/23. 
