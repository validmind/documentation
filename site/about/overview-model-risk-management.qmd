...
The {{< var vm_platform >}} offers an integrated platform to manage validation reports, track findings, and report on model risk compliance across your model portfolio. Its main purpose is to enable your organization to monitor and manage models effectively, focusing on mitigating risks, maintaining governance, and ensuring compliance throughout the entire enterprise.

## The {{< var vm_platform >}} 

The {{< var vm_platform >}} provides a comprehensive suite of tools, guidelines, and best practices. You use the platform to review and evaluate models and model documentation to ensure they comply with organizational and regulatory requirements.
...
The {{< var vm_ui >}} employs a multi-tenant architecture, hosting the cloud-based user interface, APIs, databases, and internal services. The design ensures efficient resource utilization and offers a highly scalable solution for organizations of varying sizes.

With the {{< var vm_ui >}}, you can:
...
::: {.g-col-8}
### SR 11-7: Guidance on Model Risk Management^1^
...
::: {.g-col-9}
### SS1/23 – Model Risk Management Principles for Banks^2^
...
::: {.g-col-6}
#### Guideline-E23: Enterprise-Wide Model Risk Management for Deposit-Taking Institutions^3^
...
::: {.g-col-6}
#### Principles for Model Risk Management^4^
...
- ^3^[Guideline-E23](https://www.osfi-bsif.gc.ca/Eng/fi-if/rg-ro/gdn-ort/gl-ld/Pages/e23.aspx)
- ^4^[Principles for Model Risk Management](https://www.fsa.go.jp/common/law/ginkou/pdf_03.pdf)
