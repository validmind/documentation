...
| [Integrations](/guide/guides.qmd#integrations) | Connecting {{< var vm.product >}} to external systems | Manage secrets, configure connections, link external models |
...
| [Documents & templates](/guide/guides.qmd#documents-templates) | Creating and customizing documentation | Manage document types, customize templates, use the text block library |
