...
As a member of the ValidMind community, we invite you to be part of our process. From our public documentation to the code behind our [{{< var vm_dev >}}](../../developer-framework/get-started-developer-framework.qmd), we've exposed the wiring for inspection in hopes that great minds think differently and dare to spark change. 

### Contribution ideas
Please note that all community contributions are subject to review by the ValidMind team. See our [software license agreement](../fine-print/license-agreement.qmd) for more details. 
...
- **[{{< var vm_framework >}}](https://github.com/validmind/developer-framework/)** – Live by the {{< var vm_dev >}}, and have an idea that will streamline the experience for others? Let us know!
