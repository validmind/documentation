...
As a member of the ValidMind community, we invite you to be part of our process. From our public documentation to the code behind our [{{< var developer >}}](/developer/get-started-developer-framework.qmd), we've exposed the wiring for inspection in hopes that great minds think differently and dare to spark change. 
...
- **[{{< var validmind_developer >}}](https://github.com/validmind/developer-framework/)** — Live by the {{< var developer >}}, and have an idea that will streamline the experience for others? Let us know!
