...
As a member of the ValidMind community, we invite you to be part of our process. From our public documentation to the code behind our [{{< var vm_dev >}}](/developer/get-started-developer-framework.qmd), we've exposed the wiring for inspection in hopes that great minds think differently and dare to spark change. 
