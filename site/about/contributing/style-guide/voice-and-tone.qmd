...
| Correct | Incorrect | 
|------|-----|
|   After completing this QuickStart, you will be able to view your test results as part of your model documentation right in the {{< var validmind_platform >}}.  |  After completing this QuickStart, the model developer will be able to view the test results as part of the model documentation right in the {{< var validmind_platform >}}.   |
