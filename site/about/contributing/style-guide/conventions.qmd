...
| Correct | Incorrect | 
|------|-----|
|   ![Verification email sent by ValidMind](/guide/configuration/verify-email.png){width=70% fig-alt="Screenshot of the verification email sent by ValidMind" class="screenshot"}  |  ![](/guide/configuration/verify-email-incorrect.png){width=70%} | 
