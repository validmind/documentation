...
| Correct | Incorrect | 
|------|-----|
|   `[Configure model workflows](/guide/workflows/configure-model-workflows.qmd)`  |  `[Learn more ...](/../../configure-custom-workflows.html)`  |
...
[Configure model workflows](/guide/workflows/configure-model-workflows.qmd){.button}
...
<form method="get" action="../../../guide/workflows/configure-custom-workflows.html">
