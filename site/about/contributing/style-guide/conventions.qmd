...
- In single-source files, either place the link inline for training materials formatted in `revealjs`,[^6] or use an embedded footnote for our normal user guides. 
  ...
  1. Select a model by clicking on it or find your model by applying a filter or searching for it.^[[Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models)]
  ...
  1. Select a model by clicking on it or [find your model by applying a filter or searching for it](/guide/inventory/working-with-model-inventory.qmd#search-filter-and-sort-models).
