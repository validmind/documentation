...
|   In the {{< var validmind_platform >}}, click **Model Inventory** on the left sidebar.  | In the {{< var validmind_platform >}}, click "Model Inventory" on the left sidebar. |
...
| {{< var validmind_platform >}} |  `{{{< var validmind_platform >}}}` | Hosted multi-tenant architecture that includes a cloud-based web interface. |
| {{< var developer >}} |  `{{{< var developer >}}}` | Short form of {{< var validmind_developer >}}. |
| {{< var platform >}} |  `{{{< var platform >}}}` | Short form of {{< var validmind_platform >}}. |
| {{< var vm_url >}} | `{{{< var vm_url >}}}` | URL of the {{< var validmind_platform >}}. |
