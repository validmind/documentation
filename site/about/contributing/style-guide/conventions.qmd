...
The {{< var vm.product >}} Academy[^20] is delivered in Revealjs presentation format,[^21] with a slightly different set of conventions:
...
- Training materials use several supplementary style sheets to apply an alternate site theme: 
  ...
  a. **{{< var vm.product >}} Academy hub:** `training.css`[^24]
...
[^20]: [{{< var vm.product >}} Academy](/training/training.qmd)
