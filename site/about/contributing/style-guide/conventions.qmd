...
| Correct | Incorrect | 
|------|-----|
|   `[Configure custom workflows](/guide/model-workflows/configure-custom-workflows.qmd)`  |  `[Learn more ...](/../../configure-custom-workflows.html)`  |
...
[Configure custom workflows](/guide/model-workflows/configure-custom-workflows.qmd){.button}
