...
| Correct | Incorrect | 
|------|-----|
|   `[Set up model workflows](/guide/model-workflows/configure-custom-workflows.qmd)`  |  `[Learn more ...](/../../configure-custom-workflows.html)`  |
...
[Set up model workflows](/guide/model-workflows/configure-custom-workflows.qmd){.button}
