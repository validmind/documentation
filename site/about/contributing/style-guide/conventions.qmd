...
We provide live previews of training modules on our course pages. These previews act like links but they provide a live preview of the training module linked to. To simplify embedding these previews, we created a course–preview extension for Quarto that is part of our repository.
...
::: {.course-preview src="../../../training/administrator-fundamentals.qmd"}
:::
