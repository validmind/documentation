...
| Correct | Incorrect | 
|------|-----|
|   `[Configure custom workflows](/guide/model-workflows/configure-model-workflows.qmd)`  |  `[Learn more ...](/../../configure-custom-workflows.html)`  |
...
[Configure custom workflows](/guide/model-workflows/configure-model-workflows.qmd){.button}
