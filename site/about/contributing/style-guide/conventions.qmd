...
: {{< var vm.product >}} product **variable keys** {.hover tbl-colwidths="[25,35,40]"}
...
The {{< var vm.product >}} Academy is delivered in Revealjs presentation format,[^19] with a slightly different set of conventions:
