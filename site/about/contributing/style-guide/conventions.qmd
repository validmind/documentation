...
|---:|---|---|
| {{< var validmind.product >}} | `{{{< var validmind.product >}}}` | Risk platform with a {{< var developer >}} for documenting and testing models, alongside a {{< var platform >}} hosting cloud-based tools, APIs, databases, and validation engines. |
| {{< var validmind.developer >}} |  `{{{< var validmind.developer >}}}` | Open-source suite of of tools that connects to the  {{< var platform >}}. |
| {{< var validmind.platform >}} |  `{{{< var validmind.platform >}}}` | Hosted multi-tenant architecture that includes a cloud-based web interface. |
| {{< var developer >}} |  `{{{< var developer >}}}` | Short form of {{< var validmind.developer >}}. |
