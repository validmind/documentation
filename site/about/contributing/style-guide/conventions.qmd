...
- When possible — such as any time instructions are not single-sourced — instead of multiple inline links, make use of margin footnotes.[^4]
...
- It makes use of Tachyons CSS to provide demostration overlays:
