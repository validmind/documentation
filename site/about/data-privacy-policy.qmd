...
- **No personal identifiable information in documentation**: When the {{< var vm_framework >}} generates documentation, it ensures that no personally identifiable information (PII) is included. This practice is a critical part of our commitment to protecting your privacy and maintaining the confidentiality of your data.
...
The {{< var vm_framework >}} does not send any personally identifiable information (PII) through our API. 

## What's next

- [Configure AWS PrivateLink](../guide/configure-aws-privatelink.qmd)
