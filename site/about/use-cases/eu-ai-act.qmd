...
[EU AI Act (Regulation (EU) 2024/1689) on EUR-Lex](https://eur-lex.europa.eu/eli/reg/2024/1689)
:::
...
1. Complete the risk classification questionnaire:
   - Configure custom inventory fields[^1] to capture EU AI Act risk classification.
...
3. Set up custom workflows[^2] for different risk levels:
...
2. Implement out-of-the-box data quality tests:[^3]
...
1. Work with documentation templates:[^4]
...
1. Prepare validation reports:[^6]
...
4. Record findings and remediations:[^7]
...
1. Configure ongoing monitoring:[^10]
...
3. Create human review workflows:[^2]
...
1. Set up the conformity assessment process (Article 43):
   - Configure end-to-end compliance workflows[^2]
...
3. Implement post-market monitoring (Article 61):[^10]
...
[^3]: [Run tests and test suites](/developer/model-testing/testing-overview.qmd)

[^4]: [Work with document templates](/guide/templates/working-with-document-templates.qmd)

[^5]: [Test descriptions](/developer/model-testing/test-descriptions.qmd)
...
[^8]: [Work with analytics](/guide/reporting/working-with-analytics.qmd)

[^9]: [Customize your dashboard](/guide/configuration/customize-your-dashboard.qmd)
