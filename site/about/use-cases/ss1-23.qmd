...
[^2]: [Manage model inventory fields](/guide/inventory/manage-model-inventory-fields.qmd)

[^3]: [Working with the model inventory](/guide/inventory/working-with-model-inventory.qmd)
