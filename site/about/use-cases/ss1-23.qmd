...
[^10]: [Work with artifacts](/guide/validation/working-with-artifacts.qmd)
...
[^13]: [Manage validation guidelines](/guide/validation/manage-validation-guidelines.qmd)

[^14]: [Ongoing monitoring](/guide/monitoring/ongoing-monitoring.qmd)

[^15]: [Working with model documentation](/guide/documentation/working-with-model-documentation.qmd)
