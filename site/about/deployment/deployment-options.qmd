...
![{{< var vm.product >}} Platform architecture overview](validmind-architecture-overview.png){fig-alt="An image showing the ValidMind Platform architecture"}
...
These models are then integrated with the {{< var validmind.developer >}}, which communicates with {{< var validmind.platform >}} via our {{< var validmind.api >}}.
