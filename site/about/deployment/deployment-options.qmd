...
- **{{< var validmind.vpv >}} (VPV)** — A single-tenant architecture where one organization uses a dedicated infrastructure instance, offering greater control, customization, and enhanced security. This option is ideal for high-compliance needs and also supports VPC for secure connectivity.
