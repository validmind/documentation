...
![{{< var vm.product >}} multi-tenant cloud](multi-tenant-cloud.png){width="85%" fig-alt="An image showing one ValidMind multi-tenant cloud deployment"}
...
Optional VPC connections offer secure integration with on-premise networks.
