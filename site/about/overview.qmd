...
::: {.g-col-6}
![](../assets/img/Group 38-2-compact.png){width=85% fig-alt="An image showing the main ValidMind Platform UI main dashboard"}
:::
...
::: {.g-col-6}
## Automated model testing & documentation 
Our {{< var vm_framework >}} streamlines the process of documenting various types of models, including traditional statistical models, legacy systems, artificial intelligence or machine learning models, and large language models (LLMs). 
...
::: {.g-col-6}
## Model risk governance management
Our {{< var vm_platform >}}	 offers an integrated platform to manage validation reports, track findings, and report on model risk compliance across your model portfolio.
