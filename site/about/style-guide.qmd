...
#### Callouts
We use two [types of callouts](https://quarto.org/docs/authoring/callouts.html) to call attention to supplementary information or issue warnings:
...
Within a Jupyter Notebook, simply use a [**code cell**](https://jupyter-notebook.readthedocs.io/en/stable/notebook.html#code-cells) rather than a markdown cell.
