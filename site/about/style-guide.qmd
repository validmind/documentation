...
### Product names
Within [our documentation](https://docs.validmind.ai/), you are able to reference product features such as the {{< var vm_framework >}} and {{< var vm_platform >}} [via variables](https://quarto.org/docs/authoring/variables.html#var). 
