...
{{< var vm.product >}} supports various model types, including:[^1]
...
{{< var vm.product >}} imports the following artifacts into the documentation via our API endpoint integration:
