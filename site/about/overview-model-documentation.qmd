...
- You can easily add support for new models and data types by defining new classes within the {{< var vm_framework >}}. We provide templates to guide you through this process.^2^ 
...
- ^1^[Supported models](../guide/supported-models.qmd)
- ^2^[Customize documentation templates](../guide/customize-documentation-templates.qmd)
