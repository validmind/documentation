...
The ValidMind Developer Framework streamlines the process of documenting various types of models, including traditional statistical models, legacy systems, artificial intelligence or machine learning models, and large language models (LLMs). Its main purpose is to automate the documentation process, ensuring that it aligns with regulatory and compliance standards.

## The {{< var vm_framework >}}

The {{< var vm_framework >}} is a {{< var vm_dev >}} and documentation engine designed to streamline the process of documenting various types of models, including traditional statistical models, legacy systems, artificial intelligence/machine learning models, and large language models (LLMs). It offers model developers a systematic approach to documenting and testing risk models with repeatability and consistency, ensuring alignment with regulatory and compliance standards.
...
The {{< var vm_framework >}} consists of a client-side library, API integration for models and testing, and validation tests that streamline the model development process. Implemented as a series of independent libraries in Python and R, our {{< var vm_dev >}} ensures compatibility and flexibility with diverse sets of developer environments and requirements.

With the {{< var vm_dev >}}, you can:
...
- **Integrate with your development environment** — Seamlessly incorporate the {{< var vm_framework >}} into your existing model development environment, connecting to your existing model code and data sets.
...
::: {.g-col-5}
What the {{< var vm_framework >}} offers:
...
- Dual-licensed: the {{< var vm_dev >}} is available as open-source under AGPL v3 license and also with a commercial software license.
:::
...
:::
How the {{< var vm_framework >}} works:
...
- The {{< var vm_dev >}} integrates with ETL/data processing pipelines using connector interfaces. This enables the extraction of relationships between raw data sources and their corresponding post-processed datasets, such as those preloaded session instances received from platforms like Spark and Snowflake.
...
[Read more ...](../guide/supported-models.qmd)
...
- You can easily add support for new models and data types by defining new classes within the {{< var vm_framework >}}. We provide templates to guide you through this process. [Read more ...](../guide/customize-documentation-templates.qmd)
- To include custom tests in the library, you can define new functions. We offer templates to help you create these custom tests. [Read more ...](../notebooks/code_samples/custom_tests/implement_custom_tests.ipynb)
