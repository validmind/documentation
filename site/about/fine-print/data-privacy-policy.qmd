...
- **No personal identifiable information in documentation** — When the {{< var validmind_developer >}} generates documentation, it ensures that no personally identifiable information (PII) is included. This practice is a critical part of our commitment to protecting your privacy and maintaining the confidentiality of your data.
...
The {{< var validmind_developer >}} does not send any personally identifiable information (PII) through our API. 
