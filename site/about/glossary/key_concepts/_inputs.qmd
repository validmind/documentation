...
:::: {.content-visible when-format="html" when-meta="includes.glossary"}
  - **model**: A single record (such as a model) that has been initialized in {{< var vm.product >}}. Despite the naming convention, model objects can be any type of record you want to test, document, validate, or monitor with {{< var vm.product >}}.^[**Refer to:** [`vm.init_model()`](/validmind/validmind.qmd#init_model){target="_blank"}]
