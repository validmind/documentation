...
{{< var vm.product >}} documentation templates function as test suites and lay out the structure of documentation, segmented into various sections and sub-sections. Documentation templates define the structure of your documentation, specifying the tests that should be run, and how the results should be displayed.
