...
{{< var vm.product >}} documentation templates function as test suites documentation templates function as test suites by defining the structure of your documentation, specifying the tests that should be run, and how the results should be displayed.
