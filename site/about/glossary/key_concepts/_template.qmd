...
document template
: Lays out the structure of documents, segmented into various sections and sub-sections, and functions as test suites to help automate your development, validation, monitoring, and other risk management processes. Document templates are available for default {{< var vm.product >}} document types[^default-documents] as well as custom document types.
...
: Lays out the structure of documents, segmented into various sections and sub-sections, and functions as test suites to help automate your development, validation, monitoring, and other risk management processes. Document templates are available for default {{< var vm.product >}} document types as well as custom document types.
