...
In the context of {{< var vm.product >}}'s Jupyter Notebooks, metrics and tests can be thought of as interchangeable concepts.^[**Refer also to:** [tests](/about/glossary/glossary.qmd#tests)]
::::
