...
: A hosted multi-tenant architecture^[[Log into the {{< var validmind_platform >}}](/guide/log-into-validmind.qmd)] that includes the ValidMind cloud-based web interface, APIs, databases, documentation and validation engine, and various internal services. 
