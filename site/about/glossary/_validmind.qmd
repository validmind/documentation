...
: A hosted multi-tenant architecture^[[Log into the {{< var validmind_platform >}}](/guide/configuration/log-in-to-validmind.qmd)] that includes the ValidMind cloud-based web interface, APIs, databases, documentation and validation engine, and various internal services. 
