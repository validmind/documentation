...
::: {.column-margin .pt6}
![Check regulatory compliance](overvierw-llm-features-check-document.png){fig-alt="A screenshot showing the LLM feature for checking documents that can be accessed with the Check Document button" class="screenshot" width=80%}
:::
