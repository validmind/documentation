...
|---|---|---|---|
|`validmind_platform` | ValidMind Platform | `validmind.platform` | {{< var validmind.platform >}} |
|`validmind_developer` | ValidMind Library | `validmind.developer` | {{< var validmind.developer >}} |
|`risk_platform` | ValidMind AI risk platform | `validmind.product` | {{< var validmind.product >}}|
|`platform` | platform | `vm.platform` | {{< var vm.platform >}} |
|`developer` | library | `vm.developer` | {{< var vm.developer >}} |
